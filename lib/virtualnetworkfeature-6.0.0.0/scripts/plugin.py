...
def get_plugin_info():
    return Plugin('virtual-network', '1.0')
...
class Plugin(PythonPlugin):
    ...
    def __init__(self, name, version):
        ...
        self.setDescription('Virtual Network Feature')

    def init(self):
        virtual_network.VirtualNetworkFeature.getInstance().register()

    def shutdown(self):
        virtual_network.VirtualNetworkFeature.getInstance().unregister()
