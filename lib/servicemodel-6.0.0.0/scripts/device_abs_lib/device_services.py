...
class services(object):
  #XPATH devices/device/services/service
  class service(AbstractDeviceMgr):
    ...
    def validate_inputs_form_payload(self, mapping_dict, update=False):
      ...
      service_object_list = []
      for name_iterator in name:
        from servicemodel.controller.devices.device import services
        ...
        try:
          if (update == False) or (update == True and str(mapping_dict.get('port', None)) != ''):
            service_object.port = mapping_dict.get('port', None)
          else:
            service_object.port._empty_tag = True
        except TypeError:
          pass
        try:
          if (update == False) or (update == True and str(mapping_dict.get('device_group', None)) != ''):
            service_object.device_group = mapping_dict.get('device_group', None)
          else:
            service_object.device_group._empty_tag = True
        except TypeError:
          pass
