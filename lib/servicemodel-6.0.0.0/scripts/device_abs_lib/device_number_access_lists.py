...
class number_access_lists(object):
  #XPATH devices/device/number-access-lists/access-list-numbers
  class access_list_numbers(AbstractDeviceMgr):
    key_hints = [[]]
    def getRcpathPayload(self, sdata, dev, mapping_dict):
      ...
      payload_list = []
      ##prepare rcpath
      rcpath = "acl:number-access-lists"
      rcpath_list.append(rcpath)
      mapping_dict = kwargs.get('mapping_dict')

      #validating inputs and get payload object
      access_list_numbers_object_list = self.validate_inputs_form_payload(mapping_dict)

      for access_list_numbers_object in access_list_numbers_object_list:
        #fetch payload
        access_list_numbers_payload = access_list_numbers_object.getxml(filter=True)
        util.log_debug('access_list_numbers_payload %s'%access_list_numbers_payload)
        payload_list.append(access_list_numbers_payload)
    ...
    def create_(self, sdata, dev, **kwargs):
      ...
      for access_list_numbers_object in access_list_numbers_object_list:
        ...
        super(self.__class__, self).create_(sdata, dev, rcpath=kwargs.get('rcpath'), payload=access_list_numbers_payload, key_hints=self.key_hints, addref=kwargs.get('addref', True), autocommit=kwargs.get('autocommit', True), mapping_dict=mapping_dict)
    ...
    def update_(self, sdata, dev, **kwargs):
      ...
      #validating inputs and get payload object
      access_list_numbers_object_list = self.validate_inputs_form_payload(mapping_dict, update=True)

      #convert keys to list
      access_list_number = mapping_dict.get('access_list_number')
      if not isinstance(access_list_number, list):
        access_list_number = [access_list_number]

      #prepare rcpath
      rcpath = kwargs.get('rcpath')
      rcpath_list = []
      for access_list_number_iterator in access_list_number:
        rcpath_tmp =  rcpath+"/access-list-numbers=%s"%(util.make_interfacename(access_list_number_iterator))
        rcpath_list.append(rcpath_tmp)
      for rc_counter, access_list_numbers_object in enumerate(access_list_numbers_object_list):
        #fetch payload
        access_list_numbers_payload = access_list_numbers_object.getxml(filter=True)

        util.log_debug('update access_list_numbers_payload %s'%access_list_numbers_payload)

        rcpath = rcpath_list[rc_counter]
        #call the base abstract class for createData
        super(self.__class__, self).update_(sdata, dev, rcpath=rcpath, payload=access_list_numbers_payload, key_hints=self.key_hints, addref=kwargs.get('addref', False), autocommit=kwargs.get('autocommit', True), mapping_dict=mapping_dict)
    ...
    def delete_(self, sdata, dev, **kwargs):
      ...
      #validating inputs
      if util.isEmpty(mapping_dict.get('access_list_number')):
        raise Exception("'access_list_number' cannot be empty")
    ...
    def validate_inputs_form_payload(self, mapping_dict, update=False):
      ...
      #prepare payload
      access_list_numbers_object_list = []
      for access_list_number_iterator in access_list_number:
        from servicemodel.controller.devices.device import number_access_lists
        access_list_numbers_object = number_access_lists.access_list_numbers.access_list_numbers()
        access_list_numbers_object.access_list_number = access_list_number_iterator
        access_list_numbers_object_list.append(access_list_numbers_object)

      return access_list_numbers_object_list

    #XPATH devices/device/number-access-lists/access-list-numbers/acl-rule
    class acl_rule(AbstractDeviceMgr):
      key_hints = [['access_list_number']]
      def getRcpathPayload(self, sdata, dev, access_list_numbers_access_list_number, mapping_dict):
        dev = get_valid_devices(dev)
        if len(dev) == 0:
          return
        #Input Key Validations
        self.validate_parent_keys( access_list_numbers_access_list_number)

        #convert parent keys to list
        rcpath_list = []
        payload_list = []
        if not isinstance(access_list_numbers_access_list_number, list):
          access_list_numbers_access_list_number_list = [access_list_numbers_access_list_number]
        else:
          access_list_numbers_access_list_number_list = access_list_numbers_access_list_number

        for access_list_numbers_access_list_number in access_list_numbers_access_list_number_list:
          ##prepare rcpath
          rcpath = "acl:number-access-lists/access-list-numbers=%s"%(util.make_interfacename(access_list_numbers_access_list_number))
          rcpath_list.append(rcpath)
        mapping_dict = kwargs.get('mapping_dict')
      ...
      def create(self, sdata, dev, access_list_numbers_access_list_number, mapping_dict, addref=True, autocommit=True):
        dev = get_valid_devices(dev)
        if len(dev) == 0:
          return
        #Input Key Validations
      ...
      def update(self, sdata, dev, access_list_numbers_access_list_number, mapping_dict, addref=True, autocommit=True):
        dev = get_valid_devices(dev)
        if len(dev) == 0:
          return
        #Input Key Validations
      ...
      def delete(self, sdata, dev, access_list_numbers_access_list_number, mapping_dict, fail_silently=False, remove_reference=False):
        dev = get_valid_devices(dev)
        if len(dev) == 0:
          return
        #Input Key Validations
      ...
      def validate_parent_keys(self, access_list_numbers_access_list_number):
        #Parent Key Validations
        if util.isEmpty(access_list_numbers_access_list_number):
          raise Exception("'access_list_numbers_access_list_number' cannot be empty")
      ...
      def validate_inputs_form_payload(self, mapping_dict, update=False):
        ...
        for name_iterator in name:
          from servicemodel.controller.devices.device.number_access_lists import access_list_numbers
          acl_rule_object = access_list_numbers.acl_rule.acl_rule()
