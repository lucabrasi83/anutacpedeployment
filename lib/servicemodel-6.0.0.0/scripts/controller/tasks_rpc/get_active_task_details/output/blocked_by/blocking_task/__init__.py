...
def isEmpty(val):
    ...
    return False
class blocking_task(PybindBase):
  """
  This class was auto-generated by the PythonClass plugin for PYANG
  from YANG module tasks - based on the path /tasks_rpc/get-active-task-details/output/blocked-by/blocking-task. Each member element of
  the container is represented as a class variable - with a specific
  YANG type.
  """
  __slots__ = ('_pybind_generated_by', '_netconf_operation_type', '_path_helper', '_yang_name', '_extmethods', '_module_name', '_namespace','__task_id','__operation_name',)

  _yang_name = 'blocking-task'
  _module_name = 'tasks'
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'tasks_rpc', u'get-active-task-details', u'output', u'blocked-by', u'blocking-task']

  def _get_task_id(self):
    """
    Getter method for task_id, mapped from YANG variable /tasks_rpc/get_active_task_details/output/blocked_by/blocking_task/task_id (string)
  ...
  def _set_task_id(self, v, load=False):
    """
    Setter method for task_id, mapped from YANG variable /tasks_rpc/get_active_task_details/output/blocked_by/blocking_task/task_id (string)
  ...
  def _get_operation_name(self):
    """
    Getter method for operation_name, mapped from YANG variable /tasks_rpc/get_active_task_details/output/blocked_by/blocking_task/operation_name (string)
  ...
  def _set_operation_name(self, v, load=False):
    """
    Setter method for operation_name, mapped from YANG variable /tasks_rpc/get_active_task_details/output/blocked_by/blocking_task/operation_name (string)
    If this variable is read-only (config: false) in the
  ...
  _pyangbind_elements = collections.OrderedDict([('task_id', task_id), ('operation_name', operation_name), ])
