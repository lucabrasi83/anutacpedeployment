...
class task(PybindBase):
  ...
  from YANG module tasks - based on the path /tasks_rpc/get-active-task-details/output/blocking/task. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'tasks_rpc', u'get-active-task-details', u'output', u'blocking', u'task']

  def _get_task_id(self):
    """
    Getter method for task_id, mapped from YANG variable /tasks_rpc/get_active_task_details/output/blocking/task/task_id (string)
  ...
  def _set_task_id(self, v, load=False):
    """
    Setter method for task_id, mapped from YANG variable /tasks_rpc/get_active_task_details/output/blocking/task/task_id (string)
  ...
  def _get_operation_name(self):
    """
    Getter method for operation_name, mapped from YANG variable /tasks_rpc/get_active_task_details/output/blocking/task/operation_name (string)
  ...
  def _set_operation_name(self, v, load=False):
    """
    Setter method for operation_name, mapped from YANG variable /tasks_rpc/get_active_task_details/output/blocking/task/operation_name (string)
    If this variable is read-only (config: false) in the
