...
class input(PybindBase):
  ...
  from YANG module tasks - based on the path /tasks_rpc/get-tasks-by-status/input. Each member element of
  the container is represented as a class variable - with a specific
  YANG type.
  """
  __slots__ = ('_pybind_generated_by', '_netconf_operation_type', '_path_helper', '_yang_name', '_extmethods', '_module_name', '_namespace','__status',)
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'tasks_rpc', u'get-tasks-by-status', u'input']

  def _get_status(self):
    """
    Getter method for status, mapped from YANG variable /tasks_rpc/get_tasks_by_status/input/status (ncx-types:taskstatus-enum)
...
CANCELLED
  ...
  def _set_status(self, v, load=False):
    """
    Setter method for status, mapped from YANG variable /tasks_rpc/get_tasks_by_status/input/status (ncx-types:taskstatus-enum)
...
CANCELLED
  ...
  _pyangbind_elements = collections.OrderedDict([('status', status), ])
