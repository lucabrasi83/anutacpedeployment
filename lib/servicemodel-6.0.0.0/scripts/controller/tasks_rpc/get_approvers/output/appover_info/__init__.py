...
class appover_info(PybindBase):
  ...
  from YANG module tasks - based on the path /tasks_rpc/get-approvers/output/appover-info. Each member element of
  ...
  def __init__(self, *args, **kwargs):
    ...
    self.__notes = YANGDynClass(base=unicode, is_leaf=True, yang_name="notes", module_name="tasks", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=False, namespace='http://anutanetworks.com/tasks', defining_module='tasks', yang_type='string', is_config=True)
    self.__approver = YANGDynClass(base=unicode, is_leaf=True, yang_name="approver", module_name="tasks", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=False, namespace='http://anutanetworks.com/tasks', defining_module='tasks', yang_type='string', is_config=True)
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'tasks_rpc', u'get-approvers', u'output', u'appover-info']

  def _get_approver(self):
    """
    Getter method for approver, mapped from YANG variable /tasks_rpc/get_approvers/output/appover_info/approver (string)
  ...
  def _set_approver(self, v, load=False):
    """
    Setter method for approver, mapped from YANG variable /tasks_rpc/get_approvers/output/appover_info/approver (string)
    ...
    try:
      if isEmpty(v):
        return
      t = YANGDynClass(v,base=unicode, is_leaf=True, yang_name="approver", module_name="tasks", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=False, namespace='http://anutanetworks.com/tasks', defining_module='tasks', yang_type='string', is_config=True)
    except (TypeError, ValueError):
      raise ValueError({
          'error-string': """approver must be of a type compatible with string""",
          'defined-type': "string",
          'generated-type': """YANGDynClass(base=unicode, is_leaf=True, yang_name="approver", module_name="tasks", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=False, namespace='http://anutanetworks.com/tasks', defining_module='tasks', yang_type='string', is_config=True)""",
        })
  ...
  def _get_notes(self):
    """
    Getter method for notes, mapped from YANG variable /tasks_rpc/get_approvers/output/appover_info/notes (string)
  ...
  def _set_notes(self, v, load=False):
    """
    Setter method for notes, mapped from YANG variable /tasks_rpc/get_approvers/output/appover_info/notes (string)
    If this variable is read-only (config: false) in the
    ...
    try:
      if isEmpty(v):
        return
      t = YANGDynClass(v,base=unicode, is_leaf=True, yang_name="notes", module_name="tasks", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=False, namespace='http://anutanetworks.com/tasks', defining_module='tasks', yang_type='string', is_config=True)
    except (TypeError, ValueError):
      raise ValueError({
          'error-string': """notes must be of a type compatible with string""",
          'defined-type': "string",
          'generated-type': """YANGDynClass(base=unicode, is_leaf=True, yang_name="notes", module_name="tasks", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=False, namespace='http://anutanetworks.com/tasks', defining_module='tasks', yang_type='string', is_config=True)""",
        })
  ...
  def _get_status(self):
    """
    Getter method for status, mapped from YANG variable /tasks_rpc/get_approvers/output/appover_info/status (ncx-types:taskstatus-enum)
  ...
  def _set_status(self, v, load=False):
    """
    Setter method for status, mapped from YANG variable /tasks_rpc/get_approvers/output/appover_info/status (ncx-types:taskstatus-enum)
    If this variable is read-only (config: false) in the
