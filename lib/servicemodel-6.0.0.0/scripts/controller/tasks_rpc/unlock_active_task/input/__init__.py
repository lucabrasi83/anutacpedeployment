...
class input(PybindBase):
  ...
  from YANG module tasks - based on the path /tasks_rpc/unlock-active-task/input. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'tasks_rpc', u'unlock-active-task', u'input']

  def _get_task_id(self):
    """
    Getter method for task_id, mapped from YANG variable /tasks_rpc/unlock_active_task/input/task_id (string)
  ...
  def _set_task_id(self, v, load=False):
    """
    Setter method for task_id, mapped from YANG variable /tasks_rpc/unlock_active_task/input/task_id (string)
