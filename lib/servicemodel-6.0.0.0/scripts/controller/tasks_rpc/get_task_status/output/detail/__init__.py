...
class detail(PybindBase):
  ...
  from YANG module tasks - based on the path /tasks_rpc/get-task-status/output/detail. Each member element of
  the container is represented as a class variable - with a specific
  YANG type.
  """
  __slots__ = ('_pybind_generated_by', '_netconf_operation_type', '_path_helper', '_yang_name', '_extmethods', '_module_name', '_namespace','__task_id','__status','__retriable','__percentComplete',)
  ...
  def __init__(self, *args, **kwargs):
    ...
    self.__retriable = YANGDynClass(base=YANGBool, is_leaf=True, yang_name="retriable", module_name="tasks", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=False, namespace='http://anutanetworks.com/tasks', defining_module='tasks', yang_type='boolean', is_config=True)
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'tasks_rpc', u'get-task-status', u'output', u'detail']

  def _get_task_id(self):
    """
    Getter method for task_id, mapped from YANG variable /tasks_rpc/get_task_status/output/detail/task_id (string)
  ...
  def _set_task_id(self, v, load=False):
    """
    Setter method for task_id, mapped from YANG variable /tasks_rpc/get_task_status/output/detail/task_id (string)
  ...
  def _get_status(self):
    """
    Getter method for status, mapped from YANG variable /tasks_rpc/get_task_status/output/detail/status (ncx-types:taskstatus-enum)
...
CANCELLED
  ...
  def _set_status(self, v, load=False):
    """
    Setter method for status, mapped from YANG variable /tasks_rpc/get_task_status/output/detail/status (ncx-types:taskstatus-enum)
    If this variable is read-only (config: false) in the
...
CANCELLED
  ...
  def _get_retriable(self):
    """
    Getter method for retriable, mapped from YANG variable /tasks_rpc/get_task_status/output/detail/retriable (boolean)

    YANG Description: retriable: True/False
    """
    return self.__retriable
      
  def _set_retriable(self, v, load=False):
    """
    Setter method for retriable, mapped from YANG variable /tasks_rpc/get_task_status/output/detail/retriable (boolean)
    If this variable is read-only (config: false) in the
    source YANG file, then _set_retriable is considered as a private
    method. Backends looking to populate this variable should
    do so via calling thisObj._set_retriable() directly.
    ...
    try:
      if isEmpty(v):
        return
      t = YANGDynClass(v,base=YANGBool, is_leaf=True, yang_name="retriable", module_name="tasks", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=False, namespace='http://anutanetworks.com/tasks', defining_module='tasks', yang_type='boolean', is_config=True)
    except (TypeError, ValueError):
      raise ValueError({
          'error-string': """retriable must be of a type compatible with boolean""",
          'defined-type': "boolean",
          'generated-type': """YANGDynClass(base=YANGBool, is_leaf=True, yang_name="retriable", module_name="tasks", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=False, namespace='http://anutanetworks.com/tasks', defining_module='tasks', yang_type='boolean', is_config=True)""",
        })
  ...
  def _unset_retriable(self):
    self.__retriable = YANGDynClass(base=YANGBool, is_leaf=True, yang_name="retriable", module_name="tasks", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=False, namespace='http://anutanetworks.com/tasks', defining_module='tasks', yang_type='boolean', is_config=True)


  def _get_percentComplete(self):
    """
    Getter method for percentComplete, mapped from YANG variable /tasks_rpc/get_task_status/output/detail/percentComplete (int8)
  ...
  def _set_percentComplete(self, v, load=False):
    """
    Setter method for percentComplete, mapped from YANG variable /tasks_rpc/get_task_status/output/detail/percentComplete (int8)
    If this variable is read-only (config: false) in the
  ...
  retriable = __builtin__.property(_get_retriable, _set_retriable)
  percentComplete = __builtin__.property(_get_percentComplete, _set_percentComplete)


  _pyangbind_elements = collections.OrderedDict([('task_id', task_id), ('status', status), ('retriable', retriable), ('percentComplete', percentComplete), ])
