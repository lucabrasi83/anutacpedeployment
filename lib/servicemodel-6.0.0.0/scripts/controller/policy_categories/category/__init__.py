...
class category(PybindBase):
  ...
  from YANG module device-comp - based on the path /policy-categories/category. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'policy-categories', u'category']

  def _get_name(self):
    """
    Getter method for name, mapped from YANG variable /policy_categories/category/name (string)
  ...
  def _set_name(self, v, load=False):
    """
    Setter method for name, mapped from YANG variable /policy_categories/category/name (string)
  ...
  def _get_description(self):
    """
    Getter method for description, mapped from YANG variable /policy_categories/category/description (string)
  ...
  def _set_description(self, v, load=False):
    """
    Setter method for description, mapped from YANG variable /policy_categories/category/description (string)
    If this variable is read-only (config: false) in the
