...
def isEmpty(val):
    ...
    return False
import data_diff
class upgrade_script(PybindBase):
  """
  This class was auto-generated by the PythonClass plugin for PYANG
  from YANG module controller - based on the path /migrations/migrations/migration-task/upgrade-script. Each member element of
  the container is represented as a class variable - with a specific
  YANG type.
  """
  __slots__ = ('_pybind_generated_by', '_netconf_operation_type', '_path_helper', '_yang_name', '_extmethods', '_module_name', '_namespace','__data_diff',)

  _yang_name = 'upgrade-script'
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'migrations', u'migrations', u'migration-task', u'upgrade-script']

  def _get_data_diff(self):
    """
    Getter method for data_diff, mapped from YANG variable /migrations/migrations/migration_task/upgrade_script/data_diff (container)
    """
    return self.__data_diff
      
  def _set_data_diff(self, v, load=False):
    """
    Setter method for data_diff, mapped from YANG variable /migrations/migrations/migration_task/upgrade_script/data_diff (container)
  ...
  _pyangbind_elements = collections.OrderedDict([('data_diff', data_diff), ])
