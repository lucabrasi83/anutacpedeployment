...
class migration_task(PybindBase):
  """
  This class was auto-generated by the PythonClass plugin for PYANG
  from YANG module controller - based on the path /migrations/migrations/migration-task. Each member element of
  the container is represented as a class variable - with a specific
  YANG type.
  """
  __slots__ = ('_pybind_generated_by', '_netconf_operation_type', '_path_helper', '_yang_name', '_extmethods', '_module_name', '_namespace','__task_id','__name','__package','__state_machine_log','__upgrade_analysis','__upgrade_script',)

  _yang_name = 'migration-task'
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'migrations', u'migrations', u'migration-task']

  def _get_task_id(self):
    """
    Getter method for task_id, mapped from YANG variable /migrations/migrations/migration_task/task_id (string)
  ...
  def _set_task_id(self, v, load=False):
    """
    Setter method for task_id, mapped from YANG variable /migrations/migrations/migration_task/task_id (string)
  ...
  def _get_name(self):
    """
    Getter method for name, mapped from YANG variable /migrations/migrations/migration_task/name (string)
  ...
  def _set_name(self, v, load=False):
    """
    Setter method for name, mapped from YANG variable /migrations/migrations/migration_task/name (string)
    If this variable is read-only (config: false) in the
  ...
  def _get_package(self):
    """
    Getter method for package, mapped from YANG variable /migrations/migrations/migration_task/package (list)
    """
    return self.__package
      
  def _set_package(self, v, load=False):
    """
    Setter method for package, mapped from YANG variable /migrations/migrations/migration_task/package (list)
    If this variable is read-only (config: false) in the
  ...
  def _get_state_machine_log(self):
    """
    Getter method for state_machine_log, mapped from YANG variable /migrations/migrations/migration_task/state_machine_log (container)
    """
    return self.__state_machine_log
      
  def _set_state_machine_log(self, v, load=False):
    """
    Setter method for state_machine_log, mapped from YANG variable /migrations/migrations/migration_task/state_machine_log (container)
    If this variable is read-only (config: false) in the
  ...
  def _get_upgrade_analysis(self):
    """
    Getter method for upgrade_analysis, mapped from YANG variable /migrations/migrations/migration_task/upgrade_analysis (container)
    """
    return self.__upgrade_analysis
      
  def _set_upgrade_analysis(self, v, load=False):
    """
    Setter method for upgrade_analysis, mapped from YANG variable /migrations/migrations/migration_task/upgrade_analysis (container)
    If this variable is read-only (config: false) in the
  ...
  def _get_upgrade_script(self):
    """
    Getter method for upgrade_script, mapped from YANG variable /migrations/migrations/migration_task/upgrade_script (container)
    """
    return self.__upgrade_script
      
  def _set_upgrade_script(self, v, load=False):
    """
    Setter method for upgrade_script, mapped from YANG variable /migrations/migrations/migration_task/upgrade_script (container)
    If this variable is read-only (config: false) in the
  ...
  _pyangbind_elements = collections.OrderedDict([('task_id', task_id), ('name', name), ('package', package), ('state_machine_log', state_machine_log), ('upgrade_analysis', upgrade_analysis), ('upgrade_script', upgrade_script), ])
