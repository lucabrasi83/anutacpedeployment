...
class upgrade_analysis(PybindBase):
  ...
  from YANG module controller - based on the path /migrations/migrations/migration-task/upgrade-analysis. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'migrations', u'migrations', u'migration-task', u'upgrade-analysis']

  def _get_schema_diff(self):
    """
    Getter method for schema_diff, mapped from YANG variable /migrations/migrations/migration_task/upgrade_analysis/schema_diff (container)
    """
    return self.__schema_diff
      
  def _set_schema_diff(self, v, load=False):
    """
    Setter method for schema_diff, mapped from YANG variable /migrations/migrations/migration_task/upgrade_analysis/schema_diff (container)
  ...
  def _get_data_diff(self):
    """
    Getter method for data_diff, mapped from YANG variable /migrations/migrations/migration_task/upgrade_analysis/data_diff (container)
    """
    return self.__data_diff
      
  def _set_data_diff(self, v, load=False):
    """
    Setter method for data_diff, mapped from YANG variable /migrations/migrations/migration_task/upgrade_analysis/data_diff (container)
    If this variable is read-only (config: false) in the
