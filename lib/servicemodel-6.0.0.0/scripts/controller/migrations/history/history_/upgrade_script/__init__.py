...
class upgrade_script(PybindBase):
  ...
  from YANG module controller - based on the path /migrations/history/history/upgrade-script. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'migrations', u'history', u'history', u'upgrade-script']

  def _get_data_diff(self):
    """
    Getter method for data_diff, mapped from YANG variable /migrations/history/history/upgrade_script/data_diff (container)
    """
    return self.__data_diff
      
  def _set_data_diff(self, v, load=False):
    """
    Setter method for data_diff, mapped from YANG variable /migrations/history/history/upgrade_script/data_diff (container)
