...
class schema_diff_item(PybindBase):
  ...
  from YANG module controller - based on the path /migrations/history/history/upgrade-analysis/schema-diff/schema-diff-item. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'migrations', u'history', u'history', u'upgrade-analysis', u'schema-diff', u'schema-diff-item']

  def _get_schema_path(self):
    """
    Getter method for schema_path, mapped from YANG variable /migrations/history/history/upgrade_analysis/schema_diff/schema_diff_item/schema_path (string)
  ...
  def _set_schema_path(self, v, load=False):
    """
    Setter method for schema_path, mapped from YANG variable /migrations/history/history/upgrade_analysis/schema_diff/schema_diff_item/schema_path (string)
  ...
  def _get_diff_type(self):
    """
    Getter method for diff_type, mapped from YANG variable /migrations/history/history/upgrade_analysis/schema_diff/schema_diff_item/diff_type (diff-type)
...
DELETE
  ...
  def _set_diff_type(self, v, load=False):
    """
    Setter method for diff_type, mapped from YANG variable /migrations/history/history/upgrade_analysis/schema_diff/schema_diff_item/diff_type (diff-type)
    If this variable is read-only (config: false) in the
...
DELETE
  ...
  def _get_added_properties(self):
    """
    Getter method for added_properties, mapped from YANG variable /migrations/history/history/upgrade_analysis/schema_diff/schema_diff_item/added_properties (container)
    """
    return self.__added_properties
      
  def _set_added_properties(self, v, load=False):
    """
    Setter method for added_properties, mapped from YANG variable /migrations/history/history/upgrade_analysis/schema_diff/schema_diff_item/added_properties (container)
    If this variable is read-only (config: false) in the
  ...
  def _get_removed_properties(self):
    """
    Getter method for removed_properties, mapped from YANG variable /migrations/history/history/upgrade_analysis/schema_diff/schema_diff_item/removed_properties (container)
    """
    return self.__removed_properties
      
  def _set_removed_properties(self, v, load=False):
    """
    Setter method for removed_properties, mapped from YANG variable /migrations/history/history/upgrade_analysis/schema_diff/schema_diff_item/removed_properties (container)
    If this variable is read-only (config: false) in the
