...
class transition(PybindBase):
  ...
  from YANG module controller - based on the path /migrations/history/history/state-machine-log/transition. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'migrations', u'history', u'history', u'state-machine-log', u'transition']

  def _get_index(self):
    """
    Getter method for index, mapped from YANG variable /migrations/history/history/state_machine_log/transition/index (uint32)
  ...
  def _set_index(self, v, load=False):
    """
    Setter method for index, mapped from YANG variable /migrations/history/history/state_machine_log/transition/index (uint32)
  ...
  def _get_from_state(self):
    """
    Getter method for from_state, mapped from YANG variable /migrations/history/history/state_machine_log/transition/from_state (string)
  ...
  def _set_from_state(self, v, load=False):
    """
    Setter method for from_state, mapped from YANG variable /migrations/history/history/state_machine_log/transition/from_state (string)
    If this variable is read-only (config: false) in the
  ...
  def _get_event_name(self):
    """
    Getter method for event_name, mapped from YANG variable /migrations/history/history/state_machine_log/transition/event_name (string)
  ...
  def _set_event_name(self, v, load=False):
    """
    Setter method for event_name, mapped from YANG variable /migrations/history/history/state_machine_log/transition/event_name (string)
    If this variable is read-only (config: false) in the
  ...
  def _get_next_state(self):
    """
    Getter method for next_state, mapped from YANG variable /migrations/history/history/state_machine_log/transition/next_state (string)
  ...
  def _set_next_state(self, v, load=False):
    """
    Setter method for next_state, mapped from YANG variable /migrations/history/history/state_machine_log/transition/next_state (string)
    If this variable is read-only (config: false) in the
  ...
  def _get_time(self):
    """
    Getter method for time, mapped from YANG variable /migrations/history/history/state_machine_log/transition/time (string)
  ...
  def _set_time(self, v, load=False):
    """
    Setter method for time, mapped from YANG variable /migrations/history/history/state_machine_log/transition/time (string)
    If this variable is read-only (config: false) in the
  ...
  def _get_timestamp(self):
    """
    Getter method for timestamp, mapped from YANG variable /migrations/history/history/state_machine_log/transition/timestamp (uint32)
  ...
  def _set_timestamp(self, v, load=False):
    """
    Setter method for timestamp, mapped from YANG variable /migrations/history/history/state_machine_log/transition/timestamp (uint32)
    If this variable is read-only (config: false) in the
  ...
  def _get_event_data(self):
    """
    Getter method for event_data, mapped from YANG variable /migrations/history/history/state_machine_log/transition/event_data (string)
  ...
  def _set_event_data(self, v, load=False):
    """
    Setter method for event_data, mapped from YANG variable /migrations/history/history/state_machine_log/transition/event_data (string)
    If this variable is read-only (config: false) in the
