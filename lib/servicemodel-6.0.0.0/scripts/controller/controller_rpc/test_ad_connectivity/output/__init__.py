...
class output(PybindBase):
  ...
  from YANG module controller - based on the path /controller_rpc/test-ad-connectivity/output. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'controller_rpc', u'test-ad-connectivity', u'output']

  def _get_result(self):
    """
    Getter method for result, mapped from YANG variable /controller_rpc/test_ad_connectivity/output/result (string)
  ...
  def _set_result(self, v, load=False):
    """
    Setter method for result, mapped from YANG variable /controller_rpc/test_ad_connectivity/output/result (string)
