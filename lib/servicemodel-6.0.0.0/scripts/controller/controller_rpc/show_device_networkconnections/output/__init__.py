...
class output(PybindBase):
  ...
  from YANG module controller - based on the path /controller_rpc/show-device-networkconnections/output. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'controller_rpc', u'show-device-networkconnections', u'output']

  def _get_result(self):
    """
    Getter method for result, mapped from YANG variable /controller_rpc/show_device_networkconnections/output/result (string)
  ...
  def _set_result(self, v, load=False):
    """
    Setter method for result, mapped from YANG variable /controller_rpc/show_device_networkconnections/output/result (string)
