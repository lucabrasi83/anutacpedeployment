...
class input(PybindBase):
  ...
  from YANG module controller - based on the path /controller_rpc/assign-owner-and-shared/input. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'controller_rpc', u'assign-owner-and-shared', u'input']

  def _get_entity(self):
    """
    Getter method for entity, mapped from YANG variable /controller_rpc/assign_owner_and_shared/input/entity (list)
    """
    return self.__entity
      
  def _set_entity(self, v, load=False):
    """
    Setter method for entity, mapped from YANG variable /controller_rpc/assign_owner_and_shared/input/entity (list)
