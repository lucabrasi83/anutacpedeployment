...
class output(PybindBase):
  ...
  from YANG module controller - based on the path /controller_rpc/get-current-ownership-assignments/output. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'controller_rpc', u'get-current-ownership-assignments', u'output']

  def _get_entity(self):
    """
    Getter method for entity, mapped from YANG variable /controller_rpc/get_current_ownership_assignments/output/entity (list)
    """
    return self.__entity
      
  def _set_entity(self, v, load=False):
    """
    Setter method for entity, mapped from YANG variable /controller_rpc/get_current_ownership_assignments/output/entity (list)
