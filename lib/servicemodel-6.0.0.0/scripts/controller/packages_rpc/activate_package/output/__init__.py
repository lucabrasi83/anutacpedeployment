...
class output(PybindBase):
  ...
  from YANG module packages - based on the path /packages_rpc/activate-package/output. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'packages_rpc', u'activate-package', u'output']

  def _get_task_id(self):
    """
    Getter method for task_id, mapped from YANG variable /packages_rpc/activate_package/output/task_id (string)

    YANG Description: Id of the task created to activate the specified package. Use rpc get-basic-task-detail to monitor the package activation status
    """
    return self.__task_id
      
  def _set_task_id(self, v, load=False):
    """
    Setter method for task_id, mapped from YANG variable /packages_rpc/activate_package/output/task_id (string)
