...
import input
import output
class activate_package(PybindBase):
  """
  This class was auto-generated by the PythonClass plugin for PYANG
  from YANG module packages - based on the path /packages_rpc/activate-package. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'packages_rpc', u'activate-package']

  def _get_input(self):
    """
    Getter method for input, mapped from YANG variable /packages_rpc/activate_package/input (input)
    """
    return self.__input
      
  def _set_input(self, v, load=False):
    """
    Setter method for input, mapped from YANG variable /packages_rpc/activate_package/input (input)
  ...
  def _get_output(self):
    """
    Getter method for output, mapped from YANG variable /packages_rpc/activate_package/output (output)
    """
    return self.__output
      
  def _set_output(self, v, load=False):
    """
    Setter method for output, mapped from YANG variable /packages_rpc/activate_package/output (output)
    If this variable is read-only (config: false) in the
