...
class output(PybindBase):
  ...
  from YANG module packages - based on the path /packages_rpc/deactivate-package/output. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'packages_rpc', u'deactivate-package', u'output']

  def _get_task_id(self):
    """
    Getter method for task_id, mapped from YANG variable /packages_rpc/deactivate_package/output/task_id (string)

    YANG Description: Id of the task created to deactivate the specified package. Use rpc get-basic-task-detail to monitor the package deactivation status
    """
    return self.__task_id
      
  def _set_task_id(self, v, load=False):
    """
    Setter method for task_id, mapped from YANG variable /packages_rpc/deactivate_package/output/task_id (string)
