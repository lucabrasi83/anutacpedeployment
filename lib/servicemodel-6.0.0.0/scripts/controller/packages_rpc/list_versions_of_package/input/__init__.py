...
class input(PybindBase):
  ...
  from YANG module packages - based on the path /packages_rpc/list-versions-of-package/input. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'packages_rpc', u'list-versions-of-package', u'input']

  def _get_name(self):
    """
    Getter method for name, mapped from YANG variable /packages_rpc/list_versions_of_package/input/name (string)
  ...
  def _set_name(self, v, load=False):
    """
    Setter method for name, mapped from YANG variable /packages_rpc/list_versions_of_package/input/name (string)
