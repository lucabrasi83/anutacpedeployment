...
class input(PybindBase):
  ...
  from YANG module packages - based on the path /packages_rpc/download-package/input. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'packages_rpc', u'download-package', u'input']

  def _get_name(self):
    """
    Getter method for name, mapped from YANG variable /packages_rpc/download_package/input/name (string)
  ...
  def _set_name(self, v, load=False):
    """
    Setter method for name, mapped from YANG variable /packages_rpc/download_package/input/name (string)
  ...
  def _get_version(self):
    """
    Getter method for version, mapped from YANG variable /packages_rpc/download_package/input/version (string)
  ...
  def _set_version(self, v, load=False):
    """
    Setter method for version, mapped from YANG variable /packages_rpc/download_package/input/version (string)
    If this variable is read-only (config: false) in the
