...
def isEmpty(val):
    ...
    return False
import template
class compliance_templates(PybindBase):
  """
  This class was auto-generated by the PythonClass plugin for PYANG
  from YANG module device-comp - based on the path /compliance-templates. Each member element of
  ...
  _yang_name = 'compliance-templates'
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'compliance-templates']

  def _get_template(self):
    """
    Getter method for template, mapped from YANG variable /compliance_templates/template (list)
  ...
  def _set_template(self, v, load=False):
    """
    Setter method for template, mapped from YANG variable /compliance_templates/template (list)
