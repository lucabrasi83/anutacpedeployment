...
def isEmpty(val):
    ...
    return False
class capacity_alarm_spec(PybindBase):
  """
  This class was auto-generated by the PythonClass plugin for PYANG
  from YANG module capacities - based on the path /capacity-alarm-specs/capacity-alarm-spec. Each member element of
  the container is represented as a class variable - with a specific
  YANG type.
  """
  __slots__ = ('_pybind_generated_by', '_netconf_operation_type', '_path_helper', '_yang_name', '_extmethods', '_module_name', '_namespace','__capacity_type','__description','__alarm_spec_type',)

  _yang_name = 'capacity-alarm-spec'
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'capacity-alarm-specs', u'capacity-alarm-spec']

  def _get_capacity_type(self):
    """
    Getter method for capacity_type, mapped from YANG variable /capacity_alarm_specs/capacity_alarm_spec/capacity_type (leafref)
  ...
  def _set_capacity_type(self, v, load=False):
    """
    Setter method for capacity_type, mapped from YANG variable /capacity_alarm_specs/capacity_alarm_spec/capacity_type (leafref)
  ...
  def _get_description(self):
    """
    Getter method for description, mapped from YANG variable /capacity_alarm_specs/capacity_alarm_spec/description (string)
  ...
  def _set_description(self, v, load=False):
    """
    Setter method for description, mapped from YANG variable /capacity_alarm_specs/capacity_alarm_spec/description (string)
    If this variable is read-only (config: false) in the
  ...
  def _get_alarm_spec_type(self):
    """
    Getter method for alarm_spec_type, mapped from YANG variable /capacity_alarm_specs/capacity_alarm_spec/alarm_spec_type (leafref)
  ...
  def _set_alarm_spec_type(self, v, load=False):
    """
    Setter method for alarm_spec_type, mapped from YANG variable /capacity_alarm_specs/capacity_alarm_spec/alarm_spec_type (leafref)
    If this variable is read-only (config: false) in the
  ...
  _pyangbind_elements = collections.OrderedDict([('capacity_type', capacity_type), ('description', description), ('alarm_spec_type', alarm_spec_type), ])
