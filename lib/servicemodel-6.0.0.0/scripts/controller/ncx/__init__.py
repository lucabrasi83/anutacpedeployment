...
class ncx(PybindBase):
  ...
  from YANG module controller - based on the path /ncx. Each member element of
  the container is represented as a class variable - with a specific
  YANG type.
  """
  __slots__ = ('_pybind_generated_by', '_netconf_operation_type', '_path_helper', '_yang_name', '_extmethods', '_module_name', '_namespace','__components',)
  ...
  def _get_components(self):
    """
    Getter method for components, mapped from YANG variable /ncx/components (container)
    """
    return self.__components
      
  def _set_components(self, v, load=False):
    """
    Setter method for components, mapped from YANG variable /ncx/components (container)
  ...
  _pyangbind_elements = collections.OrderedDict([('components', components), ])
