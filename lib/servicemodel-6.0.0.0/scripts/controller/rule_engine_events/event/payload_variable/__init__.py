...
class payload_variable(PybindBase):
  ...
  from YANG module controller - based on the path /rule-engine-events/event/payload-variable. Each member element of
  ...
  _module_name = 'rule-engine-events'
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'rule-engine-events', u'event', u'payload-variable']

  def _get_name(self):
    """
    Getter method for name, mapped from YANG variable /rule_engine_events/event/payload_variable/name (string)

    YANG Description: Name of the variable as desired in the service implementation
    """
    return self.__name
      
  def _set_name(self, v, load=False):
    """
    Setter method for name, mapped from YANG variable /rule_engine_events/event/payload_variable/name (string)
