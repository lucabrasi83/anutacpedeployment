...
class input(PybindBase):
  ...
  from YANG module vnfdriver - based on the path /vnfdriver_rpc/vm-reboot/input. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'vnfdriver_rpc', u'vm-reboot', u'input']

  def _get_mgmt_ip(self):
    """
    Getter method for mgmt_ip, mapped from YANG variable /vnfdriver_rpc/vm_reboot/input/mgmt_ip (inet:ip-address)
  ...
  def _set_mgmt_ip(self, v, load=False):
    """
    Setter method for mgmt_ip, mapped from YANG variable /vnfdriver_rpc/vm_reboot/input/mgmt_ip (inet:ip-address)
  ...
  def _get_user_name(self):
    """
    Getter method for user_name, mapped from YANG variable /vnfdriver_rpc/vm_reboot/input/user_name (string)
  ...
  def _set_user_name(self, v, load=False):
    """
    Setter method for user_name, mapped from YANG variable /vnfdriver_rpc/vm_reboot/input/user_name (string)
    If this variable is read-only (config: false) in the
  ...
  def _get_password(self):
    """
    Getter method for password, mapped from YANG variable /vnfdriver_rpc/vm_reboot/input/password (ndt:password)
  ...
  def _set_password(self, v, load=False):
    """
    Setter method for password, mapped from YANG variable /vnfdriver_rpc/vm_reboot/input/password (ndt:password)
    If this variable is read-only (config: false) in the
  ...
  def _get_name(self):
    """
    Getter method for name, mapped from YANG variable /vnfdriver_rpc/vm_reboot/input/name (string)
  ...
  def _set_name(self, v, load=False):
    """
    Setter method for name, mapped from YANG variable /vnfdriver_rpc/vm_reboot/input/name (string)
    If this variable is read-only (config: false) in the
  ...
  def _get_request_timeout(self):
    """
    Getter method for request_timeout, mapped from YANG variable /vnfdriver_rpc/vm_reboot/input/request_timeout (uint64)
  ...
  def _set_request_timeout(self, v, load=False):
    """
    Setter method for request_timeout, mapped from YANG variable /vnfdriver_rpc/vm_reboot/input/request_timeout (uint64)
    If this variable is read-only (config: false) in the
