...
class output(PybindBase):
  ...
  from YANG module vnfdriver - based on the path /vnfdriver_rpc/vm-assign-port-group/output. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'vnfdriver_rpc', u'vm-assign-port-group', u'output']

  def _get_response(self):
    """
    Getter method for response, mapped from YANG variable /vnfdriver_rpc/vm_assign_port_group/output/response (string)
  ...
  def _set_response(self, v, load=False):
    """
    Setter method for response, mapped from YANG variable /vnfdriver_rpc/vm_assign_port_group/output/response (string)
