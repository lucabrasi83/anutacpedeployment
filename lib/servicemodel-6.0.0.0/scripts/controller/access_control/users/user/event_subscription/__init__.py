...
class event_subscription(PybindBase):
  ...
  from YANG module controller - based on the path /access-control/users/user/event-subscription. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'access-control', u'users', u'user', u'event-subscription']

  def _get_id(self):
    """
    Getter method for id, mapped from YANG variable /access_control/users/user/event_subscription/id (uint8)
  ...
  def _set_id(self, v, load=False):
    """
    Setter method for id, mapped from YANG variable /access_control/users/user/event_subscription/id (uint8)
  ...
  def _get_naas_event_spec(self):
    """
    Getter method for naas_event_spec, mapped from YANG variable /access_control/users/user/event_subscription/naas_event_spec (leafref)
  ...
  def _set_naas_event_spec(self, v, load=False):
    """
    Setter method for naas_event_spec, mapped from YANG variable /access_control/users/user/event_subscription/naas_event_spec (leafref)
    If this variable is read-only (config: false) in the
  ...
  def _get_immediate_email(self):
    """
    Getter method for immediate_email, mapped from YANG variable /access_control/users/user/event_subscription/immediate_email (boolean)
  ...
  def _set_immediate_email(self, v, load=False):
    """
    Setter method for immediate_email, mapped from YANG variable /access_control/users/user/event_subscription/immediate_email (boolean)
    If this variable is read-only (config: false) in the
  ...
  def _get_schedule_email(self):
    """
    Getter method for schedule_email, mapped from YANG variable /access_control/users/user/event_subscription/schedule_email (schedule)
...
WEEKLY
  ...
  def _set_schedule_email(self, v, load=False):
    """
    Setter method for schedule_email, mapped from YANG variable /access_control/users/user/event_subscription/schedule_email (schedule)
    If this variable is read-only (config: false) in the
