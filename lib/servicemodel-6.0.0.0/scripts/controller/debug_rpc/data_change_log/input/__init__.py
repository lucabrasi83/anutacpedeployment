...
class input(PybindBase):
  ...
  from YANG module debug - based on the path /debug_rpc/data-change-log/input. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'debug_rpc', u'data-change-log', u'input']

  def _get_task_id(self):
    """
    Getter method for task_id, mapped from YANG variable /debug_rpc/data_change_log/input/task_id (string)
  ...
  def _set_task_id(self, v, load=False):
    """
    Setter method for task_id, mapped from YANG variable /debug_rpc/data_change_log/input/task_id (string)
