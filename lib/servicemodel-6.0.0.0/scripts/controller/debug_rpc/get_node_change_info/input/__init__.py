...
class input(PybindBase):
  ...
  from YANG module debug - based on the path /debug_rpc/get-node-change-info/input. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'debug_rpc', u'get-node-change-info', u'input']

  def _get_task_id(self):
    """
    Getter method for task_id, mapped from YANG variable /debug_rpc/get_node_change_info/input/task_id (string)
  ...
  def _set_task_id(self, v, load=False):
    """
    Setter method for task_id, mapped from YANG variable /debug_rpc/get_node_change_info/input/task_id (string)
