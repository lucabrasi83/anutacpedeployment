...
def isEmpty(val):
    ...
    return False
class db_delta(PybindBase):
  """
  This class was auto-generated by the PythonClass plugin for PYANG
  from YANG module debug - based on the path /debug_rpc/get-node-change-info/output/results/db-delta. Each member element of
  the container is represented as a class variable - with a specific
  YANG type.
  """
  __slots__ = ('_pybind_generated_by', '_netconf_operation_type', '_path_helper', '_yang_name', '_extmethods', '_module_name', '_namespace','__node_id','__rcpath','__task_id','__previous_value','__current_value','__mfd','__base_node_id',)
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'debug_rpc', u'get-node-change-info', u'output', u'results', u'db-delta']

  def _get_node_id(self):
    """
    Getter method for node_id, mapped from YANG variable /debug_rpc/get_node_change_info/output/results/db_delta/node_id (string)
  ...
  def _set_node_id(self, v, load=False):
    """
    Setter method for node_id, mapped from YANG variable /debug_rpc/get_node_change_info/output/results/db_delta/node_id (string)
  ...
  def _get_rcpath(self):
    """
    Getter method for rcpath, mapped from YANG variable /debug_rpc/get_node_change_info/output/results/db_delta/rcpath (string)
  ...
  def _set_rcpath(self, v, load=False):
    """
    Setter method for rcpath, mapped from YANG variable /debug_rpc/get_node_change_info/output/results/db_delta/rcpath (string)
    If this variable is read-only (config: false) in the
  ...
  def _get_task_id(self):
    """
    Getter method for task_id, mapped from YANG variable /debug_rpc/get_node_change_info/output/results/db_delta/task_id (string)
  ...
  def _set_task_id(self, v, load=False):
    """
    Setter method for task_id, mapped from YANG variable /debug_rpc/get_node_change_info/output/results/db_delta/task_id (string)
    If this variable is read-only (config: false) in the
  ...
  def _get_previous_value(self):
    """
    Getter method for previous_value, mapped from YANG variable /debug_rpc/get_node_change_info/output/results/db_delta/previous_value (string)
  ...
  def _set_previous_value(self, v, load=False):
    """
    Setter method for previous_value, mapped from YANG variable /debug_rpc/get_node_change_info/output/results/db_delta/previous_value (string)
    If this variable is read-only (config: false) in the
  ...
  def _get_current_value(self):
    """
    Getter method for current_value, mapped from YANG variable /debug_rpc/get_node_change_info/output/results/db_delta/current_value (string)
  ...
  def _set_current_value(self, v, load=False):
    """
    Setter method for current_value, mapped from YANG variable /debug_rpc/get_node_change_info/output/results/db_delta/current_value (string)
    If this variable is read-only (config: false) in the
  ...
  def _get_mfd(self):
    """
    Getter method for mfd, mapped from YANG variable /debug_rpc/get_node_change_info/output/results/db_delta/mfd (boolean)
  ...
  def _set_mfd(self, v, load=False):
    """
    Setter method for mfd, mapped from YANG variable /debug_rpc/get_node_change_info/output/results/db_delta/mfd (boolean)
    If this variable is read-only (config: false) in the
  ...
  def _get_base_node_id(self):
    """
    Getter method for base_node_id, mapped from YANG variable /debug_rpc/get_node_change_info/output/results/db_delta/base_node_id (string)
  ...
  def _set_base_node_id(self, v, load=False):
    """
    Setter method for base_node_id, mapped from YANG variable /debug_rpc/get_node_change_info/output/results/db_delta/base_node_id (string)
    If this variable is read-only (config: false) in the
  ...
  _pyangbind_elements = collections.OrderedDict([('node_id', node_id), ('rcpath', rcpath), ('task_id', task_id), ('previous_value', previous_value), ('current_value', current_value), ('mfd', mfd), ('base_node_id', base_node_id), ])
