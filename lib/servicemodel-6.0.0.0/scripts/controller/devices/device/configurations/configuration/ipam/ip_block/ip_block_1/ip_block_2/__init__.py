...
import ipv4_network
import ip_block_3
class ip_block_2(PybindBase):
  """
  This class was auto-generated by the PythonClass plugin for PYANG
  from YANG module controller - based on the path /devices/device/configurations/configuration/ipam/ip-block/ip-block-1/ip-block-2. Each member element of
  the container is represented as a class variable - with a specific
  YANG type.
  """
  __slots__ = ('_pybind_generated_by', '_netconf_operation_type', '_path_helper', '_yang_name', '_extmethods', '_module_name', '_namespace','__CIDR_Block','__id','__default_view','__ipv4_network','__ip_block_3',)

  _yang_name = 'ip-block-2'
  ...
  def __init__(self, *args, **kwargs):
    ...
    self.__ip_block_3 = YANGDynClass(base=YANGListType("CIDR_Block",ip_block_3.ip_block_3, yang_name="ip-block-3", module_name="bluecat", parent=self, is_container='list', user_ordered=False, path_helper=self._path_helper, yang_keys='CIDR-Block'), is_container='list', yang_name="ip-block-3", module_name="bluecat", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='http://anutanetworks.com/bluecat', defining_module='bluecat', yang_type='list', is_config=True)
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'devices', u'device', u'configurations', u'configuration', u'ipam', u'ip-block', u'ip-block-1', u'ip-block-2']

  def _get_CIDR_Block(self):
    """
    Getter method for CIDR_Block, mapped from YANG variable /devices/device/configurations/configuration/ipam/ip_block/ip_block_1/ip_block_2/CIDR_Block (string)
  ...
  def _set_CIDR_Block(self, v, load=False):
    """
    Setter method for CIDR_Block, mapped from YANG variable /devices/device/configurations/configuration/ipam/ip_block/ip_block_1/ip_block_2/CIDR_Block (string)
  ...
  def _get_id(self):
    """
    Getter method for id, mapped from YANG variable /devices/device/configurations/configuration/ipam/ip_block/ip_block_1/ip_block_2/id (string)
  ...
  def _set_id(self, v, load=False):
    """
    Setter method for id, mapped from YANG variable /devices/device/configurations/configuration/ipam/ip_block/ip_block_1/ip_block_2/id (string)
    If this variable is read-only (config: false) in the
  ...
  def _get_default_view(self):
    """
    Getter method for default_view, mapped from YANG variable /devices/device/configurations/configuration/ipam/ip_block/ip_block_1/ip_block_2/default_view (leafref)
  ...
  def _set_default_view(self, v, load=False):
    """
    Setter method for default_view, mapped from YANG variable /devices/device/configurations/configuration/ipam/ip_block/ip_block_1/ip_block_2/default_view (leafref)
    If this variable is read-only (config: false) in the
  ...
  def _get_ipv4_network(self):
    """
    Getter method for ipv4_network, mapped from YANG variable /devices/device/configurations/configuration/ipam/ip_block/ip_block_1/ip_block_2/ipv4_network (list)
    """
    return self.__ipv4_network
      
  def _set_ipv4_network(self, v, load=False):
    """
    Setter method for ipv4_network, mapped from YANG variable /devices/device/configurations/configuration/ipam/ip_block/ip_block_1/ip_block_2/ipv4_network (list)
    If this variable is read-only (config: false) in the
  ...
  def _get_ip_block_3(self):
    """
    Getter method for ip_block_3, mapped from YANG variable /devices/device/configurations/configuration/ipam/ip_block/ip_block_1/ip_block_2/ip_block_3 (list)
    """
    return self.__ip_block_3
      
  def _set_ip_block_3(self, v, load=False):
    """
    Setter method for ip_block_3, mapped from YANG variable /devices/device/configurations/configuration/ipam/ip_block/ip_block_1/ip_block_2/ip_block_3 (list)
    If this variable is read-only (config: false) in the
    source YANG file, then _set_ip_block_3 is considered as a private
    method. Backends looking to populate this variable should
    do so via calling thisObj._set_ip_block_3() directly.
    """
    try:
      if isEmpty(v):
        return
      ...
      raise ValueError({
          'error-string': """ip_block_3 must be of a type compatible with list""",
          'defined-type': "list",
          'generated-type': """YANGDynClass(base=YANGListType("CIDR_Block",ip_block_3.ip_block_3, yang_name="ip-block-3", module_name="bluecat", parent=self, is_container='list', user_ordered=False, path_helper=self._path_helper, yang_keys='CIDR-Block'), is_container='list', yang_name="ip-block-3", module_name="bluecat", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='http://anutanetworks.com/bluecat', defining_module='bluecat', yang_type='list', is_config=True)""",
        })
  ...
  ip_block_3 = __builtin__.property(_get_ip_block_3, _set_ip_block_3)


  _pyangbind_elements = collections.OrderedDict([('CIDR_Block', CIDR_Block), ('id', id), ('default_view', default_view), ('ipv4_network', ipv4_network), ('ip_block_3', ip_block_3), ])
