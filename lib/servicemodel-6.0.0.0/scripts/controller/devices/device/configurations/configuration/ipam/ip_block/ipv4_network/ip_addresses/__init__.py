...
class ip_addresses(PybindBase):
  ...
  from YANG module controller - based on the path /devices/device/configurations/configuration/ipam/ip-block/ipv4-network/ip-addresses. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'devices', u'device', u'configurations', u'configuration', u'ipam', u'ip-block', u'ipv4-network', u'ip-addresses']

  def _get_ip_address(self):
    """
    Getter method for ip_address, mapped from YANG variable /devices/device/configurations/configuration/ipam/ip_block/ipv4_network/ip_addresses/ip_address (inet:ipv4-address)
  ...
  def _set_ip_address(self, v, load=False):
    """
    Setter method for ip_address, mapped from YANG variable /devices/device/configurations/configuration/ipam/ip_block/ipv4_network/ip_addresses/ip_address (inet:ipv4-address)
  ...
  def _get_hostname(self):
    """
    Getter method for hostname, mapped from YANG variable /devices/device/configurations/configuration/ipam/ip_block/ipv4_network/ip_addresses/hostname (string)
  ...
  def _set_hostname(self, v, load=False):
    """
    Setter method for hostname, mapped from YANG variable /devices/device/configurations/configuration/ipam/ip_block/ipv4_network/ip_addresses/hostname (string)
    If this variable is read-only (config: false) in the
