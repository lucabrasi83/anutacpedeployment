...
class ipv4_network(PybindBase):
  ...
  from YANG module controller - based on the path /devices/device/configurations/configuration/ipam/ip-block/ip-block-1/ip-block-2/ipv4-network. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'devices', u'device', u'configurations', u'configuration', u'ipam', u'ip-block', u'ip-block-1', u'ip-block-2', u'ipv4-network']

  def _get_CIDR_Block(self):
    """
    Getter method for CIDR_Block, mapped from YANG variable /devices/device/configurations/configuration/ipam/ip_block/ip_block_1/ip_block_2/ipv4_network/CIDR_Block (string)
  ...
  def _set_CIDR_Block(self, v, load=False):
    """
    Setter method for CIDR_Block, mapped from YANG variable /devices/device/configurations/configuration/ipam/ip_block/ip_block_1/ip_block_2/ipv4_network/CIDR_Block (string)
  ...
  def _get_id(self):
    """
    Getter method for id, mapped from YANG variable /devices/device/configurations/configuration/ipam/ip_block/ip_block_1/ip_block_2/ipv4_network/id (string)
  ...
  def _set_id(self, v, load=False):
    """
    Setter method for id, mapped from YANG variable /devices/device/configurations/configuration/ipam/ip_block/ip_block_1/ip_block_2/ipv4_network/id (string)
    If this variable is read-only (config: false) in the
  ...
  def _get_ip_addresses(self):
    """
    Getter method for ip_addresses, mapped from YANG variable /devices/device/configurations/configuration/ipam/ip_block/ip_block_1/ip_block_2/ipv4_network/ip_addresses (list)
    """
    return self.__ip_addresses
      
  def _set_ip_addresses(self, v, load=False):
    """
    Setter method for ip_addresses, mapped from YANG variable /devices/device/configurations/configuration/ipam/ip_block/ip_block_1/ip_block_2/ipv4_network/ip_addresses (list)
    If this variable is read-only (config: false) in the
