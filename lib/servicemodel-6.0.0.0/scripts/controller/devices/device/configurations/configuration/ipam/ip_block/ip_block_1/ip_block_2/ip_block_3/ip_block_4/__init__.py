...
def isEmpty(val):
    ...
    return False
import ipv4_network
class ip_block_4(PybindBase):
  """
  This class was auto-generated by the PythonClass plugin for PYANG
  from YANG module controller - based on the path /devices/device/configurations/configuration/ipam/ip-block/ip-block-1/ip-block-2/ip-block-3/ip-block-4. Each member element of
  the container is represented as a class variable - with a specific
  YANG type.
  """
  __slots__ = ('_pybind_generated_by', '_netconf_operation_type', '_path_helper', '_yang_name', '_extmethods', '_module_name', '_namespace','__CIDR_Block','__id','__default_view','__ipv4_network',)

  _yang_name = 'ip-block-4'
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'devices', u'device', u'configurations', u'configuration', u'ipam', u'ip-block', u'ip-block-1', u'ip-block-2', u'ip-block-3', u'ip-block-4']

  def _get_CIDR_Block(self):
    """
    Getter method for CIDR_Block, mapped from YANG variable /devices/device/configurations/configuration/ipam/ip_block/ip_block_1/ip_block_2/ip_block_3/ip_block_4/CIDR_Block (string)
  ...
  def _set_CIDR_Block(self, v, load=False):
    """
    Setter method for CIDR_Block, mapped from YANG variable /devices/device/configurations/configuration/ipam/ip_block/ip_block_1/ip_block_2/ip_block_3/ip_block_4/CIDR_Block (string)
  ...
  def _get_id(self):
    """
    Getter method for id, mapped from YANG variable /devices/device/configurations/configuration/ipam/ip_block/ip_block_1/ip_block_2/ip_block_3/ip_block_4/id (string)
  ...
  def _set_id(self, v, load=False):
    """
    Setter method for id, mapped from YANG variable /devices/device/configurations/configuration/ipam/ip_block/ip_block_1/ip_block_2/ip_block_3/ip_block_4/id (string)
    If this variable is read-only (config: false) in the
  ...
  def _get_default_view(self):
    """
    Getter method for default_view, mapped from YANG variable /devices/device/configurations/configuration/ipam/ip_block/ip_block_1/ip_block_2/ip_block_3/ip_block_4/default_view (leafref)
  ...
  def _set_default_view(self, v, load=False):
    """
    Setter method for default_view, mapped from YANG variable /devices/device/configurations/configuration/ipam/ip_block/ip_block_1/ip_block_2/ip_block_3/ip_block_4/default_view (leafref)
    If this variable is read-only (config: false) in the
  ...
  def _get_ipv4_network(self):
    """
    Getter method for ipv4_network, mapped from YANG variable /devices/device/configurations/configuration/ipam/ip_block/ip_block_1/ip_block_2/ip_block_3/ip_block_4/ipv4_network (list)
    """
    return self.__ipv4_network
      
  def _set_ipv4_network(self, v, load=False):
    """
    Setter method for ipv4_network, mapped from YANG variable /devices/device/configurations/configuration/ipam/ip_block/ip_block_1/ip_block_2/ip_block_3/ip_block_4/ipv4_network (list)
    If this variable is read-only (config: false) in the
  ...
  _pyangbind_elements = collections.OrderedDict([('CIDR_Block', CIDR_Block), ('id', id), ('default_view', default_view), ('ipv4_network', ipv4_network), ])
