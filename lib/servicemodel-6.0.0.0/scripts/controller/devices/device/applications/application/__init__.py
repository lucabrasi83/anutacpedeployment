...
def isEmpty(val):
    ...
    return False
import application_port_ranges
class application(PybindBase):
  """
  This class was auto-generated by the PythonClass plugin for PYANG
  from YANG module controller - based on the path /devices/device/applications/application. Each member element of
  the container is represented as a class variable - with a specific
  YANG type.
  """
  __slots__ = ('_pybind_generated_by', '_netconf_operation_type', '_path_helper', '_yang_name', '_extmethods', '_module_name', '_namespace','__name','__description','__category','__app_protocol_name','__protocol_name','__protocol_number','__source_port','__dest_port','__icmp_type','__icmp_code','__icmp6_type','__icmp6_code','__device_group','__application_port_ranges','__virtual_device_name',)
  ...
  def __init__(self, *args, **kwargs):
    ...
    self.__application_port_ranges = YANGDynClass(base=YANGListType("protocol_type source_port dest_port",application_port_ranges.application_port_ranges, yang_name="application-port-ranges", module_name="firewall", parent=self, is_container='list', user_ordered=False, path_helper=self._path_helper, yang_keys='protocol-type source-port dest-port'), is_container='list', yang_name="application-port-ranges", module_name="firewall", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='http://anutanetworks.com/firewall', defining_module='firewall', yang_type='list', is_config=True)
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'devices', u'device', u'applications', u'application']

  def _get_name(self):
    """
    Getter method for name, mapped from YANG variable /devices/device/applications/application/name (string)
  ...
  def _set_name(self, v, load=False):
    """
    Setter method for name, mapped from YANG variable /devices/device/applications/application/name (string)
  ...
  def _get_description(self):
    """
    Getter method for description, mapped from YANG variable /devices/device/applications/application/description (string)
  ...
  def _set_description(self, v, load=False):
    """
    Setter method for description, mapped from YANG variable /devices/device/applications/application/description (string)
    If this variable is read-only (config: false) in the
  ...
  def _get_category(self):
    """
    Getter method for category, mapped from YANG variable /devices/device/applications/application/category (category-type)
...
networking
  ...
  def _set_category(self, v, load=False):
    """
    Setter method for category, mapped from YANG variable /devices/device/applications/application/category (category-type)
    If this variable is read-only (config: false) in the
...
networking
  ...
  def _get_app_protocol_name(self):
    """
    Getter method for app_protocol_name, mapped from YANG variable /devices/device/applications/application/app_protocol_name (string)
  ...
  def _set_app_protocol_name(self, v, load=False):
    """
    Setter method for app_protocol_name, mapped from YANG variable /devices/device/applications/application/app_protocol_name (string)
    If this variable is read-only (config: false) in the
  ...
  def _get_protocol_name(self):
    """
    Getter method for protocol_name, mapped from YANG variable /devices/device/applications/application/protocol_name (protocol-type)
...
ICMP
  ...
  def _set_protocol_name(self, v, load=False):
    """
    Setter method for protocol_name, mapped from YANG variable /devices/device/applications/application/protocol_name (protocol-type)
    If this variable is read-only (config: false) in the
...
ICMP
  ...
  def _get_protocol_number(self):
    """
    Getter method for protocol_number, mapped from YANG variable /devices/device/applications/application/protocol_number (string)
  ...
  def _set_protocol_number(self, v, load=False):
    """
    Setter method for protocol_number, mapped from YANG variable /devices/device/applications/application/protocol_number (string)
    If this variable is read-only (config: false) in the
  ...
  def _get_source_port(self):
    """
    Getter method for source_port, mapped from YANG variable /devices/device/applications/application/source_port (string)
  ...
  def _set_source_port(self, v, load=False):
    """
    Setter method for source_port, mapped from YANG variable /devices/device/applications/application/source_port (string)
    If this variable is read-only (config: false) in the
  ...
  def _get_dest_port(self):
    """
    Getter method for dest_port, mapped from YANG variable /devices/device/applications/application/dest_port (string)
  ...
  def _set_dest_port(self, v, load=False):
    """
    Setter method for dest_port, mapped from YANG variable /devices/device/applications/application/dest_port (string)
    If this variable is read-only (config: false) in the
  ...
  def _get_icmp_type(self):
    """
    Getter method for icmp_type, mapped from YANG variable /devices/device/applications/application/icmp_type (string)
  ...
  def _set_icmp_type(self, v, load=False):
    """
    Setter method for icmp_type, mapped from YANG variable /devices/device/applications/application/icmp_type (string)
    If this variable is read-only (config: false) in the
  ...
  def _get_icmp_code(self):
    """
    Getter method for icmp_code, mapped from YANG variable /devices/device/applications/application/icmp_code (string)
  ...
  def _set_icmp_code(self, v, load=False):
    """
    Setter method for icmp_code, mapped from YANG variable /devices/device/applications/application/icmp_code (string)
    If this variable is read-only (config: false) in the
  ...
  def _get_icmp6_type(self):
    """
    Getter method for icmp6_type, mapped from YANG variable /devices/device/applications/application/icmp6_type (string)
  ...
  def _set_icmp6_type(self, v, load=False):
    """
    Setter method for icmp6_type, mapped from YANG variable /devices/device/applications/application/icmp6_type (string)
    If this variable is read-only (config: false) in the
  ...
  def _get_icmp6_code(self):
    """
    Getter method for icmp6_code, mapped from YANG variable /devices/device/applications/application/icmp6_code (string)
  ...
  def _set_icmp6_code(self, v, load=False):
    """
    Setter method for icmp6_code, mapped from YANG variable /devices/device/applications/application/icmp6_code (string)
    If this variable is read-only (config: false) in the
  ...
  def _get_device_group(self):
    """
    Getter method for device_group, mapped from YANG variable /devices/device/applications/application/device_group (string)
  ...
  def _set_device_group(self, v, load=False):
    """
    Setter method for device_group, mapped from YANG variable /devices/device/applications/application/device_group (string)
    If this variable is read-only (config: false) in the
  ...
  def _get_application_port_ranges(self):
    """
    Getter method for application_port_ranges, mapped from YANG variable /devices/device/applications/application/application_port_ranges (list)
    """
    return self.__application_port_ranges
      
  def _set_application_port_ranges(self, v, load=False):
    """
    Setter method for application_port_ranges, mapped from YANG variable /devices/device/applications/application/application_port_ranges (list)
    If this variable is read-only (config: false) in the
    source YANG file, then _set_application_port_ranges is considered as a private
    method. Backends looking to populate this variable should
    do so via calling thisObj._set_application_port_ranges() directly.
    """
    try:
      if isEmpty(v):
        return
      ...
      raise ValueError({
          'error-string': """application_port_ranges must be of a type compatible with list""",
          'defined-type': "list",
          'generated-type': """YANGDynClass(base=YANGListType("protocol_type source_port dest_port",application_port_ranges.application_port_ranges, yang_name="application-port-ranges", module_name="firewall", parent=self, is_container='list', user_ordered=False, path_helper=self._path_helper, yang_keys='protocol-type source-port dest-port'), is_container='list', yang_name="application-port-ranges", module_name="firewall", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='http://anutanetworks.com/firewall', defining_module='firewall', yang_type='list', is_config=True)""",
        })

    self.__application_port_ranges = t
    if hasattr(self, '_set'):
      self._set()

  def _unset_application_port_ranges(self):
    self.__application_port_ranges = YANGDynClass(base=YANGListType("protocol_type source_port dest_port",application_port_ranges.application_port_ranges, yang_name="application-port-ranges", module_name="firewall", parent=self, is_container='list', user_ordered=False, path_helper=self._path_helper, yang_keys='protocol-type source-port dest-port'), is_container='list', yang_name="application-port-ranges", module_name="firewall", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='http://anutanetworks.com/firewall', defining_module='firewall', yang_type='list', is_config=True)


  def _get_virtual_device_name(self):
    """
    Getter method for virtual_device_name, mapped from YANG variable /devices/device/applications/application/virtual_device_name (leafref)
  ...
  def _set_virtual_device_name(self, v, load=False):
    """
    Setter method for virtual_device_name, mapped from YANG variable /devices/device/applications/application/virtual_device_name (leafref)
    If this variable is read-only (config: false) in the
