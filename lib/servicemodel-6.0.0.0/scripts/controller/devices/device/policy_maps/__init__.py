...
def isEmpty(val):
    ...
    return False
import policy_map
class policy_maps(PybindBase):
  """
  This class was auto-generated by the PythonClass plugin for PYANG
  from YANG module controller - based on the path /devices/device/policy-maps. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'devices', u'device', u'policy-maps']

  def _get_policy_map(self):
    """
    Getter method for policy_map, mapped from YANG variable /devices/device/policy_maps/policy_map (list)
    """
    return self.__policy_map
      
  def _set_policy_map(self, v, load=False):
    """
    Setter method for policy_map, mapped from YANG variable /devices/device/policy_maps/policy_map (list)
