...
def isEmpty(val):
    ...
    return False
class eem_eigrp_adj(PybindBase):
  """
  This class was auto-generated by the PythonClass plugin for PYANG
  from YANG module controller - based on the path /devices/device/eem-script/eem-eigrp-adj. Each member element of
  the container is represented as a class variable - with a specific
  YANG type.
  """
  __slots__ = ('_pybind_generated_by', '_netconf_operation_type', '_path_helper', '_yang_name', '_extmethods', '_module_name', '_namespace','__enable_eigrp_adj_eem','__variable1','__variable2','__variable3',)

  _yang_name = 'eem-eigrp-adj'
  ...
  def __init__(self, *args, **kwargs):
    ...
    self.__enable_eigrp_adj_eem = YANGDynClass(base=YANGBool, is_leaf=True, yang_name="enable-eigrp-adj-eem", module_name="l3features", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='http://anutanetworks.com/l3features', defining_module='l3features', yang_type='boolean', is_config=True)
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'devices', u'device', u'eem-script', u'eem-eigrp-adj']

  def _get_enable_eigrp_adj_eem(self):
    """
    Getter method for enable_eigrp_adj_eem, mapped from YANG variable /devices/device/eem_script/eem_eigrp_adj/enable_eigrp_adj_eem (boolean)

    YANG Description: enable-eigrp-adj-eem: True/False
    """
    return self.__enable_eigrp_adj_eem
      
  def _set_enable_eigrp_adj_eem(self, v, load=False):
    """
    Setter method for enable_eigrp_adj_eem, mapped from YANG variable /devices/device/eem_script/eem_eigrp_adj/enable_eigrp_adj_eem (boolean)
    If this variable is read-only (config: false) in the
    source YANG file, then _set_enable_eigrp_adj_eem is considered as a private
    method. Backends looking to populate this variable should
    do so via calling thisObj._set_enable_eigrp_adj_eem() directly.
    ...
    try:
      if isEmpty(v):
        return
      t = YANGDynClass(v,base=YANGBool, is_leaf=True, yang_name="enable-eigrp-adj-eem", module_name="l3features", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='http://anutanetworks.com/l3features', defining_module='l3features', yang_type='boolean', is_config=True)
    except (TypeError, ValueError):
      raise ValueError({
          'error-string': """enable_eigrp_adj_eem must be of a type compatible with boolean""",
          'defined-type': "boolean",
          'generated-type': """YANGDynClass(base=YANGBool, is_leaf=True, yang_name="enable-eigrp-adj-eem", module_name="l3features", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='http://anutanetworks.com/l3features', defining_module='l3features', yang_type='boolean', is_config=True)""",
        })

    self.__enable_eigrp_adj_eem = t
    if hasattr(self, '_set'):
      self._set()

  def _unset_enable_eigrp_adj_eem(self):
    self.__enable_eigrp_adj_eem = YANGDynClass(base=YANGBool, is_leaf=True, yang_name="enable-eigrp-adj-eem", module_name="l3features", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='http://anutanetworks.com/l3features', defining_module='l3features', yang_type='boolean', is_config=True)


  def _get_variable1(self):
    """
    Getter method for variable1, mapped from YANG variable /devices/device/eem_script/eem_eigrp_adj/variable1 (string)
  ...
  def _set_variable1(self, v, load=False):
    """
    Setter method for variable1, mapped from YANG variable /devices/device/eem_script/eem_eigrp_adj/variable1 (string)
    If this variable is read-only (config: false) in the
  ...
  def _get_variable2(self):
    """
    Getter method for variable2, mapped from YANG variable /devices/device/eem_script/eem_eigrp_adj/variable2 (string)
  ...
  def _set_variable2(self, v, load=False):
    """
    Setter method for variable2, mapped from YANG variable /devices/device/eem_script/eem_eigrp_adj/variable2 (string)
    If this variable is read-only (config: false) in the
  ...
  def _get_variable3(self):
    """
    Getter method for variable3, mapped from YANG variable /devices/device/eem_script/eem_eigrp_adj/variable3 (string)
  ...
  def _set_variable3(self, v, load=False):
    """
    Setter method for variable3, mapped from YANG variable /devices/device/eem_script/eem_eigrp_adj/variable3 (string)
    If this variable is read-only (config: false) in the
  ...
  enable_eigrp_adj_eem = __builtin__.property(_get_enable_eigrp_adj_eem, _set_enable_eigrp_adj_eem)
  ...
  _pyangbind_elements = collections.OrderedDict([('enable_eigrp_adj_eem', enable_eigrp_adj_eem), ('variable1', variable1), ('variable2', variable2), ('variable3', variable3), ])
