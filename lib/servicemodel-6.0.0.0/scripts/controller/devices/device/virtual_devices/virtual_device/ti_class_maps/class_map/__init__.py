...
class class_map(PybindBase):
  ...
  from YANG module controller - based on the path /devices/device/virtual-devices/virtual-device/ti-class-maps/class-map. Each member element of
  the container is represented as a class variable - with a specific
  YANG type.
  """
  __slots__ = ('_pybind_generated_by', '_netconf_operation_type', '_path_helper', '_yang_name', '_extmethods', '_module_name', '_namespace','__name','__match_condition',)
  ...
  def __init__(self, *args, **kwargs):
    ...
    self.__match_condition = YANGDynClass(base=YANGListType("match_value",match_condition.match_condition, yang_name="match-condition", module_name="firewall", parent=self, is_container='list', user_ordered=False, path_helper=self._path_helper, yang_keys='match-value'), is_container='list', yang_name="match-condition", module_name="firewall", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='http://anutanetworks.com/firewall', defining_module='firewall', yang_type='list', is_config=True)
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'devices', u'device', u'virtual-devices', u'virtual-device', u'ti-class-maps', u'class-map']

  def _get_name(self):
    """
    Getter method for name, mapped from YANG variable /devices/device/virtual_devices/virtual_device/ti_class_maps/class_map/name (string)
  ...
  def _set_name(self, v, load=False):
    """
    Setter method for name, mapped from YANG variable /devices/device/virtual_devices/virtual_device/ti_class_maps/class_map/name (string)
  ...
  def _get_match_condition(self):
    """
    Getter method for match_condition, mapped from YANG variable /devices/device/virtual_devices/virtual_device/ti_class_maps/class_map/match_condition (list)
    """
    return self.__match_condition
      
  def _set_match_condition(self, v, load=False):
    """
    Setter method for match_condition, mapped from YANG variable /devices/device/virtual_devices/virtual_device/ti_class_maps/class_map/match_condition (list)
    If this variable is read-only (config: false) in the
  ...
  _pyangbind_elements = collections.OrderedDict([('name', name), ('match_condition', match_condition), ])
