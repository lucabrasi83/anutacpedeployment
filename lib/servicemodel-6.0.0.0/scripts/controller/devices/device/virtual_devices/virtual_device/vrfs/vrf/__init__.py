...
class vrf(PybindBase):
  ...
  from YANG module controller - based on the path /devices/device/virtual-devices/virtual-device/vrfs/vrf. Each member element of
  the container is represented as a class variable - with a specific
  YANG type.
  """
  __slots__ = ('_pybind_generated_by', '_netconf_operation_type', '_path_helper', '_yang_name', '_extmethods', '_module_name', '_namespace','__name','__description','__interface',)
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'devices', u'device', u'virtual-devices', u'virtual-device', u'vrfs', u'vrf']

  def _get_name(self):
    """
    Getter method for name, mapped from YANG variable /devices/device/virtual_devices/virtual_device/vrfs/vrf/name (string)
  ...
  def _set_name(self, v, load=False):
    """
    Setter method for name, mapped from YANG variable /devices/device/virtual_devices/virtual_device/vrfs/vrf/name (string)
  ...
  def _get_description(self):
    """
    Getter method for description, mapped from YANG variable /devices/device/virtual_devices/virtual_device/vrfs/vrf/description (string)
  ...
  def _set_description(self, v, load=False):
    """
    Setter method for description, mapped from YANG variable /devices/device/virtual_devices/virtual_device/vrfs/vrf/description (string)
    If this variable is read-only (config: false) in the
  ...
  def _get_interface(self):
    """
    Getter method for interface, mapped from YANG variable /devices/device/virtual_devices/virtual_device/vrfs/vrf/interface (list)
    """
    return self.__interface
      
  def _set_interface(self, v, load=False):
    """
    Setter method for interface, mapped from YANG variable /devices/device/virtual_devices/virtual_device/vrfs/vrf/interface (list)
    If this variable is read-only (config: false) in the
  ...
  _pyangbind_elements = collections.OrderedDict([('name', name), ('description', description), ('interface', interface), ])
