...
class tacacs_servers(PybindBase):
  ...
  from YANG module controller - based on the path /devices/device/virtual-devices/virtual-device/tacacs-conf/tacacs-servers. Each member element of
  ...
  def __init__(self, *args, **kwargs):
    ...
    self.__tacacs_server = YANGDynClass(base=RestrictedClassType(base_type=unicode, restriction_dict={'pattern': u'(([0-9]|[1-9][0-9]|1[0-9][0-9]|2[0-4][0-9]|25[0-5])\\.){3}([0-9]|[1-9][0-9]|1[0-9][0-9]|2[0-4][0-9]|25[0-5])(%[\\p{N}\\p{L}]+)?'}), is_leaf=True, yang_name="tacacs-server", module_name="firewall", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, is_keyval=True, namespace='http://anutanetworks.com/firewall', defining_module='firewall', yang_type='inet:ipv4-address', is_config=True)
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'devices', u'device', u'virtual-devices', u'virtual-device', u'tacacs-conf', u'tacacs-servers']

  def _get_tacacs_server(self):
    """
    Getter method for tacacs_server, mapped from YANG variable /devices/device/virtual_devices/virtual_device/tacacs_conf/tacacs_servers/tacacs_server (inet:ipv4-address)
  ...
  def _set_tacacs_server(self, v, load=False):
    """
    Setter method for tacacs_server, mapped from YANG variable /devices/device/virtual_devices/virtual_device/tacacs_conf/tacacs_servers/tacacs_server (inet:ipv4-address)
