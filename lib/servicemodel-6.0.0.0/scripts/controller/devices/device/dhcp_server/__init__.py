...
class dhcp_server(PybindBase):
  ...
  from YANG module controller - based on the path /devices/device/dhcp-server. Each member element of
  the container is represented as a class variable - with a specific
  YANG type.
  """
  __slots__ = ('_pybind_generated_by', '_netconf_operation_type', '_path_helper', '_yang_name', '_extmethods', '_module_name', '_namespace','__pool_name','__pool_vrf','__network','__mask','__domain_name','__dhcp_server_ip','__dns_server_ip','__default_router','__interface_name','__start_ip','__end_ip','__lease','__excluded_address',)
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'devices', u'device', u'dhcp-server']

  def _get_pool_name(self):
    """
    Getter method for pool_name, mapped from YANG variable /devices/device/dhcp_server/pool_name (string)
  ...
  def _set_pool_name(self, v, load=False):
    """
    Setter method for pool_name, mapped from YANG variable /devices/device/dhcp_server/pool_name (string)
  ...
  def _get_pool_vrf(self):
    """
    Getter method for pool_vrf, mapped from YANG variable /devices/device/dhcp_server/pool_vrf (string)
  ...
  def _set_pool_vrf(self, v, load=False):
    """
    Setter method for pool_vrf, mapped from YANG variable /devices/device/dhcp_server/pool_vrf (string)
    If this variable is read-only (config: false) in the
  ...
  def _get_network(self):
    """
    Getter method for network, mapped from YANG variable /devices/device/dhcp_server/network (string)
  ...
  def _set_network(self, v, load=False):
    """
    Setter method for network, mapped from YANG variable /devices/device/dhcp_server/network (string)
    If this variable is read-only (config: false) in the
  ...
  def _get_mask(self):
    """
    Getter method for mask, mapped from YANG variable /devices/device/dhcp_server/mask (string)
  ...
  def _set_mask(self, v, load=False):
    """
    Setter method for mask, mapped from YANG variable /devices/device/dhcp_server/mask (string)
    If this variable is read-only (config: false) in the
  ...
  def _get_domain_name(self):
    """
    Getter method for domain_name, mapped from YANG variable /devices/device/dhcp_server/domain_name (string)
  ...
  def _set_domain_name(self, v, load=False):
    """
    Setter method for domain_name, mapped from YANG variable /devices/device/dhcp_server/domain_name (string)
    If this variable is read-only (config: false) in the
  ...
  def _get_dhcp_server_ip(self):
    """
    Getter method for dhcp_server_ip, mapped from YANG variable /devices/device/dhcp_server/dhcp_server_ip (inet:ip-address)
  ...
  def _set_dhcp_server_ip(self, v, load=False):
    """
    Setter method for dhcp_server_ip, mapped from YANG variable /devices/device/dhcp_server/dhcp_server_ip (inet:ip-address)
    If this variable is read-only (config: false) in the
  ...
  def _get_dns_server_ip(self):
    """
    Getter method for dns_server_ip, mapped from YANG variable /devices/device/dhcp_server/dns_server_ip (string)
  ...
  def _set_dns_server_ip(self, v, load=False):
    """
    Setter method for dns_server_ip, mapped from YANG variable /devices/device/dhcp_server/dns_server_ip (string)
    If this variable is read-only (config: false) in the
  ...
  def _get_default_router(self):
    """
    Getter method for default_router, mapped from YANG variable /devices/device/dhcp_server/default_router (string)
  ...
  def _set_default_router(self, v, load=False):
    """
    Setter method for default_router, mapped from YANG variable /devices/device/dhcp_server/default_router (string)
    If this variable is read-only (config: false) in the
  ...
  def _get_interface_name(self):
    """
    Getter method for interface_name, mapped from YANG variable /devices/device/dhcp_server/interface_name (string)
  ...
  def _set_interface_name(self, v, load=False):
    """
    Setter method for interface_name, mapped from YANG variable /devices/device/dhcp_server/interface_name (string)
    If this variable is read-only (config: false) in the
  ...
  def _get_start_ip(self):
    """
    Getter method for start_ip, mapped from YANG variable /devices/device/dhcp_server/start_ip (string)
  ...
  def _set_start_ip(self, v, load=False):
    """
    Setter method for start_ip, mapped from YANG variable /devices/device/dhcp_server/start_ip (string)
    If this variable is read-only (config: false) in the
  ...
  def _get_end_ip(self):
    """
    Getter method for end_ip, mapped from YANG variable /devices/device/dhcp_server/end_ip (string)
  ...
  def _set_end_ip(self, v, load=False):
    """
    Setter method for end_ip, mapped from YANG variable /devices/device/dhcp_server/end_ip (string)
    If this variable is read-only (config: false) in the
  ...
  def _get_lease(self):
    """
    Getter method for lease, mapped from YANG variable /devices/device/dhcp_server/lease (uint32)
  ...
  def _set_lease(self, v, load=False):
    """
    Setter method for lease, mapped from YANG variable /devices/device/dhcp_server/lease (uint32)
    If this variable is read-only (config: false) in the
  ...
  def _get_excluded_address(self):
    """
    Getter method for excluded_address, mapped from YANG variable /devices/device/dhcp_server/excluded_address (list)
    """
    return self.__excluded_address
      
  def _set_excluded_address(self, v, load=False):
    """
    Setter method for excluded_address, mapped from YANG variable /devices/device/dhcp_server/excluded_address (list)
    If this variable is read-only (config: false) in the
  ...
  _pyangbind_elements = collections.OrderedDict([('pool_name', pool_name), ('pool_vrf', pool_vrf), ('network', network), ('mask', mask), ('domain_name', domain_name), ('dhcp_server_ip', dhcp_server_ip), ('dns_server_ip', dns_server_ip), ('default_router', default_router), ('interface_name', interface_name), ('start_ip', start_ip), ('end_ip', end_ip), ('lease', lease), ('excluded_address', excluded_address), ])
