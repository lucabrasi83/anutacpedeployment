...
def isEmpty(val):
    ...
    return False
class partition(PybindBase):
  """
  This class was auto-generated by the PythonClass plugin for PYANG
  from YANG module controller - based on the path /devices/device/partitions/partition. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'devices', u'device', u'partitions', u'partition']

  def _get_name(self):
    """
    Getter method for name, mapped from YANG variable /devices/device/partitions/partition/name (string)
  ...
  def _set_name(self, v, load=False):
    """
    Setter method for name, mapped from YANG variable /devices/device/partitions/partition/name (string)
  ...
  def _get_description(self):
    """
    Getter method for description, mapped from YANG variable /devices/device/partitions/partition/description (string)
  ...
  def _set_description(self, v, load=False):
    """
    Setter method for description, mapped from YANG variable /devices/device/partitions/partition/description (string)
    If this variable is read-only (config: false) in the
