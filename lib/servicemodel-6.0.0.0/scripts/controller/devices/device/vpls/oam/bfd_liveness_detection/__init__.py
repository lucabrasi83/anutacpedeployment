...
class bfd_liveness_detection(PybindBase):
  ...
  from YANG module controller - based on the path /devices/device/vpls/oam/bfd-liveness-detection. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'devices', u'device', u'vpls', u'oam', u'bfd-liveness-detection']

  def _get_version(self):
    """
    Getter method for version, mapped from YANG variable /devices/device/vpls/oam/bfd_liveness_detection/version (enumeration)
  ...
  def _set_version(self, v, load=False):
    """
    Setter method for version, mapped from YANG variable /devices/device/vpls/oam/bfd_liveness_detection/version (enumeration)
  ...
  def _get_minimum_interval(self):
    """
    Getter method for minimum_interval, mapped from YANG variable /devices/device/vpls/oam/bfd_liveness_detection/minimum_interval (uint32)
  ...
  def _set_minimum_interval(self, v, load=False):
    """
    Setter method for minimum_interval, mapped from YANG variable /devices/device/vpls/oam/bfd_liveness_detection/minimum_interval (uint32)
    If this variable is read-only (config: false) in the
  ...
  def _get_minimum_receive_interval(self):
    """
    Getter method for minimum_receive_interval, mapped from YANG variable /devices/device/vpls/oam/bfd_liveness_detection/minimum_receive_interval (uint32)
  ...
  def _set_minimum_receive_interval(self, v, load=False):
    """
    Setter method for minimum_receive_interval, mapped from YANG variable /devices/device/vpls/oam/bfd_liveness_detection/minimum_receive_interval (uint32)
    If this variable is read-only (config: false) in the
  ...
  def _get_multiplier(self):
    """
    Getter method for multiplier, mapped from YANG variable /devices/device/vpls/oam/bfd_liveness_detection/multiplier (uint32)
  ...
  def _set_multiplier(self, v, load=False):
    """
    Setter method for multiplier, mapped from YANG variable /devices/device/vpls/oam/bfd_liveness_detection/multiplier (uint32)
    If this variable is read-only (config: false) in the
  ...
  def _get_no_adaptation(self):
    """
    Getter method for no_adaptation, mapped from YANG variable /devices/device/vpls/oam/bfd_liveness_detection/no_adaptation (empty)
  ...
  def _set_no_adaptation(self, v, load=False):
    """
    Setter method for no_adaptation, mapped from YANG variable /devices/device/vpls/oam/bfd_liveness_detection/no_adaptation (empty)
    If this variable is read-only (config: false) in the
  ...
  def _get_transmit_interval(self):
    """
    Getter method for transmit_interval, mapped from YANG variable /devices/device/vpls/oam/bfd_liveness_detection/transmit_interval (container)
  ...
  def _set_transmit_interval(self, v, load=False):
    """
    Setter method for transmit_interval, mapped from YANG variable /devices/device/vpls/oam/bfd_liveness_detection/transmit_interval (container)
    If this variable is read-only (config: false) in the
  ...
  def _get_detection_time(self):
    """
    Getter method for detection_time, mapped from YANG variable /devices/device/vpls/oam/bfd_liveness_detection/detection_time (container)
  ...
  def _set_detection_time(self, v, load=False):
    """
    Setter method for detection_time, mapped from YANG variable /devices/device/vpls/oam/bfd_liveness_detection/detection_time (container)
    If this variable is read-only (config: false) in the
