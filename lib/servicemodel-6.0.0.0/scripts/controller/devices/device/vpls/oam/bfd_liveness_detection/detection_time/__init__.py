...
class detection_time(PybindBase):
  ...
  from YANG module controller - based on the path /devices/device/vpls/oam/bfd-liveness-detection/detection-time. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'devices', u'device', u'vpls', u'oam', u'bfd-liveness-detection', u'detection-time']

  def _get_threshold(self):
    """
    Getter method for threshold, mapped from YANG variable /devices/device/vpls/oam/bfd_liveness_detection/detection_time/threshold (uint32)
  ...
  def _set_threshold(self, v, load=False):
    """
    Setter method for threshold, mapped from YANG variable /devices/device/vpls/oam/bfd_liveness_detection/detection_time/threshold (uint32)
