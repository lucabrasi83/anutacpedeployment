...
class transmit_interval(PybindBase):
  ...
  from YANG module controller - based on the path /devices/device/vpls/mesh-group/neighbor/oam/bfd-liveness-detection/transmit-interval. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'devices', u'device', u'vpls', u'mesh-group', u'neighbor', u'oam', u'bfd-liveness-detection', u'transmit-interval']

  def _get_minimum_interval(self):
    """
    Getter method for minimum_interval, mapped from YANG variable /devices/device/vpls/mesh_group/neighbor/oam/bfd_liveness_detection/transmit_interval/minimum_interval (uint32)
  ...
  def _set_minimum_interval(self, v, load=False):
    """
    Setter method for minimum_interval, mapped from YANG variable /devices/device/vpls/mesh_group/neighbor/oam/bfd_liveness_detection/transmit_interval/minimum_interval (uint32)
  ...
  def _get_threshold(self):
    """
    Getter method for threshold, mapped from YANG variable /devices/device/vpls/mesh_group/neighbor/oam/bfd_liveness_detection/transmit_interval/threshold (uint32)
  ...
  def _set_threshold(self, v, load=False):
    """
    Setter method for threshold, mapped from YANG variable /devices/device/vpls/mesh_group/neighbor/oam/bfd_liveness_detection/transmit_interval/threshold (uint32)
    If this variable is read-only (config: false) in the
