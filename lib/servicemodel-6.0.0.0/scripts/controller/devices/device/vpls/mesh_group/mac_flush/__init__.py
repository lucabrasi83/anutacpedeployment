...
class mac_flush(PybindBase):
  ...
  from YANG module controller - based on the path /devices/device/vpls/mesh-group/mac-flush. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'devices', u'device', u'vpls', u'mesh-group', u'mac-flush']

  def _get_any_interface(self):
    """
    Getter method for any_interface, mapped from YANG variable /devices/device/vpls/mesh_group/mac_flush/any_interface (empty)
  ...
  def _set_any_interface(self, v, load=False):
    """
    Setter method for any_interface, mapped from YANG variable /devices/device/vpls/mesh_group/mac_flush/any_interface (empty)
  ...
  def _get_any_spoke(self):
    """
    Getter method for any_spoke, mapped from YANG variable /devices/device/vpls/mesh_group/mac_flush/any_spoke (empty)
  ...
  def _set_any_spoke(self, v, load=False):
    """
    Setter method for any_spoke, mapped from YANG variable /devices/device/vpls/mesh_group/mac_flush/any_spoke (empty)
    If this variable is read-only (config: false) in the
  ...
  def _get_propagate(self):
    """
    Getter method for propagate, mapped from YANG variable /devices/device/vpls/mesh_group/mac_flush/propagate (empty)
  ...
  def _set_propagate(self, v, load=False):
    """
    Setter method for propagate, mapped from YANG variable /devices/device/vpls/mesh_group/mac_flush/propagate (empty)
    If this variable is read-only (config: false) in the
