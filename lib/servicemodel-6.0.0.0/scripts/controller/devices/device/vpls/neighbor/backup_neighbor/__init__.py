...
class backup_neighbor(PybindBase):
  ...
  from YANG module controller - based on the path /devices/device/vpls/neighbor/backup-neighbor. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'devices', u'device', u'vpls', u'neighbor', u'backup-neighbor']

  def _get_neighbor_id(self):
    """
    Getter method for neighbor_id, mapped from YANG variable /devices/device/vpls/neighbor/backup_neighbor/neighbor_id (ipv4addr)
  ...
  def _set_neighbor_id(self, v, load=False):
    """
    Setter method for neighbor_id, mapped from YANG variable /devices/device/vpls/neighbor/backup_neighbor/neighbor_id (ipv4addr)
  ...
  def _get_static(self):
    """
    Getter method for static, mapped from YANG variable /devices/device/vpls/neighbor/backup_neighbor/static (container)
  ...
  def _set_static(self, v, load=False):
    """
    Setter method for static, mapped from YANG variable /devices/device/vpls/neighbor/backup_neighbor/static (container)
    If this variable is read-only (config: false) in the
  ...
  def _get_community(self):
    """
    Getter method for community, mapped from YANG variable /devices/device/vpls/neighbor/backup_neighbor/community (string)
  ...
  def _set_community(self, v, load=False):
    """
    Setter method for community, mapped from YANG variable /devices/device/vpls/neighbor/backup_neighbor/community (string)
    If this variable is read-only (config: false) in the
  ...
  def _get_psn_tunnel_endpoint(self):
    """
    Getter method for psn_tunnel_endpoint, mapped from YANG variable /devices/device/vpls/neighbor/backup_neighbor/psn_tunnel_endpoint (ipv4addr)
  ...
  def _set_psn_tunnel_endpoint(self, v, load=False):
    """
    Setter method for psn_tunnel_endpoint, mapped from YANG variable /devices/device/vpls/neighbor/backup_neighbor/psn_tunnel_endpoint (ipv4addr)
    If this variable is read-only (config: false) in the
  ...
  def _get_standby(self):
    """
    Getter method for standby, mapped from YANG variable /devices/device/vpls/neighbor/backup_neighbor/standby (empty)
  ...
  def _set_standby(self, v, load=False):
    """
    Setter method for standby, mapped from YANG variable /devices/device/vpls/neighbor/backup_neighbor/standby (empty)
    If this variable is read-only (config: false) in the
