...
class health_monitors(PybindBase):
  ...
  from YANG module controller - based on the path /devices/device/health-monitors. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'devices', u'device', u'health-monitors']

  def _get_health_monitor(self):
    """
    Getter method for health_monitor, mapped from YANG variable /devices/device/health_monitors/health_monitor (list)
    """
    return self.__health_monitor
      
  def _set_health_monitor(self, v, load=False):
    """
    Setter method for health_monitor, mapped from YANG variable /devices/device/health_monitors/health_monitor (list)
