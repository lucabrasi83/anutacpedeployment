...
def isEmpty(val):
    ...
    return False
import pool
class ip_nat_pool(PybindBase):
  """
  This class was auto-generated by the PythonClass plugin for PYANG
  from YANG module controller - based on the path /devices/device/ip-nat-pool. Each member element of
  the container is represented as a class variable - with a specific
  YANG type.
  """
  __slots__ = ('_pybind_generated_by', '_netconf_operation_type', '_path_helper', '_yang_name', '_extmethods', '_module_name', '_namespace','__pool',)

  _yang_name = 'ip-nat-pool'
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'devices', u'device', u'ip-nat-pool']

  def _get_pool(self):
    """
    Getter method for pool, mapped from YANG variable /devices/device/ip_nat_pool/pool (list)
    """
    return self.__pool
      
  def _set_pool(self, v, load=False):
    """
    Setter method for pool, mapped from YANG variable /devices/device/ip_nat_pool/pool (list)
  ...
  _pyangbind_elements = collections.OrderedDict([('pool', pool), ])
