...
def isEmpty(val):
    ...
    return False
class dns_proxy(PybindBase):
  """
  This class was auto-generated by the PythonClass plugin for PYANG
  from YANG module controller - based on the path /devices/device/dnsproxies/dns-proxy. Each member element of
  the container is represented as a class variable - with a specific
  YANG type.
  """
  __slots__ = ('_pybind_generated_by', '_netconf_operation_type', '_path_helper', '_yang_name', '_extmethods', '_module_name', '_namespace','__name','__interface_name',)

  _yang_name = 'dns-proxy'
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'devices', u'device', u'dnsproxies', u'dns-proxy']

  def _get_name(self):
    """
    Getter method for name, mapped from YANG variable /devices/device/dnsproxies/dns_proxy/name (string)
  ...
  def _set_name(self, v, load=False):
    """
    Setter method for name, mapped from YANG variable /devices/device/dnsproxies/dns_proxy/name (string)
  ...
  def _get_interface_name(self):
    """
    Getter method for interface_name, mapped from YANG variable /devices/device/dnsproxies/dns_proxy/interface_name (string)
  ...
  def _set_interface_name(self, v, load=False):
    """
    Setter method for interface_name, mapped from YANG variable /devices/device/dnsproxies/dns_proxy/interface_name (string)
    If this variable is read-only (config: false) in the
  ...
  _pyangbind_elements = collections.OrderedDict([('name', name), ('interface_name', interface_name), ])
