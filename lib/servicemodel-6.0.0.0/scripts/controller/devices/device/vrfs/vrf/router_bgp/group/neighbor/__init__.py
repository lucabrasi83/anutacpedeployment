...
class neighbor(PybindBase):
  ...
  from YANG module controller - based on the path /devices/device/vrfs/vrf/router-bgp/group/neighbor. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'devices', u'device', u'vrfs', u'vrf', u'router-bgp', u'group', u'neighbor']

  def _get_ip_address(self):
    """
    Getter method for ip_address, mapped from YANG variable /devices/device/vrfs/vrf/router_bgp/group/neighbor/ip_address (inet:ipv4-address)
  ...
  def _set_ip_address(self, v, load=False):
    """
    Setter method for ip_address, mapped from YANG variable /devices/device/vrfs/vrf/router_bgp/group/neighbor/ip_address (inet:ipv4-address)
