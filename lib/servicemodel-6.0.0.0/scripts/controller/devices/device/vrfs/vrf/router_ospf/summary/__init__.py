...
class summary(PybindBase):
  ...
  from YANG module controller - based on the path /devices/device/vrfs/vrf/router-ospf/summary. Each member element of
  the container is represented as a class variable - with a specific
  YANG type.
  """
  __slots__ = ('_pybind_generated_by', '_netconf_operation_type', '_path_helper', '_yang_name', '_extmethods', '_module_name', '_namespace','__ip_address','__netmask','__route_map','__not_advertise','__nssa_only','__tag',)
  ...
  def __init__(self, *args, **kwargs):
    ...
    self.__not_advertise = YANGDynClass(base=YANGBool, is_leaf=True, yang_name="not-advertise", module_name="l3features", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='http://anutanetworks.com/l3features', defining_module='l3features', yang_type='boolean', is_config=True)
    ...
    self.__ip_address = YANGDynClass(base=[RestrictedClassType(base_type=unicode, restriction_dict={'pattern': u'(([0-9]|[1-9][0-9]|1[0-9][0-9]|2[0-4][0-9]|25[0-5])\\.){3}([0-9]|[1-9][0-9]|1[0-9][0-9]|2[0-4][0-9]|25[0-5])(%[\\p{N}\\p{L}]+)?'}),RestrictedClassType(base_type=unicode, restriction_dict={'pattern': u'((:|[0-9a-fA-F]{0,4}):)([0-9a-fA-F]{0,4}:){0,5}((([0-9a-fA-F]{0,4}:)?(:|[0-9a-fA-F]{0,4}))|(((25[0-5]|2[0-4][0-9]|[01]?[0-9]?[0-9])\\.){3}(25[0-5]|2[0-4][0-9]|[01]?[0-9]?[0-9])))(%[\\p{N}\\p{L}]+)?'}),], is_leaf=True, yang_name="ip-address", module_name="l3features", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='http://anutanetworks.com/l3features', defining_module='l3features', yang_type='inet:ip-address', is_config=True)
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'devices', u'device', u'vrfs', u'vrf', u'router-ospf', u'summary']

  def _get_ip_address(self):
    """
    Getter method for ip_address, mapped from YANG variable /devices/device/vrfs/vrf/router_ospf/summary/ip_address (inet:ip-address)
  ...
  def _set_ip_address(self, v, load=False):
    """
    Setter method for ip_address, mapped from YANG variable /devices/device/vrfs/vrf/router_ospf/summary/ip_address (inet:ip-address)
    ...
    try:
      if isEmpty(v):
        return
      t = YANGDynClass(v,base=[RestrictedClassType(base_type=unicode, restriction_dict={'pattern': u'(([0-9]|[1-9][0-9]|1[0-9][0-9]|2[0-4][0-9]|25[0-5])\\.){3}([0-9]|[1-9][0-9]|1[0-9][0-9]|2[0-4][0-9]|25[0-5])(%[\\p{N}\\p{L}]+)?'}),RestrictedClassType(base_type=unicode, restriction_dict={'pattern': u'((:|[0-9a-fA-F]{0,4}):)([0-9a-fA-F]{0,4}:){0,5}((([0-9a-fA-F]{0,4}:)?(:|[0-9a-fA-F]{0,4}))|(((25[0-5]|2[0-4][0-9]|[01]?[0-9]?[0-9])\\.){3}(25[0-5]|2[0-4][0-9]|[01]?[0-9]?[0-9])))(%[\\p{N}\\p{L}]+)?'}),], is_leaf=True, yang_name="ip-address", module_name="l3features", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='http://anutanetworks.com/l3features', defining_module='l3features', yang_type='inet:ip-address', is_config=True)
    except (TypeError, ValueError):
      raise ValueError({
          'error-string': """ip_address must be of a type compatible with inet:ip-address""",
          'defined-type': "inet:ip-address",
          'generated-type': """YANGDynClass(base=[RestrictedClassType(base_type=unicode, restriction_dict={'pattern': u'(([0-9]|[1-9][0-9]|1[0-9][0-9]|2[0-4][0-9]|25[0-5])\\.){3}([0-9]|[1-9][0-9]|1[0-9][0-9]|2[0-4][0-9]|25[0-5])(%[\\p{N}\\p{L}]+)?'}),RestrictedClassType(base_type=unicode, restriction_dict={'pattern': u'((:|[0-9a-fA-F]{0,4}):)([0-9a-fA-F]{0,4}:){0,5}((([0-9a-fA-F]{0,4}:)?(:|[0-9a-fA-F]{0,4}))|(((25[0-5]|2[0-4][0-9]|[01]?[0-9]?[0-9])\\.){3}(25[0-5]|2[0-4][0-9]|[01]?[0-9]?[0-9])))(%[\\p{N}\\p{L}]+)?'}),], is_leaf=True, yang_name="ip-address", module_name="l3features", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='http://anutanetworks.com/l3features', defining_module='l3features', yang_type='inet:ip-address', is_config=True)""",
        })
  ...
  def _get_netmask(self):
    """
    Getter method for netmask, mapped from YANG variable /devices/device/vrfs/vrf/router_ospf/summary/netmask (string)
  ...
  def _set_netmask(self, v, load=False):
    """
    Setter method for netmask, mapped from YANG variable /devices/device/vrfs/vrf/router_ospf/summary/netmask (string)
    If this variable is read-only (config: false) in the
  ...
  def _get_route_map(self):
    """
    Getter method for route_map, mapped from YANG variable /devices/device/vrfs/vrf/router_ospf/summary/route_map (string)
  ...
  def _set_route_map(self, v, load=False):
    """
    Setter method for route_map, mapped from YANG variable /devices/device/vrfs/vrf/router_ospf/summary/route_map (string)
    If this variable is read-only (config: false) in the
  ...
  def _get_not_advertise(self):
    """
    Getter method for not_advertise, mapped from YANG variable /devices/device/vrfs/vrf/router_ospf/summary/not_advertise (boolean)

    YANG Description: not-advertise: True/False
    """
    return self.__not_advertise
      
  def _set_not_advertise(self, v, load=False):
    """
    Setter method for not_advertise, mapped from YANG variable /devices/device/vrfs/vrf/router_ospf/summary/not_advertise (boolean)
    If this variable is read-only (config: false) in the
    source YANG file, then _set_not_advertise is considered as a private
    method. Backends looking to populate this variable should
    do so via calling thisObj._set_not_advertise() directly.
    ...
    try:
      if isEmpty(v):
        return
      t = YANGDynClass(v,base=YANGBool, is_leaf=True, yang_name="not-advertise", module_name="l3features", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='http://anutanetworks.com/l3features', defining_module='l3features', yang_type='boolean', is_config=True)
    except (TypeError, ValueError):
      raise ValueError({
          'error-string': """not_advertise must be of a type compatible with boolean""",
          'defined-type': "boolean",
          'generated-type': """YANGDynClass(base=YANGBool, is_leaf=True, yang_name="not-advertise", module_name="l3features", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='http://anutanetworks.com/l3features', defining_module='l3features', yang_type='boolean', is_config=True)""",
        })

    self.__not_advertise = t
    if hasattr(self, '_set'):
      self._set()

  def _unset_not_advertise(self):
    self.__not_advertise = YANGDynClass(base=YANGBool, is_leaf=True, yang_name="not-advertise", module_name="l3features", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='http://anutanetworks.com/l3features', defining_module='l3features', yang_type='boolean', is_config=True)


  def _get_nssa_only(self):
    """
    Getter method for nssa_only, mapped from YANG variable /devices/device/vrfs/vrf/router_ospf/summary/nssa_only (boolean)
  ...
  def _set_nssa_only(self, v, load=False):
    """
    Setter method for nssa_only, mapped from YANG variable /devices/device/vrfs/vrf/router_ospf/summary/nssa_only (boolean)
    If this variable is read-only (config: false) in the
  ...
  def _get_tag(self):
    """
    Getter method for tag, mapped from YANG variable /devices/device/vrfs/vrf/router_ospf/summary/tag (uint32)
  ...
  def _set_tag(self, v, load=False):
    """
    Setter method for tag, mapped from YANG variable /devices/device/vrfs/vrf/router_ospf/summary/tag (uint32)
    If this variable is read-only (config: false) in the
  ...
  not_advertise = __builtin__.property(_get_not_advertise, _set_not_advertise)
  nssa_only = __builtin__.property(_get_nssa_only, _set_nssa_only)
  tag = __builtin__.property(_get_tag, _set_tag)


  _pyangbind_elements = collections.OrderedDict([('ip_address', ip_address), ('netmask', netmask), ('route_map', route_map), ('not_advertise', not_advertise), ('nssa_only', nssa_only), ('tag', tag), ])
