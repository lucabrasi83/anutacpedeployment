...
class match_conditions(PybindBase):
  ...
  from YANG module controller - based on the path /devices/device/vrfs/vrf/router-eigrp/match-conditions. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'devices', u'device', u'vrfs', u'vrf', u'router-eigrp', u'match-conditions']

  def _get_match_condition(self):
    """
    Getter method for match_condition, mapped from YANG variable /devices/device/vrfs/vrf/router_eigrp/match_conditions/match_condition (list)
    """
    return self.__match_condition
      
  def _set_match_condition(self, v, load=False):
    """
    Setter method for match_condition, mapped from YANG variable /devices/device/vrfs/vrf/router_eigrp/match_conditions/match_condition (list)
