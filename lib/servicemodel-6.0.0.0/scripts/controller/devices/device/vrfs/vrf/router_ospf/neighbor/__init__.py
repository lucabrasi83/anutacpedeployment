...
class neighbor(PybindBase):
  ...
  from YANG module controller - based on the path /devices/device/vrfs/vrf/router-ospf/neighbor. Each member element of
  the container is represented as a class variable - with a specific
  YANG type.
  """
  __slots__ = ('_pybind_generated_by', '_netconf_operation_type', '_path_helper', '_yang_name', '_extmethods', '_module_name', '_namespace','__ip_address','__ipv6_address','__netmask','__local_interface','__area',)
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'devices', u'device', u'vrfs', u'vrf', u'router-ospf', u'neighbor']

  def _get_ip_address(self):
    """
    Getter method for ip_address, mapped from YANG variable /devices/device/vrfs/vrf/router_ospf/neighbor/ip_address (inet:ipv4-address)
  ...
  def _set_ip_address(self, v, load=False):
    """
    Setter method for ip_address, mapped from YANG variable /devices/device/vrfs/vrf/router_ospf/neighbor/ip_address (inet:ipv4-address)
  ...
  def _get_ipv6_address(self):
    """
    Getter method for ipv6_address, mapped from YANG variable /devices/device/vrfs/vrf/router_ospf/neighbor/ipv6_address (inet:ipv6-address)
  ...
  def _set_ipv6_address(self, v, load=False):
    """
    Setter method for ipv6_address, mapped from YANG variable /devices/device/vrfs/vrf/router_ospf/neighbor/ipv6_address (inet:ipv6-address)
    If this variable is read-only (config: false) in the
  ...
  def _get_netmask(self):
    """
    Getter method for netmask, mapped from YANG variable /devices/device/vrfs/vrf/router_ospf/neighbor/netmask (string)
  ...
  def _set_netmask(self, v, load=False):
    """
    Setter method for netmask, mapped from YANG variable /devices/device/vrfs/vrf/router_ospf/neighbor/netmask (string)
    If this variable is read-only (config: false) in the
  ...
  def _get_local_interface(self):
    """
    Getter method for local_interface, mapped from YANG variable /devices/device/vrfs/vrf/router_ospf/neighbor/local_interface (leafref)
  ...
  def _set_local_interface(self, v, load=False):
    """
    Setter method for local_interface, mapped from YANG variable /devices/device/vrfs/vrf/router_ospf/neighbor/local_interface (leafref)
    If this variable is read-only (config: false) in the
  ...
  def _get_area(self):
    """
    Getter method for area, mapped from YANG variable /devices/device/vrfs/vrf/router_ospf/neighbor/area (string)
  ...
  def _set_area(self, v, load=False):
    """
    Setter method for area, mapped from YANG variable /devices/device/vrfs/vrf/router_ospf/neighbor/area (string)
    If this variable is read-only (config: false) in the
  ...
  _pyangbind_elements = collections.OrderedDict([('ip_address', ip_address), ('ipv6_address', ipv6_address), ('netmask', netmask), ('local_interface', local_interface), ('area', area), ])
