...
def isEmpty(val):
    ...
    return False
class export_map(PybindBase):
  """
  This class was auto-generated by the PythonClass plugin for PYANG
  from YANG module controller - based on the path /devices/device/vrfs/vrf/export-map. Each member element of
  the container is represented as a class variable - with a specific
  YANG type.
  """
  __slots__ = ('_pybind_generated_by', '_netconf_operation_type', '_path_helper', '_yang_name', '_extmethods', '_module_name', '_namespace','__export_map','__ipv4','__table','__upper_limit',)

  _yang_name = 'export-map'
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'devices', u'device', u'vrfs', u'vrf', u'export-map']

  def _get_export_map(self):
    """
    Getter method for export_map, mapped from YANG variable /devices/device/vrfs/vrf/export_map/export_map (string)
  ...
  def _set_export_map(self, v, load=False):
    """
    Setter method for export_map, mapped from YANG variable /devices/device/vrfs/vrf/export_map/export_map (string)
    ...
    try:
      if isEmpty(v):
        return
      t = YANGDynClass(v,base=unicode, is_leaf=True, yang_name="export-map", module_name="l3features", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, is_keyval=True, namespace='http://anutanetworks.com/l3features', defining_module='l3features', yang_type='string', is_config=True)
    except (TypeError, ValueError):
      raise ValueError({
          'error-string': """export_map must be of a type compatible with string""",
          'defined-type': "string",
          'generated-type': """YANGDynClass(base=unicode, is_leaf=True, yang_name="export-map", module_name="l3features", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, is_keyval=True, namespace='http://anutanetworks.com/l3features', defining_module='l3features', yang_type='string', is_config=True)""",
        })
  ...
  def _get_ipv4(self):
    """
    Getter method for ipv4, mapped from YANG variable /devices/device/vrfs/vrf/export_map/ipv4 (boolean)
  ...
  def _set_ipv4(self, v, load=False):
    """
    Setter method for ipv4, mapped from YANG variable /devices/device/vrfs/vrf/export_map/ipv4 (boolean)
    If this variable is read-only (config: false) in the
  ...
  def _get_table(self):
    """
    Getter method for table, mapped from YANG variable /devices/device/vrfs/vrf/export_map/table (table-def)
...
unicast
  ...
  def _set_table(self, v, load=False):
    """
    Setter method for table, mapped from YANG variable /devices/device/vrfs/vrf/export_map/table (table-def)
    If this variable is read-only (config: false) in the
...
unicast
  ...
  def _get_upper_limit(self):
    """
    Getter method for upper_limit, mapped from YANG variable /devices/device/vrfs/vrf/export_map/upper_limit (uint32)
  ...
  def _set_upper_limit(self, v, load=False):
    """
    Setter method for upper_limit, mapped from YANG variable /devices/device/vrfs/vrf/export_map/upper_limit (uint32)
    If this variable is read-only (config: false) in the
  ...
  _pyangbind_elements = collections.OrderedDict([('export_map', export_map), ('ipv4', ipv4), ('table', table), ('upper_limit', upper_limit), ])
