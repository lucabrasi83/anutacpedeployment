...
class capacity(PybindBase):
  ...
  from YANG module controller - based on the path /devices/device/capacities/capacity. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'devices', u'device', u'capacities', u'capacity']

  def _get_capacity_id(self):
    """
    Getter method for capacity_id, mapped from YANG variable /devices/device/capacities/capacity/capacity_id (string)
  ...
  def _set_capacity_id(self, v, load=False):
    """
    Setter method for capacity_id, mapped from YANG variable /devices/device/capacities/capacity/capacity_id (string)
  ...
  def _get_capacity_type(self):
    """
    Getter method for capacity_type, mapped from YANG variable /devices/device/capacities/capacity/capacity_type (leafref)
  ...
  def _set_capacity_type(self, v, load=False):
    """
    Setter method for capacity_type, mapped from YANG variable /devices/device/capacities/capacity/capacity_type (leafref)
    If this variable is read-only (config: false) in the
  ...
  def _get_capacity_units(self):
    """
    Getter method for capacity_units, mapped from YANG variable /devices/device/capacities/capacity/capacity_units (ndt:capacity-units)
...
PACKETS
  ...
  def _set_capacity_units(self, v, load=False):
    """
    Setter method for capacity_units, mapped from YANG variable /devices/device/capacities/capacity/capacity_units (ndt:capacity-units)
    If this variable is read-only (config: false) in the
...
PACKETS
  ...
  def _get_total(self):
    """
    Getter method for total, mapped from YANG variable /devices/device/capacities/capacity/total (uint32)
  ...
  def _set_total(self, v, load=False):
    """
    Setter method for total, mapped from YANG variable /devices/device/capacities/capacity/total (uint32)
    If this variable is read-only (config: false) in the
  ...
  def _get_reserved(self):
    """
    Getter method for reserved, mapped from YANG variable /devices/device/capacities/capacity/reserved (uint32)
  ...
  def _set_reserved(self, v, load=False):
    """
    Setter method for reserved, mapped from YANG variable /devices/device/capacities/capacity/reserved (uint32)
    If this variable is read-only (config: false) in the
  ...
  def _get_used(self):
    """
    Getter method for used, mapped from YANG variable /devices/device/capacities/capacity/used (uint32)
  ...
  def _set_used(self, v, load=False):
    """
    Setter method for used, mapped from YANG variable /devices/device/capacities/capacity/used (uint32)
    If this variable is read-only (config: false) in the
  ...
  def _get_available(self):
    """
    Getter method for available, mapped from YANG variable /devices/device/capacities/capacity/available (uint32)
  ...
  def _set_available(self, v, load=False):
    """
    Setter method for available, mapped from YANG variable /devices/device/capacities/capacity/available (uint32)
    If this variable is read-only (config: false) in the
  ...
  def _get_alarm_spec_type(self):
    """
    Getter method for alarm_spec_type, mapped from YANG variable /devices/device/capacities/capacity/alarm_spec_type (leafref)
  ...
  def _set_alarm_spec_type(self, v, load=False):
    """
    Setter method for alarm_spec_type, mapped from YANG variable /devices/device/capacities/capacity/alarm_spec_type (leafref)
    If this variable is read-only (config: false) in the
    ...
    try:
      if isEmpty(v):
        return
      t = YANGDynClass(v,base=unicode, is_leaf=True, yang_name="alarm-spec-type", module_name="capacities", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='http://anutanetworks.com/capacities', defining_module='capacities', yang_type='leafref', is_config=True)
    except (TypeError, ValueError):
      raise ValueError({
          'error-string': """alarm_spec_type must be of a type compatible with leafref""",
          'defined-type': "leafref",
          'generated-type': """YANGDynClass(base=unicode, is_leaf=True, yang_name="alarm-spec-type", module_name="capacities", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='http://anutanetworks.com/capacities', defining_module='capacities', yang_type='leafref', is_config=True)""",
        })
