...
class address(PybindBase):
  ...
  from YANG module controller - based on the path /devices/device/interfaces/interface/hsrp/additional-ipv4-address/address. Each member element of
  the container is represented as a class variable - with a specific
  YANG type.
  """
  __slots__ = ('_pybind_generated_by', '_netconf_operation_type', '_path_helper', '_yang_name', '_extmethods', '_module_name', '_namespace','__ip','__netmask','__family','__mtu','__acl_inbound_name','__acl_outbound_name','__source_ip','__destination_ip','__destination_vrf','__allow_fragmentation',)
  ...
  def __init__(self, *args, **kwargs):
    ...
    self.__destination_ip = YANGDynClass(base=RestrictedClassType(base_type=unicode, restriction_dict={'pattern': u'(([0-9]|[1-9][0-9]|1[0-9][0-9]|2[0-4][0-9]|25[0-5])\\.){3}([0-9]|[1-9][0-9]|1[0-9][0-9]|2[0-4][0-9]|25[0-5])(%[\\p{N}\\p{L}]+)?'}), is_leaf=True, yang_name="destination-ip", module_name="hsrp", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='http://anutanetworks.com/hsrp', defining_module='hsrp', yang_type='inet:ipv4-address', is_config=True)
    ...
    self.__ip = YANGDynClass(base=RestrictedClassType(base_type=unicode, restriction_dict={'pattern': u'(([0-9]|[1-9][0-9]|1[0-9][0-9]|2[0-4][0-9]|25[0-5])\\.){3}([0-9]|[1-9][0-9]|1[0-9][0-9]|2[0-4][0-9]|25[0-5])(%[\\p{N}\\p{L}]+)?'}), is_leaf=True, yang_name="ip", module_name="hsrp", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, is_keyval=True, namespace='http://anutanetworks.com/hsrp', defining_module='hsrp', yang_type='inet:ipv4-address', is_config=True)
    ...
    self.__source_ip = YANGDynClass(base=RestrictedClassType(base_type=unicode, restriction_dict={'pattern': u'(([0-9]|[1-9][0-9]|1[0-9][0-9]|2[0-4][0-9]|25[0-5])\\.){3}([0-9]|[1-9][0-9]|1[0-9][0-9]|2[0-4][0-9]|25[0-5])(%[\\p{N}\\p{L}]+)?'}), is_leaf=True, yang_name="source-ip", module_name="hsrp", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='http://anutanetworks.com/hsrp', defining_module='hsrp', yang_type='inet:ipv4-address', is_config=True)
    ...
    self.__netmask = YANGDynClass(base=unicode, is_leaf=True, yang_name="netmask", module_name="hsrp", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='http://anutanetworks.com/hsrp', defining_module='hsrp', yang_type='string', is_config=True)
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'devices', u'device', u'interfaces', u'interface', u'hsrp', u'additional-ipv4-address', u'address']

  def _get_ip(self):
    """
    Getter method for ip, mapped from YANG variable /devices/device/interfaces/interface/hsrp/additional_ipv4_address/address/ip (inet:ipv4-address)
  ...
  def _set_ip(self, v, load=False):
    """
    Setter method for ip, mapped from YANG variable /devices/device/interfaces/interface/hsrp/additional_ipv4_address/address/ip (inet:ipv4-address)
    ...
    try:
      if isEmpty(v):
        return
      t = YANGDynClass(v,base=RestrictedClassType(base_type=unicode, restriction_dict={'pattern': u'(([0-9]|[1-9][0-9]|1[0-9][0-9]|2[0-4][0-9]|25[0-5])\\.){3}([0-9]|[1-9][0-9]|1[0-9][0-9]|2[0-4][0-9]|25[0-5])(%[\\p{N}\\p{L}]+)?'}), is_leaf=True, yang_name="ip", module_name="hsrp", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, is_keyval=True, namespace='http://anutanetworks.com/hsrp', defining_module='hsrp', yang_type='inet:ipv4-address', is_config=True)
    except (TypeError, ValueError):
      raise ValueError({
          'error-string': """ip must be of a type compatible with inet:ipv4-address""",
          'defined-type': "inet:ipv4-address",
          'generated-type': """YANGDynClass(base=RestrictedClassType(base_type=unicode, restriction_dict={'pattern': u'(([0-9]|[1-9][0-9]|1[0-9][0-9]|2[0-4][0-9]|25[0-5])\\.){3}([0-9]|[1-9][0-9]|1[0-9][0-9]|2[0-4][0-9]|25[0-5])(%[\\p{N}\\p{L}]+)?'}), is_leaf=True, yang_name="ip", module_name="hsrp", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, is_keyval=True, namespace='http://anutanetworks.com/hsrp', defining_module='hsrp', yang_type='inet:ipv4-address', is_config=True)""",
        })
  ...
  def _get_netmask(self):
    """
    Getter method for netmask, mapped from YANG variable /devices/device/interfaces/interface/hsrp/additional_ipv4_address/address/netmask (string)
  ...
  def _set_netmask(self, v, load=False):
    """
    Setter method for netmask, mapped from YANG variable /devices/device/interfaces/interface/hsrp/additional_ipv4_address/address/netmask (string)
    If this variable is read-only (config: false) in the
    ...
    try:
      if isEmpty(v):
        return
      t = YANGDynClass(v,base=unicode, is_leaf=True, yang_name="netmask", module_name="hsrp", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='http://anutanetworks.com/hsrp', defining_module='hsrp', yang_type='string', is_config=True)
    except (TypeError, ValueError):
      raise ValueError({
          'error-string': """netmask must be of a type compatible with string""",
          'defined-type': "string",
          'generated-type': """YANGDynClass(base=unicode, is_leaf=True, yang_name="netmask", module_name="hsrp", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='http://anutanetworks.com/hsrp', defining_module='hsrp', yang_type='string', is_config=True)""",
        })
  ...
  def _get_family(self):
    """
    Getter method for family, mapped from YANG variable /devices/device/interfaces/interface/hsrp/additional_ipv4_address/address/family (family-type)
...
inet6
  ...
  def _set_family(self, v, load=False):
    """
    Setter method for family, mapped from YANG variable /devices/device/interfaces/interface/hsrp/additional_ipv4_address/address/family (family-type)
    If this variable is read-only (config: false) in the
...
inet6
  ...
  def _get_mtu(self):
    """
    Getter method for mtu, mapped from YANG variable /devices/device/interfaces/interface/hsrp/additional_ipv4_address/address/mtu (uint32)
  ...
  def _set_mtu(self, v, load=False):
    """
    Setter method for mtu, mapped from YANG variable /devices/device/interfaces/interface/hsrp/additional_ipv4_address/address/mtu (uint32)
    If this variable is read-only (config: false) in the
  ...
  def _get_acl_inbound_name(self):
    """
    Getter method for acl_inbound_name, mapped from YANG variable /devices/device/interfaces/interface/hsrp/additional_ipv4_address/address/acl_inbound_name (string)
  ...
  def _set_acl_inbound_name(self, v, load=False):
    """
    Setter method for acl_inbound_name, mapped from YANG variable /devices/device/interfaces/interface/hsrp/additional_ipv4_address/address/acl_inbound_name (string)
    If this variable is read-only (config: false) in the
  ...
  def _get_acl_outbound_name(self):
    """
    Getter method for acl_outbound_name, mapped from YANG variable /devices/device/interfaces/interface/hsrp/additional_ipv4_address/address/acl_outbound_name (string)
  ...
  def _set_acl_outbound_name(self, v, load=False):
    """
    Setter method for acl_outbound_name, mapped from YANG variable /devices/device/interfaces/interface/hsrp/additional_ipv4_address/address/acl_outbound_name (string)
    If this variable is read-only (config: false) in the
  ...
  def _get_source_ip(self):
    """
    Getter method for source_ip, mapped from YANG variable /devices/device/interfaces/interface/hsrp/additional_ipv4_address/address/source_ip (inet:ipv4-address)
  ...
  def _set_source_ip(self, v, load=False):
    """
    Setter method for source_ip, mapped from YANG variable /devices/device/interfaces/interface/hsrp/additional_ipv4_address/address/source_ip (inet:ipv4-address)
    If this variable is read-only (config: false) in the
    ...
    try:
      if isEmpty(v):
        return
      t = YANGDynClass(v,base=RestrictedClassType(base_type=unicode, restriction_dict={'pattern': u'(([0-9]|[1-9][0-9]|1[0-9][0-9]|2[0-4][0-9]|25[0-5])\\.){3}([0-9]|[1-9][0-9]|1[0-9][0-9]|2[0-4][0-9]|25[0-5])(%[\\p{N}\\p{L}]+)?'}), is_leaf=True, yang_name="source-ip", module_name="hsrp", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='http://anutanetworks.com/hsrp', defining_module='hsrp', yang_type='inet:ipv4-address', is_config=True)
    except (TypeError, ValueError):
      raise ValueError({
          'error-string': """source_ip must be of a type compatible with inet:ipv4-address""",
          'defined-type': "inet:ipv4-address",
          'generated-type': """YANGDynClass(base=RestrictedClassType(base_type=unicode, restriction_dict={'pattern': u'(([0-9]|[1-9][0-9]|1[0-9][0-9]|2[0-4][0-9]|25[0-5])\\.){3}([0-9]|[1-9][0-9]|1[0-9][0-9]|2[0-4][0-9]|25[0-5])(%[\\p{N}\\p{L}]+)?'}), is_leaf=True, yang_name="source-ip", module_name="hsrp", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='http://anutanetworks.com/hsrp', defining_module='hsrp', yang_type='inet:ipv4-address', is_config=True)""",
        })
  ...
  def _get_destination_ip(self):
    """
    Getter method for destination_ip, mapped from YANG variable /devices/device/interfaces/interface/hsrp/additional_ipv4_address/address/destination_ip (inet:ipv4-address)
  ...
  def _set_destination_ip(self, v, load=False):
    """
    Setter method for destination_ip, mapped from YANG variable /devices/device/interfaces/interface/hsrp/additional_ipv4_address/address/destination_ip (inet:ipv4-address)
    If this variable is read-only (config: false) in the
    ...
    try:
      if isEmpty(v):
        return
      t = YANGDynClass(v,base=RestrictedClassType(base_type=unicode, restriction_dict={'pattern': u'(([0-9]|[1-9][0-9]|1[0-9][0-9]|2[0-4][0-9]|25[0-5])\\.){3}([0-9]|[1-9][0-9]|1[0-9][0-9]|2[0-4][0-9]|25[0-5])(%[\\p{N}\\p{L}]+)?'}), is_leaf=True, yang_name="destination-ip", module_name="hsrp", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='http://anutanetworks.com/hsrp', defining_module='hsrp', yang_type='inet:ipv4-address', is_config=True)
    except (TypeError, ValueError):
      raise ValueError({
          'error-string': """destination_ip must be of a type compatible with inet:ipv4-address""",
          'defined-type': "inet:ipv4-address",
          'generated-type': """YANGDynClass(base=RestrictedClassType(base_type=unicode, restriction_dict={'pattern': u'(([0-9]|[1-9][0-9]|1[0-9][0-9]|2[0-4][0-9]|25[0-5])\\.){3}([0-9]|[1-9][0-9]|1[0-9][0-9]|2[0-4][0-9]|25[0-5])(%[\\p{N}\\p{L}]+)?'}), is_leaf=True, yang_name="destination-ip", module_name="hsrp", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='http://anutanetworks.com/hsrp', defining_module='hsrp', yang_type='inet:ipv4-address', is_config=True)""",
        })
  ...
  def _get_destination_vrf(self):
    """
    Getter method for destination_vrf, mapped from YANG variable /devices/device/interfaces/interface/hsrp/additional_ipv4_address/address/destination_vrf (string)
  ...
  def _set_destination_vrf(self, v, load=False):
    """
    Setter method for destination_vrf, mapped from YANG variable /devices/device/interfaces/interface/hsrp/additional_ipv4_address/address/destination_vrf (string)
    If this variable is read-only (config: false) in the
  ...
  def _get_allow_fragmentation(self):
    """
    Getter method for allow_fragmentation, mapped from YANG variable /devices/device/interfaces/interface/hsrp/additional_ipv4_address/address/allow_fragmentation (boolean)
  ...
  def _set_allow_fragmentation(self, v, load=False):
    """
    Setter method for allow_fragmentation, mapped from YANG variable /devices/device/interfaces/interface/hsrp/additional_ipv4_address/address/allow_fragmentation (boolean)
    If this variable is read-only (config: false) in the
  ...
  _pyangbind_elements = collections.OrderedDict([('ip', ip), ('netmask', netmask), ('family', family), ('mtu', mtu), ('acl_inbound_name', acl_inbound_name), ('acl_outbound_name', acl_outbound_name), ('source_ip', source_ip), ('destination_ip', destination_ip), ('destination_vrf', destination_vrf), ('allow_fragmentation', allow_fragmentation), ])
