...
def isEmpty(val):
    ...
    return False
import fw_user
class fw_user_group(PybindBase):
  """
  This class was auto-generated by the PythonClass plugin for PYANG
  from YANG module controller - based on the path /devices/device/fw-user-groups/fw-user-group. Each member element of
  the container is represented as a class variable - with a specific
  YANG type.
  """
  __slots__ = ('_pybind_generated_by', '_netconf_operation_type', '_path_helper', '_yang_name', '_extmethods', '_module_name', '_namespace','__name','__virtual_device_name','__fw_user',)

  _yang_name = 'fw-user-group'
  ...
  def __init__(self, *args, **kwargs):
    ...
    self.__fw_user = YANGDynClass(base=YANGListType("member_name",fw_user.fw_user, yang_name="fw-user", module_name="firewall", parent=self, is_container='list', user_ordered=False, path_helper=self._path_helper, yang_keys='member-name'), is_container='list', yang_name="fw-user", module_name="firewall", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='http://anutanetworks.com/firewall', defining_module='firewall', yang_type='list', is_config=True)
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'devices', u'device', u'fw-user-groups', u'fw-user-group']

  def _get_name(self):
    """
    Getter method for name, mapped from YANG variable /devices/device/fw_user_groups/fw_user_group/name (string)
  ...
  def _set_name(self, v, load=False):
    """
    Setter method for name, mapped from YANG variable /devices/device/fw_user_groups/fw_user_group/name (string)
  ...
  def _get_virtual_device_name(self):
    """
    Getter method for virtual_device_name, mapped from YANG variable /devices/device/fw_user_groups/fw_user_group/virtual_device_name (leafref)
  ...
  def _set_virtual_device_name(self, v, load=False):
    """
    Setter method for virtual_device_name, mapped from YANG variable /devices/device/fw_user_groups/fw_user_group/virtual_device_name (leafref)
    If this variable is read-only (config: false) in the
  ...
  def _get_fw_user(self):
    """
    Getter method for fw_user, mapped from YANG variable /devices/device/fw_user_groups/fw_user_group/fw_user (list)
    """
    return self.__fw_user
      
  def _set_fw_user(self, v, load=False):
    """
    Setter method for fw_user, mapped from YANG variable /devices/device/fw_user_groups/fw_user_group/fw_user (list)
    If this variable is read-only (config: false) in the
    source YANG file, then _set_fw_user is considered as a private
    method. Backends looking to populate this variable should
    do so via calling thisObj._set_fw_user() directly.
    """
    try:
      if isEmpty(v):
        return
      ...
      raise ValueError({
          'error-string': """fw_user must be of a type compatible with list""",
          'defined-type': "list",
  ...
  def _unset_fw_user(self):
    self.__fw_user = YANGDynClass(base=YANGListType("member_name",fw_user.fw_user, yang_name="fw-user", module_name="firewall", parent=self, is_container='list', user_ordered=False, path_helper=self._path_helper, yang_keys='member-name'), is_container='list', yang_name="fw-user", module_name="firewall", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='http://anutanetworks.com/firewall', defining_module='firewall', yang_type='list', is_config=True)

  name = __builtin__.property(_get_name, _set_name)
  virtual_device_name = __builtin__.property(_get_virtual_device_name, _set_virtual_device_name)
  fw_user = __builtin__.property(_get_fw_user, _set_fw_user)


  _pyangbind_elements = collections.OrderedDict([('name', name), ('virtual_device_name', virtual_device_name), ('fw_user', fw_user), ])
