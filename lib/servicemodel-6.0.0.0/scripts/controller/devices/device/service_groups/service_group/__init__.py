...
def isEmpty(val):
    ...
    return False
import member
class service_group(PybindBase):
  """
  This class was auto-generated by the PythonClass plugin for PYANG
  from YANG module controller - based on the path /devices/device/service-groups/service-group. Each member element of
  the container is represented as a class variable - with a specific
  YANG type.
  """
  __slots__ = ('_pybind_generated_by', '_netconf_operation_type', '_path_helper', '_yang_name', '_extmethods', '_module_name', '_namespace','__name','__member','__device_group',)

  _yang_name = 'service-group'
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'devices', u'device', u'service-groups', u'service-group']

  def _get_name(self):
    """
    Getter method for name, mapped from YANG variable /devices/device/service_groups/service_group/name (string)
  ...
  def _set_name(self, v, load=False):
    """
    Setter method for name, mapped from YANG variable /devices/device/service_groups/service_group/name (string)
  ...
  def _get_member(self):
    """
    Getter method for member, mapped from YANG variable /devices/device/service_groups/service_group/member (list)
    """
    return self.__member
      
  def _set_member(self, v, load=False):
    """
    Setter method for member, mapped from YANG variable /devices/device/service_groups/service_group/member (list)
    If this variable is read-only (config: false) in the
  ...
  def _get_device_group(self):
    """
    Getter method for device_group, mapped from YANG variable /devices/device/service_groups/service_group/device_group (string)
  ...
  def _set_device_group(self, v, load=False):
    """
    Setter method for device_group, mapped from YANG variable /devices/device/service_groups/service_group/device_group (string)
    If this variable is read-only (config: false) in the
  ...
  _pyangbind_elements = collections.OrderedDict([('name', name), ('member', member), ('device_group', device_group), ])
