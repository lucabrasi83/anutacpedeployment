...
def isEmpty(val):
    ...
    return False
import properties
class complex_typedef(PybindBase):
  """
  This class was auto-generated by the PythonClass plugin for PYANG
  from YANG module controller - based on the path /network-functions/complex-typedefs/complex-typedef. Each member element of
  the container is represented as a class variable - with a specific
  YANG type.
  """
  __slots__ = ('_pybind_generated_by', '_netconf_operation_type', '_path_helper', '_yang_name', '_extmethods', '_module_name', '_namespace','__name','__description','__label','__hint','__properties',)

  _yang_name = 'complex-typedef'
  ...
  def __init__(self, *args, **kwargs):
    ...
    self.__properties = YANGDynClass(base=properties.properties, is_container='container', yang_name="properties", module_name="controller", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='http://anutanetworks.com/controller', defining_module='controller', yang_type='container', is_config=True)
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'network-functions', u'complex-typedefs', u'complex-typedef']

  def _get_name(self):
    """
    Getter method for name, mapped from YANG variable /network_functions/complex_typedefs/complex_typedef/name (string)
  ...
  def _set_name(self, v, load=False):
    """
    Setter method for name, mapped from YANG variable /network_functions/complex_typedefs/complex_typedef/name (string)
  ...
  def _get_description(self):
    """
    Getter method for description, mapped from YANG variable /network_functions/complex_typedefs/complex_typedef/description (string)
  ...
  def _set_description(self, v, load=False):
    """
    Setter method for description, mapped from YANG variable /network_functions/complex_typedefs/complex_typedef/description (string)
    If this variable is read-only (config: false) in the
  ...
  def _get_label(self):
    """
    Getter method for label, mapped from YANG variable /network_functions/complex_typedefs/complex_typedef/label (string)
  ...
  def _set_label(self, v, load=False):
    """
    Setter method for label, mapped from YANG variable /network_functions/complex_typedefs/complex_typedef/label (string)
    If this variable is read-only (config: false) in the
  ...
  def _get_hint(self):
    """
    Getter method for hint, mapped from YANG variable /network_functions/complex_typedefs/complex_typedef/hint (string)
  ...
  def _set_hint(self, v, load=False):
    """
    Setter method for hint, mapped from YANG variable /network_functions/complex_typedefs/complex_typedef/hint (string)
    If this variable is read-only (config: false) in the
  ...
  def _get_properties(self):
    """
    Getter method for properties, mapped from YANG variable /network_functions/complex_typedefs/complex_typedef/properties (container)
    """
    return self.__properties
      
  def _set_properties(self, v, load=False):
    """
    Setter method for properties, mapped from YANG variable /network_functions/complex_typedefs/complex_typedef/properties (container)
    If this variable is read-only (config: false) in the
  ...
  _pyangbind_elements = collections.OrderedDict([('name', name), ('description', description), ('label', label), ('hint', hint), ('properties', properties), ])
