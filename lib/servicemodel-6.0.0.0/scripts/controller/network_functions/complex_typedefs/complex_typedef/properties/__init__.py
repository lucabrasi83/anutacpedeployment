...
class properties(PybindBase):
  ...
  from YANG module controller - based on the path /network-functions/complex-typedefs/complex-typedef/properties. Each member element of
  the container is represented as a class variable - with a specific
  YANG type.
  """
  __slots__ = ('_pybind_generated_by', '_netconf_operation_type', '_path_helper', '_yang_name', '_extmethods', '_module_name', '_namespace','__property',)
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'network-functions', u'complex-typedefs', u'complex-typedef', u'properties']

  def _get_property(self):
    """
    Getter method for property, mapped from YANG variable /network_functions/complex_typedefs/complex_typedef/properties/property (list)
    """
    return self.__property
      
  def _set_property(self, v, load=False):
    """
    Setter method for property, mapped from YANG variable /network_functions/complex_typedefs/complex_typedef/properties/property (list)
  ...
  _pyangbind_elements = collections.OrderedDict([('property', property), ])
