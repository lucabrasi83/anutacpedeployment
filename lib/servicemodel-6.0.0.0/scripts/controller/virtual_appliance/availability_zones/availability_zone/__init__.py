...
class availability_zone(PybindBase):
  ...
  from YANG module controller - based on the path /virtual-appliance/availability-zones/availability-zone. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'virtual-appliance', u'availability-zones', u'availability-zone']

  def _get_name(self):
    """
    Getter method for name, mapped from YANG variable /virtual_appliance/availability_zones/availability_zone/name (string)
  ...
  def _set_name(self, v, load=False):
    """
    Setter method for name, mapped from YANG variable /virtual_appliance/availability_zones/availability_zone/name (string)
