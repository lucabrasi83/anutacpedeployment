...
def isEmpty(val):
    ...
    return False
class availability_zone(PybindBase):
  """
  This class was auto-generated by the PythonClass plugin for PYANG
  from YANG module controller - based on the path /virtual-appliance/deployment-profiles/deployment-profile/availability-zones/availability-zone. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'virtual-appliance', u'deployment-profiles', u'deployment-profile', u'availability-zones', u'availability-zone']

  def _get_name(self):
    """
    Getter method for name, mapped from YANG variable /virtual_appliance/deployment_profiles/deployment_profile/availability_zones/availability_zone/name (string)
  ...
  def _set_name(self, v, load=False):
    """
    Setter method for name, mapped from YANG variable /virtual_appliance/deployment_profiles/deployment_profile/availability_zones/availability_zone/name (string)
