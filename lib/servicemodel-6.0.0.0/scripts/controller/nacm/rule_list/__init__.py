...
def isEmpty(val):
    ...
    return False
import rule
class rule_list(PybindBase):
  """
  This class was auto-generated by the PythonClass plugin for PYANG
  from YANG module controller - based on the path /nacm/rule-list. Each member element of
  the container is represented as a class variable - with a specific
  YANG type.

  YANG Description: An ordered collection of access control rules.
  """
  __slots__ = ('_pybind_generated_by', '_netconf_operation_type', '_path_helper', '_yang_name', '_extmethods', '_module_name', '_namespace','__name','__group','__rule',)

  _yang_name = 'rule-list'
  ...
  def __init__(self, *args, **kwargs):
    ...
    self.__group = YANGDynClass(base=TypedListType(allowed_type=unicode), is_leaf=False, yang_name="group", module_name="controller", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='http://anutanetworks.com/controller', defining_module='controller', yang_type='leafref', is_config=True)
    ...
    self.__rule = YANGDynClass(base=YANGListType("name",rule.rule, yang_name="rule", module_name="controller", parent=self, is_container='list', user_ordered=True, path_helper=self._path_helper, yang_keys='name'), is_container='list', yang_name="rule", module_name="controller", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='http://anutanetworks.com/controller', defining_module='controller', yang_type='list', is_config=True)
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'nacm', u'rule-list']

  def _get_name(self):
    """
    Getter method for name, mapped from YANG variable /nacm/rule_list/name (string)

    YANG Description: Arbitrary name assigned to the rule-list.
    """
    return self.__name
      
  def _set_name(self, v, load=False):
    """
    Setter method for name, mapped from YANG variable /nacm/rule_list/name (string)
  ...
  def _get_group(self):
    """
    Getter method for group, mapped from YANG variable /nacm/rule_list/group (leafref)

    YANG Description: List of administrative groups that will be
...
entry.
  ...
  def _set_group(self, v, load=False):
    """
    Setter method for group, mapped from YANG variable /nacm/rule_list/group (leafref)
    If this variable is read-only (config: false) in the
...
entry.
  ...
  def _get_rule(self):
    """
    Getter method for rule, mapped from YANG variable /nacm/rule_list/rule (list)
...
or not.
  ...
  def _set_rule(self, v, load=False):
    """
    Setter method for rule, mapped from YANG variable /nacm/rule_list/rule (list)
    If this variable is read-only (config: false) in the
...
or not.
  ...
  _pyangbind_elements = collections.OrderedDict([('name', name), ('group', group), ('rule', rule), ])
