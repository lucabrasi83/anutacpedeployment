...
class output(PybindBase):
  ...
  from YANG module networkfunctionssupport - based on the path /networkfunctionssupport_rpc/interface-event-handler/output. Each member element of
  the container is represented as a class variable - with a specific
  YANG type.
  """
  __slots__ = ('_pybind_generated_by', '_netconf_operation_type', '_path_helper', '_yang_name', '_extmethods', '_module_name', '_namespace','__payload',)
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'networkfunctionssupport_rpc', u'interface-event-handler', u'output']

  def _get_payload(self):
    """
    Getter method for payload, mapped from YANG variable /networkfunctionssupport_rpc/interface_event_handler/output/payload (string)

    YANG Description: Payload to update the data into DataNode
    """
    return self.__payload
      
  def _set_payload(self, v, load=False):
    """
    Setter method for payload, mapped from YANG variable /networkfunctionssupport_rpc/interface_event_handler/output/payload (string)
  ...
  _pyangbind_elements = collections.OrderedDict([('payload', payload), ])
