...
class internal(PybindBase):
  ...
  from YANG module controller - based on the path /system/internal. Each member element of
  the container is represented as a class variable - with a specific
  YANG type.
  """
  __slots__ = ('_pybind_generated_by', '_netconf_operation_type', '_path_helper', '_yang_name', '_extmethods', '_module_name', '_namespace','__tables',)
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'system', u'internal']

  def _get_tables(self):
    """
    Getter method for tables, mapped from YANG variable /system/internal/tables (container)
    """
    return self.__tables
      
  def _set_tables(self, v, load=False):
    """
    Setter method for tables, mapped from YANG variable /system/internal/tables (container)
  ...
  _pyangbind_elements = collections.OrderedDict([('tables', tables), ])
