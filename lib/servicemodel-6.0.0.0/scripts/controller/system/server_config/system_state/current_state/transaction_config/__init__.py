...
class transaction_config(PybindBase):
  ...
  from YANG module controller - based on the path /system/server-config/system-state/current-state/transaction-config. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'system', u'server-config', u'system-state', u'current-state', u'transaction-config']

  def _get_fail_fast(self):
    """
    Getter method for fail_fast, mapped from YANG variable /system/server_config/system_state/current_state/transaction_config/fail_fast (boolean)
...
commit-task
  ...
  def _set_fail_fast(self, v, load=False):
    """
    Setter method for fail_fast, mapped from YANG variable /system/server_config/system_state/current_state/transaction_config/fail_fast (boolean)
...
commit-task
  ...
  def _get_validation_scope(self):
    """
    Getter method for validation_scope, mapped from YANG variable /system/server_config/system_state/current_state/transaction_config/validation_scope (validation-scope-type)
  ...
  def _set_validation_scope(self, v, load=False):
    """
    Setter method for validation_scope, mapped from YANG variable /system/server_config/system_state/current_state/transaction_config/validation_scope (validation-scope-type)
    If this variable is read-only (config: false) in the
  ...
  def _get_command_sequence_policy(self):
    """
    Getter method for command_sequence_policy, mapped from YANG variable /system/server_config/system_state/current_state/transaction_config/command_sequence_policy (command-sequence-policy-type)
...
NONE
  ...
  def _set_command_sequence_policy(self, v, load=False):
    """
    Setter method for command_sequence_policy, mapped from YANG variable /system/server_config/system_state/current_state/transaction_config/command_sequence_policy (command-sequence-policy-type)
    If this variable is read-only (config: false) in the
...
NONE
  ...
  def _get_auto_rollback(self):
    """
    Getter method for auto_rollback, mapped from YANG variable /system/server_config/system_state/current_state/transaction_config/auto_rollback (boolean)
...
rollback the changes
  ...
  def _set_auto_rollback(self, v, load=False):
    """
    Setter method for auto_rollback, mapped from YANG variable /system/server_config/system_state/current_state/transaction_config/auto_rollback (boolean)
    If this variable is read-only (config: false) in the
