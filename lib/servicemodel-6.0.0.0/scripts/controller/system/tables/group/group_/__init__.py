...
class group(PybindBase):
  ...
  from YANG module controller - based on the path /system/tables/group/group. Each member element of
  the container is represented as a class variable - with a specific
  YANG type.
  """
  __slots__ = ('_pybind_generated_by', '_netconf_operation_type', '_path_helper', '_yang_name', '_extmethods', '_module_name', '_namespace','__name','__group_id','__description',)
  ...
  def __init__(self, *args, **kwargs):
    ...
    self.__group_id = YANGDynClass(base=unicode, is_leaf=True, yang_name="group-id", module_name="controller", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='http://anutanetworks.com/controller', defining_module='controller', yang_type='string', is_config=True)
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'system', u'tables', u'group', u'group']

  def _get_name(self):
    """
    Getter method for name, mapped from YANG variable /system/tables/group/group/name (string)
  ...
  def _set_name(self, v, load=False):
    """
    Setter method for name, mapped from YANG variable /system/tables/group/group/name (string)
  ...
  def _get_group_id(self):
    """
    Getter method for group_id, mapped from YANG variable /system/tables/group/group/group_id (string)
  ...
  def _set_group_id(self, v, load=False):
    """
    Setter method for group_id, mapped from YANG variable /system/tables/group/group/group_id (string)
    If this variable is read-only (config: false) in the
    ...
    try:
      if isEmpty(v):
        return
      t = YANGDynClass(v,base=unicode, is_leaf=True, yang_name="group-id", module_name="controller", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='http://anutanetworks.com/controller', defining_module='controller', yang_type='string', is_config=True)
    except (TypeError, ValueError):
      raise ValueError({
          'error-string': """group_id must be of a type compatible with string""",
          'defined-type': "string",
          'generated-type': """YANGDynClass(base=unicode, is_leaf=True, yang_name="group-id", module_name="controller", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='http://anutanetworks.com/controller', defining_module='controller', yang_type='string', is_config=True)""",
        })
  ...
  def _get_description(self):
    """
    Getter method for description, mapped from YANG variable /system/tables/group/group/description (string)
  ...
  def _set_description(self, v, load=False):
    """
    Setter method for description, mapped from YANG variable /system/tables/group/group/description (string)
    If this variable is read-only (config: false) in the
  ...
  _pyangbind_elements = collections.OrderedDict([('name', name), ('group_id', group_id), ('description', description), ])
