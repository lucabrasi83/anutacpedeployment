...
class snmpv3(PybindBase):
  ...
  from YANG module controller - based on the path /system/tables/access-control/users/user/snmpv3. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'system', u'tables', u'access-control', u'users', u'user', u'snmpv3']

  def _get_auth_protocol(self):
    """
    Getter method for auth_protocol, mapped from YANG variable /system/tables/access_control/users/user/snmpv3/auth_protocol (snmpv3-auth-protocol)
...
MD5
  ...
  def _set_auth_protocol(self, v, load=False):
    """
    Setter method for auth_protocol, mapped from YANG variable /system/tables/access_control/users/user/snmpv3/auth_protocol (snmpv3-auth-protocol)
...
MD5
  ...
  def _get_auth_password(self):
    """
    Getter method for auth_password, mapped from YANG variable /system/tables/access_control/users/user/snmpv3/auth_password (nct:password)
  ...
  def _set_auth_password(self, v, load=False):
    """
    Setter method for auth_password, mapped from YANG variable /system/tables/access_control/users/user/snmpv3/auth_password (nct:password)
    If this variable is read-only (config: false) in the
  ...
  def _get_priv_protocol(self):
    """
    Getter method for priv_protocol, mapped from YANG variable /system/tables/access_control/users/user/snmpv3/priv_protocol (snmpv3-priv-protocol)
...
AES256
  ...
  def _set_priv_protocol(self, v, load=False):
    """
    Setter method for priv_protocol, mapped from YANG variable /system/tables/access_control/users/user/snmpv3/priv_protocol (snmpv3-priv-protocol)
    If this variable is read-only (config: false) in the
...
AES256
  ...
  def _get_priv_password(self):
    """
    Getter method for priv_password, mapped from YANG variable /system/tables/access_control/users/user/snmpv3/priv_password (nct:password)
  ...
  def _set_priv_password(self, v, load=False):
    """
    Setter method for priv_password, mapped from YANG variable /system/tables/access_control/users/user/snmpv3/priv_password (nct:password)
    If this variable is read-only (config: false) in the
