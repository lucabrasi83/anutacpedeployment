...
class auth_priorities(PybindBase):
  ...
  from YANG module controller - based on the path /system/tables/access-control/auth-priorities. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'system', u'tables', u'access-control', u'auth-priorities']

  def _get_auth_priority(self):
    """
    Getter method for auth_priority, mapped from YANG variable /system/tables/access_control/auth_priorities/auth_priority (list)
    """
    return self.__auth_priority
      
  def _set_auth_priority(self, v, load=False):
    """
    Setter method for auth_priority, mapped from YANG variable /system/tables/access_control/auth_priorities/auth_priority (list)
