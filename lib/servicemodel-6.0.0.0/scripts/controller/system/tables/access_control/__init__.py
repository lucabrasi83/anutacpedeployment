...
class access_control(PybindBase):
  ...
  from YANG module controller - based on the path /system/tables/access-control. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'system', u'tables', u'access-control']

  def _get_roles(self):
    """
    Getter method for roles, mapped from YANG variable /system/tables/access_control/roles (container)
    """
    return self.__roles
      
  def _set_roles(self, v, load=False):
    """
    Setter method for roles, mapped from YANG variable /system/tables/access_control/roles (container)
  ...
  def _get_auth_priorities(self):
    """
    Getter method for auth_priorities, mapped from YANG variable /system/tables/access_control/auth_priorities (container)
    """
    return self.__auth_priorities
      
  def _set_auth_priorities(self, v, load=False):
    """
    Setter method for auth_priorities, mapped from YANG variable /system/tables/access_control/auth_priorities (container)
    If this variable is read-only (config: false) in the
  ...
  def _get_users(self):
    """
    Getter method for users, mapped from YANG variable /system/tables/access_control/users (container)
    """
    return self.__users
      
  def _set_users(self, v, load=False):
    """
    Setter method for users, mapped from YANG variable /system/tables/access_control/users (container)
    If this variable is read-only (config: false) in the
  ...
  def _get_ldaps(self):
    """
    Getter method for ldaps, mapped from YANG variable /system/tables/access_control/ldaps (container)
    """
    return self.__ldaps
      
  def _set_ldaps(self, v, load=False):
    """
    Setter method for ldaps, mapped from YANG variable /system/tables/access_control/ldaps (container)
    If this variable is read-only (config: false) in the
  ...
  def _get_tacacs(self):
    """
    Getter method for tacacs, mapped from YANG variable /system/tables/access_control/tacacs (container)
    """
    return self.__tacacs
      
  def _set_tacacs(self, v, load=False):
    """
    Setter method for tacacs, mapped from YANG variable /system/tables/access_control/tacacs (container)
    If this variable is read-only (config: false) in the
  ...
  def _get_active_directories(self):
    """
    Getter method for active_directories, mapped from YANG variable /system/tables/access_control/active_directories (container)
    """
    return self.__active_directories
      
  def _set_active_directories(self, v, load=False):
    """
    Setter method for active_directories, mapped from YANG variable /system/tables/access_control/active_directories (container)
    If this variable is read-only (config: false) in the
  ...
  def _get_ownership_cascades(self):
    """
    Getter method for ownership_cascades, mapped from YANG variable /system/tables/access_control/ownership_cascades (container)
...
Platform is going to check this configuration when it needs to assign an owner and no explicit 'cascade' option is specified in the user/api payloads.
  ...
  def _set_ownership_cascades(self, v, load=False):
    """
    Setter method for ownership_cascades, mapped from YANG variable /system/tables/access_control/ownership_cascades (container)
    If this variable is read-only (config: false) in the
