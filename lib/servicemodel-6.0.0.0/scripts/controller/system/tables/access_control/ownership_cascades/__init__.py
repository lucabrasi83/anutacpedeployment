...
class ownership_cascades(PybindBase):
  ...
  from YANG module controller - based on the path /system/tables/access-control/ownership-cascades. Each member element of
...
Platform is going to check this configuration when it needs to assign an owner and no explicit 'cascade' option is specified in the user/api payloads.
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'system', u'tables', u'access-control', u'ownership-cascades']

  def _get_schema_path(self):
    """
    Getter method for schema_path, mapped from YANG variable /system/tables/access_control/ownership_cascades/schema_path (string)
  ...
  def _set_schema_path(self, v, load=False):
    """
    Setter method for schema_path, mapped from YANG variable /system/tables/access_control/ownership_cascades/schema_path (string)
