...
class ldap(PybindBase):
  ...
  from YANG module controller - based on the path /system/tables/ldaps/ldap. Each member element of
  the container is represented as a class variable - with a specific
  YANG type.
  """
  __slots__ = ('_pybind_generated_by', '_netconf_operation_type', '_path_helper', '_yang_name', '_extmethods', '_module_name', '_namespace','__url','__tenant_id','__manager_dn','__user_search_filter','__user_search_base','__group_search_filter','__group_search_base','__group_role_attribute','__user_lastname_attribute','__user_firstname_attribute','__sync_freq_in_hours','__last_sync_req_time','__manager_password',)
  ...
  def __init__(self, *args, **kwargs):
    ...
    self.__manager_password = YANGDynClass(base=RestrictedClassType(base_type=unicode, restriction_dict={'length': [u'1..80']}), is_leaf=True, yang_name="manager-password", module_name="controller", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='http://anutanetworks.com/controller', defining_module='controller', yang_type='ndt:password', is_config=True)
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'system', u'tables', u'ldaps', u'ldap']

  def _get_url(self):
    """
    Getter method for url, mapped from YANG variable /system/tables/ldaps/ldap/url (string)
  ...
  def _set_url(self, v, load=False):
    """
    Setter method for url, mapped from YANG variable /system/tables/ldaps/ldap/url (string)
  ...
  def _get_tenant_id(self):
    """
    Getter method for tenant_id, mapped from YANG variable /system/tables/ldaps/ldap/tenant_id (leafref)
  ...
  def _set_tenant_id(self, v, load=False):
    """
    Setter method for tenant_id, mapped from YANG variable /system/tables/ldaps/ldap/tenant_id (leafref)
    If this variable is read-only (config: false) in the
  ...
  def _get_manager_dn(self):
    """
    Getter method for manager_dn, mapped from YANG variable /system/tables/ldaps/ldap/manager_dn (string)
  ...
  def _set_manager_dn(self, v, load=False):
    """
    Setter method for manager_dn, mapped from YANG variable /system/tables/ldaps/ldap/manager_dn (string)
    If this variable is read-only (config: false) in the
  ...
  def _get_user_search_filter(self):
    """
    Getter method for user_search_filter, mapped from YANG variable /system/tables/ldaps/ldap/user_search_filter (string)
  ...
  def _set_user_search_filter(self, v, load=False):
    """
    Setter method for user_search_filter, mapped from YANG variable /system/tables/ldaps/ldap/user_search_filter (string)
    If this variable is read-only (config: false) in the
  ...
  def _get_user_search_base(self):
    """
    Getter method for user_search_base, mapped from YANG variable /system/tables/ldaps/ldap/user_search_base (string)
  ...
  def _set_user_search_base(self, v, load=False):
    """
    Setter method for user_search_base, mapped from YANG variable /system/tables/ldaps/ldap/user_search_base (string)
    If this variable is read-only (config: false) in the
  ...
  def _get_group_search_filter(self):
    """
    Getter method for group_search_filter, mapped from YANG variable /system/tables/ldaps/ldap/group_search_filter (string)
  ...
  def _set_group_search_filter(self, v, load=False):
    """
    Setter method for group_search_filter, mapped from YANG variable /system/tables/ldaps/ldap/group_search_filter (string)
    If this variable is read-only (config: false) in the
  ...
  def _get_group_search_base(self):
    """
    Getter method for group_search_base, mapped from YANG variable /system/tables/ldaps/ldap/group_search_base (string)
  ...
  def _set_group_search_base(self, v, load=False):
    """
    Setter method for group_search_base, mapped from YANG variable /system/tables/ldaps/ldap/group_search_base (string)
    If this variable is read-only (config: false) in the
  ...
  def _get_group_role_attribute(self):
    """
    Getter method for group_role_attribute, mapped from YANG variable /system/tables/ldaps/ldap/group_role_attribute (string)
  ...
  def _set_group_role_attribute(self, v, load=False):
    """
    Setter method for group_role_attribute, mapped from YANG variable /system/tables/ldaps/ldap/group_role_attribute (string)
    If this variable is read-only (config: false) in the
  ...
  def _get_user_lastname_attribute(self):
    """
    Getter method for user_lastname_attribute, mapped from YANG variable /system/tables/ldaps/ldap/user_lastname_attribute (string)
  ...
  def _set_user_lastname_attribute(self, v, load=False):
    """
    Setter method for user_lastname_attribute, mapped from YANG variable /system/tables/ldaps/ldap/user_lastname_attribute (string)
    If this variable is read-only (config: false) in the
  ...
  def _get_user_firstname_attribute(self):
    """
    Getter method for user_firstname_attribute, mapped from YANG variable /system/tables/ldaps/ldap/user_firstname_attribute (string)
  ...
  def _set_user_firstname_attribute(self, v, load=False):
    """
    Setter method for user_firstname_attribute, mapped from YANG variable /system/tables/ldaps/ldap/user_firstname_attribute (string)
    If this variable is read-only (config: false) in the
  ...
  def _get_sync_freq_in_hours(self):
    """
    Getter method for sync_freq_in_hours, mapped from YANG variable /system/tables/ldaps/ldap/sync_freq_in_hours (int32)
  ...
  def _set_sync_freq_in_hours(self, v, load=False):
    """
    Setter method for sync_freq_in_hours, mapped from YANG variable /system/tables/ldaps/ldap/sync_freq_in_hours (int32)
    If this variable is read-only (config: false) in the
  ...
  def _get_last_sync_req_time(self):
    """
    Getter method for last_sync_req_time, mapped from YANG variable /system/tables/ldaps/ldap/last_sync_req_time (uint32)
  ...
  def _set_last_sync_req_time(self, v, load=False):
    """
    Setter method for last_sync_req_time, mapped from YANG variable /system/tables/ldaps/ldap/last_sync_req_time (uint32)
    If this variable is read-only (config: false) in the
  ...
  def _get_manager_password(self):
    """
    Getter method for manager_password, mapped from YANG variable /system/tables/ldaps/ldap/manager_password (ndt:password)
  ...
  def _set_manager_password(self, v, load=False):
    """
    Setter method for manager_password, mapped from YANG variable /system/tables/ldaps/ldap/manager_password (ndt:password)
    If this variable is read-only (config: false) in the
    ...
    try:
      if isEmpty(v):
        return
      t = YANGDynClass(v,base=RestrictedClassType(base_type=unicode, restriction_dict={'length': [u'1..80']}), is_leaf=True, yang_name="manager-password", module_name="controller", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='http://anutanetworks.com/controller', defining_module='controller', yang_type='ndt:password', is_config=True)
    except (TypeError, ValueError):
      raise ValueError({
          'error-string': """manager_password must be of a type compatible with ndt:password""",
          'defined-type': "ndt:password",
          'generated-type': """YANGDynClass(base=RestrictedClassType(base_type=unicode, restriction_dict={'length': [u'1..80']}), is_leaf=True, yang_name="manager-password", module_name="controller", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='http://anutanetworks.com/controller', defining_module='controller', yang_type='ndt:password', is_config=True)""",
        })
  ...
  _pyangbind_elements = collections.OrderedDict([('url', url), ('tenant_id', tenant_id), ('manager_dn', manager_dn), ('user_search_filter', user_search_filter), ('user_search_base', user_search_base), ('group_search_filter', group_search_filter), ('group_search_base', group_search_base), ('group_role_attribute', group_role_attribute), ('user_lastname_attribute', user_lastname_attribute), ('user_firstname_attribute', user_firstname_attribute), ('sync_freq_in_hours', sync_freq_in_hours), ('last_sync_req_time', last_sync_req_time), ('manager_password', manager_password), ])
