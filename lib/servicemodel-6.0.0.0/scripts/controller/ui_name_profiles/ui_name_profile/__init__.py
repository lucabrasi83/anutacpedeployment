...
def isEmpty(val):
    ...
    return False
import ui_name_entries
class ui_name_profile(PybindBase):
  """
  This class was auto-generated by the PythonClass plugin for PYANG
  from YANG module controller - based on the path /ui-name-profiles/ui-name-profile. Each member element of
  the container is represented as a class variable - with a specific
  YANG type.
  """
  __slots__ = ('_pybind_generated_by', '_netconf_operation_type', '_path_helper', '_yang_name', '_extmethods', '_module_name', '_namespace','__name','__ui_name_entries','__active',)

  _yang_name = 'ui-name-profile'
  ...
  def __init__(self, *args, **kwargs):
    ...
    self.__ui_name_entries = YANGDynClass(base=ui_name_entries.ui_name_entries, is_container='container', yang_name="ui-name-entries", module_name="controller", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='http://anutanetworks.com/controller', defining_module='controller', yang_type='container', is_config=True)
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'ui-name-profiles', u'ui-name-profile']

  def _get_name(self):
    """
    Getter method for name, mapped from YANG variable /ui_name_profiles/ui_name_profile/name (string)
  ...
  def _set_name(self, v, load=False):
    """
    Setter method for name, mapped from YANG variable /ui_name_profiles/ui_name_profile/name (string)
  ...
  def _get_ui_name_entries(self):
    """
    Getter method for ui_name_entries, mapped from YANG variable /ui_name_profiles/ui_name_profile/ui_name_entries (container)
    """
    return self.__ui_name_entries
      
  def _set_ui_name_entries(self, v, load=False):
    """
    Setter method for ui_name_entries, mapped from YANG variable /ui_name_profiles/ui_name_profile/ui_name_entries (container)
    If this variable is read-only (config: false) in the
    source YANG file, then _set_ui_name_entries is considered as a private
    method. Backends looking to populate this variable should
    do so via calling thisObj._set_ui_name_entries() directly.
    """
    try:
      if isEmpty(v):
        return
      t = YANGDynClass(v,base=ui_name_entries.ui_name_entries, is_container='container', yang_name="ui-name-entries", module_name="controller", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='http://anutanetworks.com/controller', defining_module='controller', yang_type='container', is_config=True)
    except (TypeError, ValueError):
      raise ValueError({
          'error-string': """ui_name_entries must be of a type compatible with container""",
          'defined-type': "container",
          'generated-type': """YANGDynClass(base=ui_name_entries.ui_name_entries, is_container='container', yang_name="ui-name-entries", module_name="controller", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='http://anutanetworks.com/controller', defining_module='controller', yang_type='container', is_config=True)""",
        })

    self.__ui_name_entries = t
    if hasattr(self, '_set'):
      self._set()

  def _unset_ui_name_entries(self):
    self.__ui_name_entries = YANGDynClass(base=ui_name_entries.ui_name_entries, is_container='container', yang_name="ui-name-entries", module_name="controller", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='http://anutanetworks.com/controller', defining_module='controller', yang_type='container', is_config=True)


  def _get_active(self):
    """
    Getter method for active, mapped from YANG variable /ui_name_profiles/ui_name_profile/active (boolean)
  ...
  def _set_active(self, v, load=False):
    """
    Setter method for active, mapped from YANG variable /ui_name_profiles/ui_name_profile/active (boolean)
    If this variable is read-only (config: false) in the
  ...
  ui_name_entries = __builtin__.property(_get_ui_name_entries, _set_ui_name_entries)
  active = __builtin__.property(_get_active, _set_active)


  _pyangbind_elements = collections.OrderedDict([('name', name), ('ui_name_entries', ui_name_entries), ('active', active), ])
