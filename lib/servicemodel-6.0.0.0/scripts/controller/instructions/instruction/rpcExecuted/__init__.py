...
def isEmpty(val):
    ...
    return False
import invoke
class rpcExecuted(PybindBase):
  """
  This class was auto-generated by the PythonClass plugin for PYANG
  from YANG module engine - based on the path /instructions/instruction/rpcExecuted. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'instructions', u'instruction', u'rpcExecuted']

  def _get_invoke(self):
    """
    Getter method for invoke, mapped from YANG variable /instructions/instruction/rpcExecuted/invoke (container)
    """
    return self.__invoke
      
  def _set_invoke(self, v, load=False):
    """
    Setter method for invoke, mapped from YANG variable /instructions/instruction/rpcExecuted/invoke (container)
