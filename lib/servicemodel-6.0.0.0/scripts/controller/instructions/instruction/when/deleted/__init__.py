...
def isEmpty(val):
    ...
    return False
import invoke
class deleted(PybindBase):
  """
  This class was auto-generated by the PythonClass plugin for PYANG
  from YANG module engine - based on the path /instructions/instruction/when/deleted. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'instructions', u'instruction', u'when', u'deleted']

  def _get_invoke(self):
    """
    Getter method for invoke, mapped from YANG variable /instructions/instruction/when/deleted/invoke (container)
    """
    return self.__invoke
      
  def _set_invoke(self, v, load=False):
    """
    Setter method for invoke, mapped from YANG variable /instructions/instruction/when/deleted/invoke (container)
