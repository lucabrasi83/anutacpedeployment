...
class input(PybindBase):
  ...
  from YANG module sciencelogic - based on the path /sciencelogic_rpc/device-discovery/input. Each member element of
  the container is represented as a class variable - with a specific
  YANG type.
  """
  __slots__ = ('_pybind_generated_by', '_netconf_operation_type', '_path_helper', '_yang_name', '_extmethods', '_module_name', '_namespace','__device_id','__cidn','__community','__collector','__source_system','__template','__device_ips',)
  ...
  def __init__(self, *args, **kwargs):
    ...
    self.__source_system = YANGDynClass(base=unicode, is_leaf=True, yang_name="source-system", module_name="sciencelogic", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=False, namespace='http://anutanetworks.com/sciencelogic', defining_module='sciencelogic', yang_type='string', is_config=True)
    ...
    self.__template = YANGDynClass(base=unicode, is_leaf=True, yang_name="template", module_name="sciencelogic", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=False, namespace='http://anutanetworks.com/sciencelogic', defining_module='sciencelogic', yang_type='string', is_config=True)
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'sciencelogic_rpc', u'device-discovery', u'input']

  def _get_device_id(self):
    """
    Getter method for device_id, mapped from YANG variable /sciencelogic_rpc/device_discovery/input/device_id (leafref)
  ...
  def _set_device_id(self, v, load=False):
    """
    Setter method for device_id, mapped from YANG variable /sciencelogic_rpc/device_discovery/input/device_id (leafref)
  ...
  def _get_cidn(self):
    """
    Getter method for cidn, mapped from YANG variable /sciencelogic_rpc/device_discovery/input/cidn (string)
  ...
  def _set_cidn(self, v, load=False):
    """
    Setter method for cidn, mapped from YANG variable /sciencelogic_rpc/device_discovery/input/cidn (string)
    If this variable is read-only (config: false) in the
  ...
  def _get_community(self):
    """
    Getter method for community, mapped from YANG variable /sciencelogic_rpc/device_discovery/input/community (string)
  ...
  def _set_community(self, v, load=False):
    """
    Setter method for community, mapped from YANG variable /sciencelogic_rpc/device_discovery/input/community (string)
    If this variable is read-only (config: false) in the
  ...
  def _get_collector(self):
    """
    Getter method for collector, mapped from YANG variable /sciencelogic_rpc/device_discovery/input/collector (string)
  ...
  def _set_collector(self, v, load=False):
    """
    Setter method for collector, mapped from YANG variable /sciencelogic_rpc/device_discovery/input/collector (string)
    If this variable is read-only (config: false) in the
  ...
  def _get_source_system(self):
    """
    Getter method for source_system, mapped from YANG variable /sciencelogic_rpc/device_discovery/input/source_system (string)

    YANG Description: string
    """
    return self.__source_system
      
  def _set_source_system(self, v, load=False):
    """
    Setter method for source_system, mapped from YANG variable /sciencelogic_rpc/device_discovery/input/source_system (string)
    If this variable is read-only (config: false) in the
    source YANG file, then _set_source_system is considered as a private
    method. Backends looking to populate this variable should
    do so via calling thisObj._set_source_system() directly.
    ...
    try:
      if isEmpty(v):
        return
      t = YANGDynClass(v,base=unicode, is_leaf=True, yang_name="source-system", module_name="sciencelogic", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=False, namespace='http://anutanetworks.com/sciencelogic', defining_module='sciencelogic', yang_type='string', is_config=True)
    except (TypeError, ValueError):
      raise ValueError({
          'error-string': """source_system must be of a type compatible with string""",
          'defined-type': "string",
          'generated-type': """YANGDynClass(base=unicode, is_leaf=True, yang_name="source-system", module_name="sciencelogic", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=False, namespace='http://anutanetworks.com/sciencelogic', defining_module='sciencelogic', yang_type='string', is_config=True)""",
        })

    self.__source_system = t
    if hasattr(self, '_set'):
      self._set()

  def _unset_source_system(self):
    self.__source_system = YANGDynClass(base=unicode, is_leaf=True, yang_name="source-system", module_name="sciencelogic", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=False, namespace='http://anutanetworks.com/sciencelogic', defining_module='sciencelogic', yang_type='string', is_config=True)


  def _get_template(self):
    """
    Getter method for template, mapped from YANG variable /sciencelogic_rpc/device_discovery/input/template (string)
  ...
  def _set_template(self, v, load=False):
    """
    Setter method for template, mapped from YANG variable /sciencelogic_rpc/device_discovery/input/template (string)
    If this variable is read-only (config: false) in the
    ...
    try:
      if isEmpty(v):
        return
      t = YANGDynClass(v,base=unicode, is_leaf=True, yang_name="template", module_name="sciencelogic", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=False, namespace='http://anutanetworks.com/sciencelogic', defining_module='sciencelogic', yang_type='string', is_config=True)
    except (TypeError, ValueError):
      raise ValueError({
          'error-string': """template must be of a type compatible with string""",
          'defined-type': "string",
          'generated-type': """YANGDynClass(base=unicode, is_leaf=True, yang_name="template", module_name="sciencelogic", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=False, namespace='http://anutanetworks.com/sciencelogic', defining_module='sciencelogic', yang_type='string', is_config=True)""",
        })
  ...
  def _get_device_ips(self):
    """
    Getter method for device_ips, mapped from YANG variable /sciencelogic_rpc/device_discovery/input/device_ips (list)
    """
    return self.__device_ips
      
  def _set_device_ips(self, v, load=False):
    """
    Setter method for device_ips, mapped from YANG variable /sciencelogic_rpc/device_discovery/input/device_ips (list)
    If this variable is read-only (config: false) in the
  ...
  source_system = __builtin__.property(_get_source_system, _set_source_system)
  template = __builtin__.property(_get_template, _set_template)
  device_ips = __builtin__.property(_get_device_ips, _set_device_ips)


  _pyangbind_elements = collections.OrderedDict([('device_id', device_id), ('cidn', cidn), ('community', community), ('collector', collector), ('source_system', source_system), ('template', template), ('device_ips', device_ips), ])
