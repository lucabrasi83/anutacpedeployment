...
def isEmpty(val):
    ...
    return False
class device_platform(PybindBase):
  """
  This class was auto-generated by the PythonClass plugin for PYANG
  from YANG module controller - based on the path /device-support/device-platforms/device-platform. Each member element of
  the container is represented as a class variable - with a specific
  YANG type.
  """
  __slots__ = ('_pybind_generated_by', '_netconf_operation_type', '_path_helper', '_yang_name', '_extmethods', '_module_name', '_namespace','__name','__os_version','__os_type','__vendor','__device_type','__device_family',)

  _yang_name = 'device-platform'
  ...
  def __init__(self, *args, **kwargs):
    ...
    self.__os_version = YANGDynClass(base=unicode, is_leaf=True, yang_name="os-version", module_name="controller", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='http://anutanetworks.com/controller', defining_module='controller', yang_type='string', is_config=True)
    self.__device_type = YANGDynClass(base=unicode, is_leaf=True, yang_name="device-type", module_name="controller", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='http://anutanetworks.com/controller', defining_module='controller', yang_type='leafref', is_config=True)
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'device-support', u'device-platforms', u'device-platform']

  def _get_name(self):
    """
    Getter method for name, mapped from YANG variable /device_support/device_platforms/device_platform/name (string)
  ...
  def _set_name(self, v, load=False):
    """
    Setter method for name, mapped from YANG variable /device_support/device_platforms/device_platform/name (string)
  ...
  def _get_os_version(self):
    """
    Getter method for os_version, mapped from YANG variable /device_support/device_platforms/device_platform/os_version (string)

    YANG Description: device operating system version
    """
    return self.__os_version
      
  def _set_os_version(self, v, load=False):
    """
    Setter method for os_version, mapped from YANG variable /device_support/device_platforms/device_platform/os_version (string)
    If this variable is read-only (config: false) in the
    ...
    try:
      if isEmpty(v):
        return
      t = YANGDynClass(v,base=unicode, is_leaf=True, yang_name="os-version", module_name="controller", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='http://anutanetworks.com/controller', defining_module='controller', yang_type='string', is_config=True)
    except (TypeError, ValueError):
      raise ValueError({
          'error-string': """os_version must be of a type compatible with string""",
          'defined-type': "string",
          'generated-type': """YANGDynClass(base=unicode, is_leaf=True, yang_name="os-version", module_name="controller", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='http://anutanetworks.com/controller', defining_module='controller', yang_type='string', is_config=True)""",
        })
  ...
  def _get_os_type(self):
    """
    Getter method for os_type, mapped from YANG variable /device_support/device_platforms/device_platform/os_type (leafref)
  ...
  def _set_os_type(self, v, load=False):
    """
    Setter method for os_type, mapped from YANG variable /device_support/device_platforms/device_platform/os_type (leafref)
    If this variable is read-only (config: false) in the
  ...
  def _get_vendor(self):
    """
    Getter method for vendor, mapped from YANG variable /device_support/device_platforms/device_platform/vendor (leafref)
  ...
  def _set_vendor(self, v, load=False):
    """
    Setter method for vendor, mapped from YANG variable /device_support/device_platforms/device_platform/vendor (leafref)
    If this variable is read-only (config: false) in the
  ...
  def _get_device_type(self):
    """
    Getter method for device_type, mapped from YANG variable /device_support/device_platforms/device_platform/device_type (leafref)
  ...
  def _set_device_type(self, v, load=False):
    """
    Setter method for device_type, mapped from YANG variable /device_support/device_platforms/device_platform/device_type (leafref)
    If this variable is read-only (config: false) in the
    ...
    try:
      if isEmpty(v):
        return
      t = YANGDynClass(v,base=unicode, is_leaf=True, yang_name="device-type", module_name="controller", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='http://anutanetworks.com/controller', defining_module='controller', yang_type='leafref', is_config=True)
    except (TypeError, ValueError):
      raise ValueError({
          'error-string': """device_type must be of a type compatible with leafref""",
          'defined-type': "leafref",
          'generated-type': """YANGDynClass(base=unicode, is_leaf=True, yang_name="device-type", module_name="controller", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='http://anutanetworks.com/controller', defining_module='controller', yang_type='leafref', is_config=True)""",
        })
  ...
  def _get_device_family(self):
    """
    Getter method for device_family, mapped from YANG variable /device_support/device_platforms/device_platform/device_family (leafref)
  ...
  def _set_device_family(self, v, load=False):
    """
    Setter method for device_family, mapped from YANG variable /device_support/device_platforms/device_platform/device_family (leafref)
    If this variable is read-only (config: false) in the
  ...
  _pyangbind_elements = collections.OrderedDict([('name', name), ('os_version', os_version), ('os_type', os_type), ('vendor', vendor), ('device_type', device_type), ('device_family', device_family), ])
