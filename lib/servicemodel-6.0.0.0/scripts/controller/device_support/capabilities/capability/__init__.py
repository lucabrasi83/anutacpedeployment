...
def isEmpty(val):
    ...
    return False
class capability(PybindBase):
  """
  This class was auto-generated by the PythonClass plugin for PYANG
  from YANG module controller - based on the path /device-support/capabilities/capability. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'device-support', u'capabilities', u'capability']

  def _get_name(self):
    """
    Getter method for name, mapped from YANG variable /device_support/capabilities/capability/name (string)

    YANG Description: Device Capability name. Can contain only AlphaNumerics, hyphen, underscore and space characters only. Max length is 64
    """
    return self.__name
      
  def _set_name(self, v, load=False):
    """
    Setter method for name, mapped from YANG variable /device_support/capabilities/capability/name (string)
  ...
  def _get_description(self):
    """
    Getter method for description, mapped from YANG variable /device_support/capabilities/capability/description (string)
  ...
  def _set_description(self, v, load=False):
    """
    Setter method for description, mapped from YANG variable /device_support/capabilities/capability/description (string)
    If this variable is read-only (config: false) in the
