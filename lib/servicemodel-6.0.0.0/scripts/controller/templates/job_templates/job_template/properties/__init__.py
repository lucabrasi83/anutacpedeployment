...
class properties(PybindBase):
  ...
  from YANG module controller - based on the path /templates/job-templates/job-template/properties. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'templates', u'job-templates', u'job-template', u'properties']

  def _get_property(self):
    """
    Getter method for property, mapped from YANG variable /templates/job_templates/job_template/properties/property (list)
    """
    return self.__property
      
  def _set_property(self, v, load=False):
    """
    Setter method for property, mapped from YANG variable /templates/job_templates/job_template/properties/property (list)
