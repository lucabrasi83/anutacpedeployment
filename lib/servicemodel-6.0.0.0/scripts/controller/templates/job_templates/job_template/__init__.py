...
def isEmpty(val):
    ...
    return False
import properties
class job_template(PybindBase):
  """
  This class was auto-generated by the PythonClass plugin for PYANG
  from YANG module controller - based on the path /templates/job-templates/job-template. Each member element of
  the container is represented as a class variable - with a specific
  YANG type.
  """
  __slots__ = ('_pybind_generated_by', '_netconf_operation_type', '_path_helper', '_yang_name', '_extmethods', '_module_name', '_namespace','__name','__description','__properties',)

  _yang_name = 'job-template'
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'templates', u'job-templates', u'job-template']

  def _get_name(self):
    """
    Getter method for name, mapped from YANG variable /templates/job_templates/job_template/name (string)
  ...
  def _set_name(self, v, load=False):
    """
    Setter method for name, mapped from YANG variable /templates/job_templates/job_template/name (string)
  ...
  def _get_description(self):
    """
    Getter method for description, mapped from YANG variable /templates/job_templates/job_template/description (string)
  ...
  def _set_description(self, v, load=False):
    """
    Setter method for description, mapped from YANG variable /templates/job_templates/job_template/description (string)
    If this variable is read-only (config: false) in the
  ...
  def _get_properties(self):
    """
    Getter method for properties, mapped from YANG variable /templates/job_templates/job_template/properties (container)
    """
    return self.__properties
      
  def _set_properties(self, v, load=False):
    """
    Setter method for properties, mapped from YANG variable /templates/job_templates/job_template/properties (container)
    If this variable is read-only (config: false) in the
  ...
  _pyangbind_elements = collections.OrderedDict([('name', name), ('description', description), ('properties', properties), ])
