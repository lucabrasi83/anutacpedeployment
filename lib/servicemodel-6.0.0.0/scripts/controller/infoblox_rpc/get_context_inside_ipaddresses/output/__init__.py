...
class output(PybindBase):
  ...
  from YANG module infoblox - based on the path /infoblox_rpc/get-context-inside-ipaddresses/output. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'infoblox_rpc', u'get-context-inside-ipaddresses', u'output']

  def _get_ip(self):
    """
    Getter method for ip, mapped from YANG variable /infoblox_rpc/get_context_inside_ipaddresses/output/ip (list)
    """
    return self.__ip
      
  def _set_ip(self, v, load=False):
    """
    Setter method for ip, mapped from YANG variable /infoblox_rpc/get_context_inside_ipaddresses/output/ip (list)
