...
class input(PybindBase):
  ...
  from YANG module infoblox - based on the path /infoblox_rpc/delete-network-container/input. Each member element of
  the container is represented as a class variable - with a specific
  YANG type.
  """
  __slots__ = ('_pybind_generated_by', '_netconf_operation_type', '_path_helper', '_yang_name', '_extmethods', '_module_name', '_namespace','__device_id','__container_id',)
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'infoblox_rpc', u'delete-network-container', u'input']

  def _get_device_id(self):
    """
    Getter method for device_id, mapped from YANG variable /infoblox_rpc/delete_network_container/input/device_id (leafref)
  ...
  def _set_device_id(self, v, load=False):
    """
    Setter method for device_id, mapped from YANG variable /infoblox_rpc/delete_network_container/input/device_id (leafref)
  ...
  def _get_container_id(self):
    """
    Getter method for container_id, mapped from YANG variable /infoblox_rpc/delete_network_container/input/container_id (string)
  ...
  def _set_container_id(self, v, load=False):
    """
    Setter method for container_id, mapped from YANG variable /infoblox_rpc/delete_network_container/input/container_id (string)
    If this variable is read-only (config: false) in the
  ...
  _pyangbind_elements = collections.OrderedDict([('device_id', device_id), ('container_id', container_id), ])
