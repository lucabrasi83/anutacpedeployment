...
class output(PybindBase):
  ...
  from YANG module infoblox - based on the path /infoblox_rpc/delete-network-container/output. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'infoblox_rpc', u'delete-network-container', u'output']

  def _get_success(self):
    """
    Getter method for success, mapped from YANG variable /infoblox_rpc/delete_network_container/output/success (boolean)
  ...
  def _set_success(self, v, load=False):
    """
    Setter method for success, mapped from YANG variable /infoblox_rpc/delete_network_container/output/success (boolean)
