...
class a_record(PybindBase):
  ...
  from YANG module infoblox - based on the path /infoblox_rpc/get-specific-a-record-by-ip-address/output/a-records/a-record. Each member element of
  the container is represented as a class variable - with a specific
  YANG type.
  """
  __slots__ = ('_pybind_generated_by', '_netconf_operation_type', '_path_helper', '_yang_name', '_extmethods', '_module_name', '_namespace','__container_id','__name','__view','__ipv4addr','__extra_attributes',)
  ...
  def __init__(self, *args, **kwargs):
    ...
    self.__ipv4addr = YANGDynClass(base=unicode, is_leaf=True, yang_name="ipv4addr", module_name="infoblox", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=False, namespace='http://anutanetworks.com/infoblox', defining_module='infoblox', yang_type='string', is_config=True)
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'infoblox_rpc', u'get-specific-a-record-by-ip-address', u'output', u'a-records', u'a-record']

  def _get_container_id(self):
    """
    Getter method for container_id, mapped from YANG variable /infoblox_rpc/get_specific_a_record_by_ip_address/output/a_records/a_record/container_id (string)
  ...
  def _set_container_id(self, v, load=False):
    """
    Setter method for container_id, mapped from YANG variable /infoblox_rpc/get_specific_a_record_by_ip_address/output/a_records/a_record/container_id (string)
  ...
  def _get_name(self):
    """
    Getter method for name, mapped from YANG variable /infoblox_rpc/get_specific_a_record_by_ip_address/output/a_records/a_record/name (string)
  ...
  def _set_name(self, v, load=False):
    """
    Setter method for name, mapped from YANG variable /infoblox_rpc/get_specific_a_record_by_ip_address/output/a_records/a_record/name (string)
    If this variable is read-only (config: false) in the
  ...
  def _get_view(self):
    """
    Getter method for view, mapped from YANG variable /infoblox_rpc/get_specific_a_record_by_ip_address/output/a_records/a_record/view (string)
  ...
  def _set_view(self, v, load=False):
    """
    Setter method for view, mapped from YANG variable /infoblox_rpc/get_specific_a_record_by_ip_address/output/a_records/a_record/view (string)
    If this variable is read-only (config: false) in the
  ...
  def _get_ipv4addr(self):
    """
    Getter method for ipv4addr, mapped from YANG variable /infoblox_rpc/get_specific_a_record_by_ip_address/output/a_records/a_record/ipv4addr (string)

    YANG Description: string
    """
    return self.__ipv4addr
      
  def _set_ipv4addr(self, v, load=False):
    """
    Setter method for ipv4addr, mapped from YANG variable /infoblox_rpc/get_specific_a_record_by_ip_address/output/a_records/a_record/ipv4addr (string)
    If this variable is read-only (config: false) in the
    source YANG file, then _set_ipv4addr is considered as a private
    method. Backends looking to populate this variable should
    do so via calling thisObj._set_ipv4addr() directly.
    ...
    try:
      if isEmpty(v):
        return
      t = YANGDynClass(v,base=unicode, is_leaf=True, yang_name="ipv4addr", module_name="infoblox", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=False, namespace='http://anutanetworks.com/infoblox', defining_module='infoblox', yang_type='string', is_config=True)
    except (TypeError, ValueError):
      raise ValueError({
          'error-string': """ipv4addr must be of a type compatible with string""",
          'defined-type': "string",
          'generated-type': """YANGDynClass(base=unicode, is_leaf=True, yang_name="ipv4addr", module_name="infoblox", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=False, namespace='http://anutanetworks.com/infoblox', defining_module='infoblox', yang_type='string', is_config=True)""",
        })
  ...
  def _unset_ipv4addr(self):
    self.__ipv4addr = YANGDynClass(base=unicode, is_leaf=True, yang_name="ipv4addr", module_name="infoblox", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=False, namespace='http://anutanetworks.com/infoblox', defining_module='infoblox', yang_type='string', is_config=True)


  def _get_extra_attributes(self):
    """
    Getter method for extra_attributes, mapped from YANG variable /infoblox_rpc/get_specific_a_record_by_ip_address/output/a_records/a_record/extra_attributes (container)
    """
    return self.__extra_attributes
      
  def _set_extra_attributes(self, v, load=False):
    """
    Setter method for extra_attributes, mapped from YANG variable /infoblox_rpc/get_specific_a_record_by_ip_address/output/a_records/a_record/extra_attributes (container)
    If this variable is read-only (config: false) in the
  ...
  ipv4addr = __builtin__.property(_get_ipv4addr, _set_ipv4addr)
  extra_attributes = __builtin__.property(_get_extra_attributes, _set_extra_attributes)


  _pyangbind_elements = collections.OrderedDict([('container_id', container_id), ('name', name), ('view', view), ('ipv4addr', ipv4addr), ('extra_attributes', extra_attributes), ])
