...
class input(PybindBase):
  ...
  from YANG module infoblox - based on the path /infoblox_rpc/get-specific-a-record-by-ip-address/input. Each member element of
  the container is represented as a class variable - with a specific
  YANG type.
  """
  __slots__ = ('_pybind_generated_by', '_netconf_operation_type', '_path_helper', '_yang_name', '_extmethods', '_module_name', '_namespace','__device_id','__ip_address',)
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'infoblox_rpc', u'get-specific-a-record-by-ip-address', u'input']

  def _get_device_id(self):
    """
    Getter method for device_id, mapped from YANG variable /infoblox_rpc/get_specific_a_record_by_ip_address/input/device_id (leafref)
  ...
  def _set_device_id(self, v, load=False):
    """
    Setter method for device_id, mapped from YANG variable /infoblox_rpc/get_specific_a_record_by_ip_address/input/device_id (leafref)
  ...
  def _get_ip_address(self):
    """
    Getter method for ip_address, mapped from YANG variable /infoblox_rpc/get_specific_a_record_by_ip_address/input/ip_address (string)
  ...
  def _set_ip_address(self, v, load=False):
    """
    Setter method for ip_address, mapped from YANG variable /infoblox_rpc/get_specific_a_record_by_ip_address/input/ip_address (string)
    If this variable is read-only (config: false) in the
  ...
  _pyangbind_elements = collections.OrderedDict([('device_id', device_id), ('ip_address', ip_address), ])
