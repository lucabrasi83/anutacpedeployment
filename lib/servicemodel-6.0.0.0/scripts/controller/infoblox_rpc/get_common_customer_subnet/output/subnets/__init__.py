...
class subnets(PybindBase):
  ...
  from YANG module infoblox - based on the path /infoblox_rpc/get-common-customer-subnet/output/subnets. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'infoblox_rpc', u'get-common-customer-subnet', u'output', u'subnets']

  def _get_subnet(self):
    """
    Getter method for subnet, mapped from YANG variable /infoblox_rpc/get_common_customer_subnet/output/subnets/subnet (container)
    """
    return self.__subnet
      
  def _set_subnet(self, v, load=False):
    """
    Setter method for subnet, mapped from YANG variable /infoblox_rpc/get_common_customer_subnet/output/subnets/subnet (container)
