...
class output(PybindBase):
  ...
  from YANG module infoblox - based on the path /infoblox_rpc/get-all-hosts/output. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'infoblox_rpc', u'get-all-hosts', u'output']

  def _get_hosts(self):
    """
    Getter method for hosts, mapped from YANG variable /infoblox_rpc/get_all_hosts/output/hosts (list)
    """
    return self.__hosts
      
  def _set_hosts(self, v, load=False):
    """
    Setter method for hosts, mapped from YANG variable /infoblox_rpc/get_all_hosts/output/hosts (list)
