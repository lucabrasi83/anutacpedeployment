...
class extra_attributes(PybindBase):
  ...
  from YANG module infoblox - based on the path /infoblox_rpc/get-all-hosts/output/hosts/host/extra-attributes. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'infoblox_rpc', u'get-all-hosts', u'output', u'hosts', u'host', u'extra-attributes']

  def _get_attributes(self):
    """
    Getter method for attributes, mapped from YANG variable /infoblox_rpc/get_all_hosts/output/hosts/host/extra_attributes/attributes (list)
    """
    return self.__attributes
      
  def _set_attributes(self, v, load=False):
    """
    Setter method for attributes, mapped from YANG variable /infoblox_rpc/get_all_hosts/output/hosts/host/extra_attributes/attributes (list)
