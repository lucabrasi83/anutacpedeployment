...
class output(PybindBase):
  ...
  from YANG module infoblox - based on the path /infoblox_rpc/get-customer-specific-network-container/output. Each member element of
  the container is represented as a class variable - with a specific
  YANG type.
  """
  __slots__ = ('_pybind_generated_by', '_netconf_operation_type', '_path_helper', '_yang_name', '_extmethods', '_module_name', '_namespace','__success','__subnets',)
  ...
  def __init__(self, *args, **kwargs):
    ...
    self.__subnets = YANGDynClass(base=YANGListType(False,subnets.subnets, yang_name="subnets", module_name="infoblox", parent=self, is_container='list', user_ordered=False, path_helper=self._path_helper, yang_keys='False'), is_container='list', yang_name="subnets", module_name="infoblox", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=False, namespace='http://anutanetworks.com/infoblox', defining_module='infoblox', yang_type='list', is_config=True)
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'infoblox_rpc', u'get-customer-specific-network-container', u'output']

  def _get_success(self):
    """
    Getter method for success, mapped from YANG variable /infoblox_rpc/get_customer_specific_network_container/output/success (boolean)
  ...
  def _set_success(self, v, load=False):
    """
    Setter method for success, mapped from YANG variable /infoblox_rpc/get_customer_specific_network_container/output/success (boolean)
  ...
  def _get_subnets(self):
    """
    Getter method for subnets, mapped from YANG variable /infoblox_rpc/get_customer_specific_network_container/output/subnets (list)
    """
    return self.__subnets
      
  def _set_subnets(self, v, load=False):
    """
    Setter method for subnets, mapped from YANG variable /infoblox_rpc/get_customer_specific_network_container/output/subnets (list)
    If this variable is read-only (config: false) in the
  ...
  _pyangbind_elements = collections.OrderedDict([('success', success), ('subnets', subnets), ])
