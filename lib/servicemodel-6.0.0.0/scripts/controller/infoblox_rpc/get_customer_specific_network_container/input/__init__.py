...
class input(PybindBase):
  ...
  from YANG module infoblox - based on the path /infoblox_rpc/get-customer-specific-network-container/input. Each member element of
  the container is represented as a class variable - with a specific
  YANG type.
  """
  __slots__ = ('_pybind_generated_by', '_netconf_operation_type', '_path_helper', '_yang_name', '_extmethods', '_module_name', '_namespace','__device_id','__cidn','__network_type',)
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'infoblox_rpc', u'get-customer-specific-network-container', u'input']

  def _get_device_id(self):
    """
    Getter method for device_id, mapped from YANG variable /infoblox_rpc/get_customer_specific_network_container/input/device_id (leafref)
  ...
  def _set_device_id(self, v, load=False):
    """
    Setter method for device_id, mapped from YANG variable /infoblox_rpc/get_customer_specific_network_container/input/device_id (leafref)
  ...
  def _get_cidn(self):
    """
    Getter method for cidn, mapped from YANG variable /infoblox_rpc/get_customer_specific_network_container/input/cidn (string)
  ...
  def _set_cidn(self, v, load=False):
    """
    Setter method for cidn, mapped from YANG variable /infoblox_rpc/get_customer_specific_network_container/input/cidn (string)
    If this variable is read-only (config: false) in the
  ...
  def _get_network_type(self):
    """
    Getter method for network_type, mapped from YANG variable /infoblox_rpc/get_customer_specific_network_container/input/network_type (string)
  ...
  def _set_network_type(self, v, load=False):
    """
    Setter method for network_type, mapped from YANG variable /infoblox_rpc/get_customer_specific_network_container/input/network_type (string)
    If this variable is read-only (config: false) in the
  ...
  _pyangbind_elements = collections.OrderedDict([('device_id', device_id), ('cidn', cidn), ('network_type', network_type), ])
