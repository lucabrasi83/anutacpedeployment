...
class output(PybindBase):
  ...
  from YANG module infoblox - based on the path /infoblox_rpc/get-network-list-with-ext-attributes/output. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'infoblox_rpc', u'get-network-list-with-ext-attributes', u'output']

  def _get_networks(self):
    """
    Getter method for networks, mapped from YANG variable /infoblox_rpc/get_network_list_with_ext_attributes/output/networks (list)
    """
    return self.__networks
      
  def _set_networks(self, v, load=False):
    """
    Setter method for networks, mapped from YANG variable /infoblox_rpc/get_network_list_with_ext_attributes/output/networks (list)
