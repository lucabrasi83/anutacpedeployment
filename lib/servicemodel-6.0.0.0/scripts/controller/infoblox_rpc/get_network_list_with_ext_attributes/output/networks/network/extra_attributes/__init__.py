...
class extra_attributes(PybindBase):
  ...
  from YANG module infoblox - based on the path /infoblox_rpc/get-network-list-with-ext-attributes/output/networks/network/extra-attributes. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'infoblox_rpc', u'get-network-list-with-ext-attributes', u'output', u'networks', u'network', u'extra-attributes']

  def _get_attributes(self):
    """
    Getter method for attributes, mapped from YANG variable /infoblox_rpc/get_network_list_with_ext_attributes/output/networks/network/extra_attributes/attributes (list)
    """
    return self.__attributes
      
  def _set_attributes(self, v, load=False):
    """
    Setter method for attributes, mapped from YANG variable /infoblox_rpc/get_network_list_with_ext_attributes/output/networks/network/extra_attributes/attributes (list)
