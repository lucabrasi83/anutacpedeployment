...
class input(PybindBase):
  ...
  from YANG module infoblox - based on the path /infoblox_rpc/get-ipaddresses-from-network/input. Each member element of
  the container is represented as a class variable - with a specific
  YANG type.
  """
  __slots__ = ('_pybind_generated_by', '_netconf_operation_type', '_path_helper', '_yang_name', '_extmethods', '_module_name', '_namespace','__device_id','__network_to_ip','__num_of_ips',)
  ...
  def __init__(self, *args, **kwargs):
    ...
    self.__network_to_ip = YANGDynClass(base=unicode, is_leaf=True, yang_name="network-to-ip", module_name="infoblox", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=False, namespace='http://anutanetworks.com/infoblox', defining_module='infoblox', yang_type='string', is_config=True)
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'infoblox_rpc', u'get-ipaddresses-from-network', u'input']

  def _get_device_id(self):
    """
    Getter method for device_id, mapped from YANG variable /infoblox_rpc/get_ipaddresses_from_network/input/device_id (leafref)
  ...
  def _set_device_id(self, v, load=False):
    """
    Setter method for device_id, mapped from YANG variable /infoblox_rpc/get_ipaddresses_from_network/input/device_id (leafref)
  ...
  def _get_network_to_ip(self):
    """
    Getter method for network_to_ip, mapped from YANG variable /infoblox_rpc/get_ipaddresses_from_network/input/network_to_ip (string)

    YANG Description: string
    """
    return self.__network_to_ip
      
  def _set_network_to_ip(self, v, load=False):
    """
    Setter method for network_to_ip, mapped from YANG variable /infoblox_rpc/get_ipaddresses_from_network/input/network_to_ip (string)
    If this variable is read-only (config: false) in the
    source YANG file, then _set_network_to_ip is considered as a private
    method. Backends looking to populate this variable should
    do so via calling thisObj._set_network_to_ip() directly.
    ...
    try:
      if isEmpty(v):
        return
      t = YANGDynClass(v,base=unicode, is_leaf=True, yang_name="network-to-ip", module_name="infoblox", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=False, namespace='http://anutanetworks.com/infoblox', defining_module='infoblox', yang_type='string', is_config=True)
    except (TypeError, ValueError):
      raise ValueError({
          'error-string': """network_to_ip must be of a type compatible with string""",
          'defined-type': "string",
          'generated-type': """YANGDynClass(base=unicode, is_leaf=True, yang_name="network-to-ip", module_name="infoblox", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=False, namespace='http://anutanetworks.com/infoblox', defining_module='infoblox', yang_type='string', is_config=True)""",
        })

    self.__network_to_ip = t
    if hasattr(self, '_set'):
      self._set()

  def _unset_network_to_ip(self):
    self.__network_to_ip = YANGDynClass(base=unicode, is_leaf=True, yang_name="network-to-ip", module_name="infoblox", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=False, namespace='http://anutanetworks.com/infoblox', defining_module='infoblox', yang_type='string', is_config=True)


  def _get_num_of_ips(self):
    """
    Getter method for num_of_ips, mapped from YANG variable /infoblox_rpc/get_ipaddresses_from_network/input/num_of_ips (uint32)
  ...
  def _set_num_of_ips(self, v, load=False):
    """
    Setter method for num_of_ips, mapped from YANG variable /infoblox_rpc/get_ipaddresses_from_network/input/num_of_ips (uint32)
    If this variable is read-only (config: false) in the
  ...
  network_to_ip = __builtin__.property(_get_network_to_ip, _set_network_to_ip)
  num_of_ips = __builtin__.property(_get_num_of_ips, _set_num_of_ips)


  _pyangbind_elements = collections.OrderedDict([('device_id', device_id), ('network_to_ip', network_to_ip), ('num_of_ips', num_of_ips), ])
