...
class input(PybindBase):
  ...
  from YANG module infoblox - based on the path /infoblox_rpc/get-all-reservations/input. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'infoblox_rpc', u'get-all-reservations', u'input']

  def _get_device_id(self):
    """
    Getter method for device_id, mapped from YANG variable /infoblox_rpc/get_all_reservations/input/device_id (leafref)
  ...
  def _set_device_id(self, v, load=False):
    """
    Setter method for device_id, mapped from YANG variable /infoblox_rpc/get_all_reservations/input/device_id (leafref)
