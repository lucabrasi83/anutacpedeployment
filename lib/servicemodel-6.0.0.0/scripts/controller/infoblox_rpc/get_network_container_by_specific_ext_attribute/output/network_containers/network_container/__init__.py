...
class network_container(PybindBase):
  ...
  from YANG module infoblox - based on the path /infoblox_rpc/get-network-container-by-specific-ext-attribute/output/network-containers/network-container. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'infoblox_rpc', u'get-network-container-by-specific-ext-attribute', u'output', u'network-containers', u'network-container']

  def _get_container_id(self):
    """
    Getter method for container_id, mapped from YANG variable /infoblox_rpc/get_network_container_by_specific_ext_attribute/output/network_containers/network_container/container_id (string)
  ...
  def _set_container_id(self, v, load=False):
    """
    Setter method for container_id, mapped from YANG variable /infoblox_rpc/get_network_container_by_specific_ext_attribute/output/network_containers/network_container/container_id (string)
  ...
  def _get_network_id(self):
    """
    Getter method for network_id, mapped from YANG variable /infoblox_rpc/get_network_container_by_specific_ext_attribute/output/network_containers/network_container/network_id (string)
  ...
  def _set_network_id(self, v, load=False):
    """
    Setter method for network_id, mapped from YANG variable /infoblox_rpc/get_network_container_by_specific_ext_attribute/output/network_containers/network_container/network_id (string)
    If this variable is read-only (config: false) in the
  ...
  def _get_network_view(self):
    """
    Getter method for network_view, mapped from YANG variable /infoblox_rpc/get_network_container_by_specific_ext_attribute/output/network_containers/network_container/network_view (string)
  ...
  def _set_network_view(self, v, load=False):
    """
    Setter method for network_view, mapped from YANG variable /infoblox_rpc/get_network_container_by_specific_ext_attribute/output/network_containers/network_container/network_view (string)
    If this variable is read-only (config: false) in the
  ...
  def _get_comment(self):
    """
    Getter method for comment, mapped from YANG variable /infoblox_rpc/get_network_container_by_specific_ext_attribute/output/network_containers/network_container/comment (string)
  ...
  def _set_comment(self, v, load=False):
    """
    Setter method for comment, mapped from YANG variable /infoblox_rpc/get_network_container_by_specific_ext_attribute/output/network_containers/network_container/comment (string)
    If this variable is read-only (config: false) in the
  ...
  def _get_extra_attributes(self):
    """
    Getter method for extra_attributes, mapped from YANG variable /infoblox_rpc/get_network_container_by_specific_ext_attribute/output/network_containers/network_container/extra_attributes (container)
    """
    return self.__extra_attributes
      
  def _set_extra_attributes(self, v, load=False):
    """
    Setter method for extra_attributes, mapped from YANG variable /infoblox_rpc/get_network_container_by_specific_ext_attribute/output/network_containers/network_container/extra_attributes (container)
    If this variable is read-only (config: false) in the
