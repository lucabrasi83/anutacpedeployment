...
class output(PybindBase):
  ...
  from YANG module infoblox - based on the path /infoblox_rpc/delete-a-record/output. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'infoblox_rpc', u'delete-a-record', u'output']

  def _get_success(self):
    """
    Getter method for success, mapped from YANG variable /infoblox_rpc/delete_a_record/output/success (boolean)
  ...
  def _set_success(self, v, load=False):
    """
    Setter method for success, mapped from YANG variable /infoblox_rpc/delete_a_record/output/success (boolean)
