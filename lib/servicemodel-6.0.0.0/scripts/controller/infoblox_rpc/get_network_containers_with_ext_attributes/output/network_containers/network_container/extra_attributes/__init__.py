...
class extra_attributes(PybindBase):
  ...
  from YANG module infoblox - based on the path /infoblox_rpc/get-network-containers-with-ext-attributes/output/network-containers/network-container/extra-attributes. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'infoblox_rpc', u'get-network-containers-with-ext-attributes', u'output', u'network-containers', u'network-container', u'extra-attributes']

  def _get_attributes(self):
    """
    Getter method for attributes, mapped from YANG variable /infoblox_rpc/get_network_containers_with_ext_attributes/output/network_containers/network_container/extra_attributes/attributes (list)
    """
    return self.__attributes
      
  def _set_attributes(self, v, load=False):
    """
    Setter method for attributes, mapped from YANG variable /infoblox_rpc/get_network_containers_with_ext_attributes/output/network_containers/network_container/extra_attributes/attributes (list)
