...
class input(PybindBase):
  ...
  from YANG module infoblox - based on the path /infoblox_rpc/get-network-containers-with-ext-attributes/input. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'infoblox_rpc', u'get-network-containers-with-ext-attributes', u'input']

  def _get_device_id(self):
    """
    Getter method for device_id, mapped from YANG variable /infoblox_rpc/get_network_containers_with_ext_attributes/input/device_id (leafref)
  ...
  def _set_device_id(self, v, load=False):
    """
    Setter method for device_id, mapped from YANG variable /infoblox_rpc/get_network_containers_with_ext_attributes/input/device_id (leafref)
