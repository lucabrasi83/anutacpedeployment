...
class output(PybindBase):
  ...
  from YANG module infoblox - based on the path /infoblox_rpc/add-network-to-infoblox/output. Each member element of
  the container is represented as a class variable - with a specific
  YANG type.
  """
  __slots__ = ('_pybind_generated_by', '_netconf_operation_type', '_path_helper', '_yang_name', '_extmethods', '_module_name', '_namespace','__success','__container_id',)
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'infoblox_rpc', u'add-network-to-infoblox', u'output']

  def _get_success(self):
    """
    Getter method for success, mapped from YANG variable /infoblox_rpc/add_network_to_infoblox/output/success (boolean)
  ...
  def _set_success(self, v, load=False):
    """
    Setter method for success, mapped from YANG variable /infoblox_rpc/add_network_to_infoblox/output/success (boolean)
  ...
  def _get_container_id(self):
    """
    Getter method for container_id, mapped from YANG variable /infoblox_rpc/add_network_to_infoblox/output/container_id (string)
  ...
  def _set_container_id(self, v, load=False):
    """
    Setter method for container_id, mapped from YANG variable /infoblox_rpc/add_network_to_infoblox/output/container_id (string)
    If this variable is read-only (config: false) in the
  ...
  _pyangbind_elements = collections.OrderedDict([('success', success), ('container_id', container_id), ])
