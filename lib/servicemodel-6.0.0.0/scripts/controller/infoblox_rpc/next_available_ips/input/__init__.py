...
class input(PybindBase):
  ...
  from YANG module infoblox - based on the path /infoblox_rpc/next-available-ips/input. Each member element of
  the container is represented as a class variable - with a specific
  YANG type.
  """
  __slots__ = ('_pybind_generated_by', '_netconf_operation_type', '_path_helper', '_yang_name', '_extmethods', '_module_name', '_namespace','__device_id','__container_id','__network_id','__num_of_ips',)
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'infoblox_rpc', u'next-available-ips', u'input']

  def _get_device_id(self):
    """
    Getter method for device_id, mapped from YANG variable /infoblox_rpc/next_available_ips/input/device_id (leafref)
  ...
  def _set_device_id(self, v, load=False):
    """
    Setter method for device_id, mapped from YANG variable /infoblox_rpc/next_available_ips/input/device_id (leafref)
  ...
  def _get_container_id(self):
    """
    Getter method for container_id, mapped from YANG variable /infoblox_rpc/next_available_ips/input/container_id (string)
  ...
  def _set_container_id(self, v, load=False):
    """
    Setter method for container_id, mapped from YANG variable /infoblox_rpc/next_available_ips/input/container_id (string)
    If this variable is read-only (config: false) in the
  ...
  def _get_network_id(self):
    """
    Getter method for network_id, mapped from YANG variable /infoblox_rpc/next_available_ips/input/network_id (string)
  ...
  def _set_network_id(self, v, load=False):
    """
    Setter method for network_id, mapped from YANG variable /infoblox_rpc/next_available_ips/input/network_id (string)
    If this variable is read-only (config: false) in the
  ...
  def _get_num_of_ips(self):
    """
    Getter method for num_of_ips, mapped from YANG variable /infoblox_rpc/next_available_ips/input/num_of_ips (uint32)
  ...
  def _set_num_of_ips(self, v, load=False):
    """
    Setter method for num_of_ips, mapped from YANG variable /infoblox_rpc/next_available_ips/input/num_of_ips (uint32)
    If this variable is read-only (config: false) in the
  ...
  _pyangbind_elements = collections.OrderedDict([('device_id', device_id), ('container_id', container_id), ('network_id', network_id), ('num_of_ips', num_of_ips), ])
