...
class output(PybindBase):
  ...
  from YANG module infoblox - based on the path /infoblox_rpc/get-network-by-type-and-cidn/output. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'infoblox_rpc', u'get-network-by-type-and-cidn', u'output']

  def _get_network(self):
    """
    Getter method for network, mapped from YANG variable /infoblox_rpc/get_network_by_type_and_cidn/output/network (string)
  ...
  def _set_network(self, v, load=False):
    """
    Setter method for network, mapped from YANG variable /infoblox_rpc/get_network_by_type_and_cidn/output/network (string)
