...
class host(PybindBase):
  ...
  from YANG module infoblox - based on the path /infoblox_rpc/get-specific-host-by-ip-address/output/hosts/host. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'infoblox_rpc', u'get-specific-host-by-ip-address', u'output', u'hosts', u'host']

  def _get_container_id(self):
    """
    Getter method for container_id, mapped from YANG variable /infoblox_rpc/get_specific_host_by_ip_address/output/hosts/host/container_id (string)
  ...
  def _set_container_id(self, v, load=False):
    """
    Setter method for container_id, mapped from YANG variable /infoblox_rpc/get_specific_host_by_ip_address/output/hosts/host/container_id (string)
  ...
  def _get_name(self):
    """
    Getter method for name, mapped from YANG variable /infoblox_rpc/get_specific_host_by_ip_address/output/hosts/host/name (string)
  ...
  def _set_name(self, v, load=False):
    """
    Setter method for name, mapped from YANG variable /infoblox_rpc/get_specific_host_by_ip_address/output/hosts/host/name (string)
    If this variable is read-only (config: false) in the
  ...
  def _get_view(self):
    """
    Getter method for view, mapped from YANG variable /infoblox_rpc/get_specific_host_by_ip_address/output/hosts/host/view (string)
  ...
  def _set_view(self, v, load=False):
    """
    Setter method for view, mapped from YANG variable /infoblox_rpc/get_specific_host_by_ip_address/output/hosts/host/view (string)
    If this variable is read-only (config: false) in the
  ...
  def _get_extra_attributes(self):
    """
    Getter method for extra_attributes, mapped from YANG variable /infoblox_rpc/get_specific_host_by_ip_address/output/hosts/host/extra_attributes (container)
    """
    return self.__extra_attributes
      
  def _set_extra_attributes(self, v, load=False):
    """
    Setter method for extra_attributes, mapped from YANG variable /infoblox_rpc/get_specific_host_by_ip_address/output/hosts/host/extra_attributes (container)
    If this variable is read-only (config: false) in the
  ...
  def _get_ipv4addrs(self):
    """
    Getter method for ipv4addrs, mapped from YANG variable /infoblox_rpc/get_specific_host_by_ip_address/output/hosts/host/ipv4addrs (list)
    """
    return self.__ipv4addrs
      
  def _set_ipv4addrs(self, v, load=False):
    """
    Setter method for ipv4addrs, mapped from YANG variable /infoblox_rpc/get_specific_host_by_ip_address/output/hosts/host/ipv4addrs (list)
    If this variable is read-only (config: false) in the
