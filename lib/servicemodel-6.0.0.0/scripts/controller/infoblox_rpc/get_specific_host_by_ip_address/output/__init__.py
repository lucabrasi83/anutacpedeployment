...
class output(PybindBase):
  ...
  from YANG module infoblox - based on the path /infoblox_rpc/get-specific-host-by-ip-address/output. Each member element of
  the container is represented as a class variable - with a specific
  YANG type.
  """
  __slots__ = ('_pybind_generated_by', '_netconf_operation_type', '_path_helper', '_yang_name', '_extmethods', '_module_name', '_namespace','__hosts',)
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'infoblox_rpc', u'get-specific-host-by-ip-address', u'output']

  def _get_hosts(self):
    """
    Getter method for hosts, mapped from YANG variable /infoblox_rpc/get_specific_host_by_ip_address/output/hosts (list)
    """
    return self.__hosts
      
  def _set_hosts(self, v, load=False):
    """
    Setter method for hosts, mapped from YANG variable /infoblox_rpc/get_specific_host_by_ip_address/output/hosts (list)
  ...
  _pyangbind_elements = collections.OrderedDict([('hosts', hosts), ])
