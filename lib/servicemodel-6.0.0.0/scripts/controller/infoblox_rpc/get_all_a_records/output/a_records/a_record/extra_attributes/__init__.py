...
class extra_attributes(PybindBase):
  ...
  from YANG module infoblox - based on the path /infoblox_rpc/get-all-a-records/output/a-records/a-record/extra-attributes. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'infoblox_rpc', u'get-all-a-records', u'output', u'a-records', u'a-record', u'extra-attributes']

  def _get_attributes(self):
    """
    Getter method for attributes, mapped from YANG variable /infoblox_rpc/get_all_a_records/output/a_records/a_record/extra_attributes/attributes (list)
    """
    return self.__attributes
      
  def _set_attributes(self, v, load=False):
    """
    Setter method for attributes, mapped from YANG variable /infoblox_rpc/get_all_a_records/output/a_records/a_record/extra_attributes/attributes (list)
