...
class network(PybindBase):
  ...
  from YANG module infoblox - based on the path /infoblox_rpc/get-network-list/output/networks/network. Each member element of
  the container is represented as a class variable - with a specific
  YANG type.
  """
  __slots__ = ('_pybind_generated_by', '_netconf_operation_type', '_path_helper', '_yang_name', '_extmethods', '_module_name', '_namespace','__container_id','__network','__network_view','__comment',)
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'infoblox_rpc', u'get-network-list', u'output', u'networks', u'network']

  def _get_container_id(self):
    """
    Getter method for container_id, mapped from YANG variable /infoblox_rpc/get_network_list/output/networks/network/container_id (string)
  ...
  def _set_container_id(self, v, load=False):
    """
    Setter method for container_id, mapped from YANG variable /infoblox_rpc/get_network_list/output/networks/network/container_id (string)
  ...
  def _get_network(self):
    """
    Getter method for network, mapped from YANG variable /infoblox_rpc/get_network_list/output/networks/network/network (string)
  ...
  def _set_network(self, v, load=False):
    """
    Setter method for network, mapped from YANG variable /infoblox_rpc/get_network_list/output/networks/network/network (string)
    If this variable is read-only (config: false) in the
  ...
  def _get_network_view(self):
    """
    Getter method for network_view, mapped from YANG variable /infoblox_rpc/get_network_list/output/networks/network/network_view (string)
  ...
  def _set_network_view(self, v, load=False):
    """
    Setter method for network_view, mapped from YANG variable /infoblox_rpc/get_network_list/output/networks/network/network_view (string)
    If this variable is read-only (config: false) in the
  ...
  def _get_comment(self):
    """
    Getter method for comment, mapped from YANG variable /infoblox_rpc/get_network_list/output/networks/network/comment (string)
  ...
  def _set_comment(self, v, load=False):
    """
    Setter method for comment, mapped from YANG variable /infoblox_rpc/get_network_list/output/networks/network/comment (string)
    If this variable is read-only (config: false) in the
  ...
  _pyangbind_elements = collections.OrderedDict([('container_id', container_id), ('network', network), ('network_view', network_view), ('comment', comment), ])
