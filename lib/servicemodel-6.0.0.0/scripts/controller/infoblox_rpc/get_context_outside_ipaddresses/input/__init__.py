...
class input(PybindBase):
  ...
  from YANG module infoblox - based on the path /infoblox_rpc/get-context-outside-ipaddresses/input. Each member element of
  the container is represented as a class variable - with a specific
  YANG type.
  """
  __slots__ = ('_pybind_generated_by', '_netconf_operation_type', '_path_helper', '_yang_name', '_extmethods', '_module_name', '_namespace','__device_id','__cidn','__num_of_ips',)
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'infoblox_rpc', u'get-context-outside-ipaddresses', u'input']

  def _get_device_id(self):
    """
    Getter method for device_id, mapped from YANG variable /infoblox_rpc/get_context_outside_ipaddresses/input/device_id (leafref)
  ...
  def _set_device_id(self, v, load=False):
    """
    Setter method for device_id, mapped from YANG variable /infoblox_rpc/get_context_outside_ipaddresses/input/device_id (leafref)
  ...
  def _get_cidn(self):
    """
    Getter method for cidn, mapped from YANG variable /infoblox_rpc/get_context_outside_ipaddresses/input/cidn (string)
  ...
  def _set_cidn(self, v, load=False):
    """
    Setter method for cidn, mapped from YANG variable /infoblox_rpc/get_context_outside_ipaddresses/input/cidn (string)
    If this variable is read-only (config: false) in the
  ...
  def _get_num_of_ips(self):
    """
    Getter method for num_of_ips, mapped from YANG variable /infoblox_rpc/get_context_outside_ipaddresses/input/num_of_ips (uint32)
  ...
  def _set_num_of_ips(self, v, load=False):
    """
    Setter method for num_of_ips, mapped from YANG variable /infoblox_rpc/get_context_outside_ipaddresses/input/num_of_ips (uint32)
    If this variable is read-only (config: false) in the
  ...
  _pyangbind_elements = collections.OrderedDict([('device_id', device_id), ('cidn', cidn), ('num_of_ips', num_of_ips), ])
