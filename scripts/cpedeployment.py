...
import managed_cpe_services.customer.access_lists.delete_access_list.delete_access_list
import managed_cpe_services.customer.object_groups.delete_object_group.delete_object_group
...
import managed_cpe_services.customer.single_cpe_site.single_cpe_site_services.cpe.ospfs.router_ospf.redistribute.redistribute_on_ospf.interface.interface
...
import managed_cpe_services.customer.dual_cpe_site.dual_cpe_site_services.cpe_primary.ospfs.router_ospf.redistribute.redistribute_on_ospf.interface.interface
...
import managed_cpe_services.customer.dual_cpe_site.dual_cpe_site_services.cpe_secondary.ospfs.router_ospf.redistribute.redistribute_on_ospf.interface.interface
...
import managed_cpe_services.customer.single_cpe_dual_wan_site.single_cpe_dual_wan_site_services.cpe.ospfs.router_ospf.redistribute.redistribute_on_ospf.interface.interface
...
import managed_cpe_services.customer.single_cpe_site.single_cpe_site_services.cpe.eigrp.router_eigrp.redistribute.redistribute_on_eigrp.interface.interface
...
import managed_cpe_services.customer.dual_cpe_site.dual_cpe_site_services.cpe_primary.eigrp.router_eigrp.redistribute.redistribute_on_eigrp.interface.interface
...
import managed_cpe_services.customer.dual_cpe_site.dual_cpe_site_services.cpe_secondary.eigrp.router_eigrp.redistribute.redistribute_on_eigrp.interface.interface
...
import managed_cpe_services.customer.dual_cpe_dual_wan_site.dual_cpe_dual_wan_site_services.cpe_primary.eigrp.router_eigrp.redistribute.redistribute_on_eigrp.interface.interface
...
import managed_cpe_services.customer.dual_cpe_dual_wan_site.dual_cpe_dual_wan_site_services.cpe_secondary.eigrp.router_eigrp.redistribute.redistribute_on_eigrp.interface.interface
...
import managed_cpe_services.customer.single_cpe_dual_wan_site.single_cpe_dual_wan_site_services.cpe.eigrp.router_eigrp.redistribute.redistribute_on_eigrp.interface.interface
...
import managed_cpe_services.customer.triple_cpe_site.triple_cpe_site_services.cpe_primary.eigrp.router_eigrp.redistribute.redistribute_on_eigrp.interface.interface
...
import managed_cpe_services.customer.triple_cpe_site.triple_cpe_site_services.cpe_secondary.eigrp.router_eigrp.redistribute.redistribute_on_eigrp.interface.interface
...
import managed_cpe_services.customer.triple_cpe_site.triple_cpe_site_services.cpe_tertiary.eigrp.router_eigrp.redistribute.redistribute_on_eigrp.interface.interface
...
import managed_cpe_services.customer.analytics.analytics
...
class CPEDEPLOYMENTService(yang.AbstractYangServiceHandler):
    ...
    def __init__(self):
        ...
        self.handler_map = {
            ...
            'cpedeployment:managed-cpe-services/customer/single-cpe-site/single-cpe-site-services/cpe/ospfs/router-ospf/redistribute/redistribute-on-ospf/interface': managed_cpe_services.customer.single_cpe_site.single_cpe_site_services.cpe.ospfs.router_ospf.redistribute.redistribute_on_ospf.interface.interface.Interface.getInstance(),
            ...
            'cpedeployment:managed-cpe-services/customer/dual-cpe-site/dual-cpe-site-services/cpe-primary/ospfs/router-ospf/redistribute/redistribute-on-ospf/interface': managed_cpe_services.customer.dual_cpe_site.dual_cpe_site_services.cpe_primary.ospfs.router_ospf.redistribute.redistribute_on_ospf.interface.interface.Interface.getInstance(),
            ...
            'cpedeployment:managed-cpe-services/customer/dual-cpe-site/dual-cpe-site-services/cpe-secondary/ospfs/router-ospf/redistribute/redistribute-on-ospf/interface': managed_cpe_services.customer.dual_cpe_site.dual_cpe_site_services.cpe_secondary.ospfs.router_ospf.redistribute.redistribute_on_ospf.interface.interface.Interface.getInstance(),
            ...
            'cpedeployment:managed-cpe-services/customer/single-cpe-dual-wan-site/single-cpe-dual-wan-site-services/cpe/ospfs/router-ospf/redistribute/redistribute-on-ospf/interface': managed_cpe_services.customer.single_cpe_dual_wan_site.single_cpe_dual_wan_site_services.cpe.ospfs.router_ospf.redistribute.redistribute_on_ospf.interface.interface.Interface.getInstance(),
            ...
            'cpedeployment:managed-cpe-services/customer/access-lists/delete-access-list': managed_cpe_services.customer.access_lists.delete_access_list.delete_access_list.DeleteAccessList.getInstance(),
            'cpedeployment:managed-cpe-services/customer/object-groups/delete-object-group': managed_cpe_services.customer.object_groups.delete_object_group.delete_object_group.DeleteObjectGroup.getInstance(),
            ...
            'cpedeployment:managed-cpe-services/customer/dual-cpe-dual-wan-site/dual-cpe-dual-wan-site-services/cpe-primary/ospfs/router-ospf/redistribute/redistribute-on-ospf/interface': managed_cpe_services.customer.dual_cpe_dual_wan_site.dual_cpe_dual_wan_site_services.cpe_primary.ospfs.router_ospf.redistribute.redistribute_on_ospf.interface.interface.Interface.getInstance(),
            ...
            'cpedeployment:managed-cpe-services/customer/dual-cpe-dual-wan-site/dual-cpe-dual-wan-site-services/cpe-secondary/ospfs/router-ospf/redistribute/redistribute-on-ospf/interface': managed_cpe_services.customer.dual_cpe_dual_wan_site.dual_cpe_dual_wan_site_services.cpe_secondary.ospfs.router_ospf.redistribute.redistribute_on_ospf.interface.interface.Interface.getInstance(),
            ...
            'cpedeployment:managed-cpe-services/customer/triple-cpe-site/triple-cpe-site-services/cpe-primary/ospfs/router-ospf/redistribute/redistribute-on-ospf/interface': managed_cpe_services.customer.triple_cpe_site.triple_cpe_site_services.cpe_primary.ospfs.router_ospf.redistribute.redistribute_on_ospf.interface.interface.Interface.getInstance(),
            ...
            'cpedeployment:managed-cpe-services/customer/triple-cpe-site/triple-cpe-site-services/cpe-secondary/ospfs/router-ospf/redistribute/redistribute-on-ospf/interface': managed_cpe_services.customer.triple_cpe_site.triple_cpe_site_services.cpe_secondary.ospfs.router_ospf.redistribute.redistribute_on_ospf.interface.interface.Interface.getInstance(),
            ...
            'cpedeployment:managed-cpe-services/customer/triple-cpe-site/triple-cpe-site-services/cpe-tertiary/ospfs/router-ospf/redistribute/redistribute-on-ospf/interface': managed_cpe_services.customer.triple_cpe_site.triple_cpe_site_services.cpe_tertiary.ospfs.router_ospf.redistribute.redistribute_on_ospf.interface.interface.Interface.getInstance(),
            ...
            'cpedeployment:managed-cpe-services/customer/single-cpe-site/single-cpe-site-services/cpe/eigrp/router-eigrp/redistribute/redistribute-on-eigrp/interface': managed_cpe_services.customer.single_cpe_site.single_cpe_site_services.cpe.eigrp.router_eigrp.redistribute.redistribute_on_eigrp.interface.interface.Interface.getInstance(),
            ...
            'cpedeployment:managed-cpe-services/customer/dual-cpe-site/dual-cpe-site-services/cpe-primary/eigrp/router-eigrp/redistribute/redistribute-on-eigrp/interface': managed_cpe_services.customer.dual_cpe_site.dual_cpe_site_services.cpe_primary.eigrp.router_eigrp.redistribute.redistribute_on_eigrp.interface.interface.Interface.getInstance(),
            ...
            'cpedeployment:managed-cpe-services/customer/dual-cpe-site/dual-cpe-site-services/cpe-secondary/eigrp/router-eigrp/redistribute/redistribute-on-eigrp/interface': managed_cpe_services.customer.dual_cpe_site.dual_cpe_site_services.cpe_secondary.eigrp.router_eigrp.redistribute.redistribute_on_eigrp.interface.interface.Interface.getInstance(),
            ...
            'cpedeployment:managed-cpe-services/customer/dual-cpe-dual-wan-site/dual-cpe-dual-wan-site-services/cpe-primary/eigrp/router-eigrp/redistribute/redistribute-on-eigrp/interface': managed_cpe_services.customer.dual_cpe_dual_wan_site.dual_cpe_dual_wan_site_services.cpe_primary.eigrp.router_eigrp.redistribute.redistribute_on_eigrp.interface.interface.Interface.getInstance(),
            ...
            'cpedeployment:managed-cpe-services/customer/dual-cpe-dual-wan-site/dual-cpe-dual-wan-site-services/cpe-secondary/eigrp/router-eigrp/redistribute/redistribute-on-eigrp/interface': managed_cpe_services.customer.dual_cpe_dual_wan_site.dual_cpe_dual_wan_site_services.cpe_secondary.eigrp.router_eigrp.redistribute.redistribute_on_eigrp.interface.interface.Interface.getInstance(),
            ...
            'cpedeployment:managed-cpe-services/customer/single-cpe-dual-wan-site/single-cpe-dual-wan-site-services/cpe/eigrp/router-eigrp/redistribute/redistribute-on-eigrp/interface': managed_cpe_services.customer.single_cpe_dual_wan_site.single_cpe_dual_wan_site_services.cpe.eigrp.router_eigrp.redistribute.redistribute_on_eigrp.interface.interface.Interface.getInstance(),
            ...
            'cpedeployment:managed-cpe-services/customer/triple-cpe-site/triple-cpe-site-services/cpe-primary/eigrp/router-eigrp/redistribute/redistribute-on-eigrp/interface': managed_cpe_services.customer.triple_cpe_site.triple_cpe_site_services.cpe_primary.eigrp.router_eigrp.redistribute.redistribute_on_eigrp.interface.interface.Interface.getInstance(),
            ...
            'cpedeployment:managed-cpe-services/customer/triple-cpe-site/triple-cpe-site-services/cpe-secondary/eigrp/router-eigrp/redistribute/redistribute-on-eigrp/interface': managed_cpe_services.customer.triple_cpe_site.triple_cpe_site_services.cpe_secondary.eigrp.router_eigrp.redistribute.redistribute_on_eigrp.interface.interface.Interface.getInstance(),
            ...
            'cpedeployment:managed-cpe-services/customer/triple-cpe-site/triple-cpe-site-services/cpe-tertiary/eigrp/router-eigrp/redistribute/redistribute-on-eigrp/interface': managed_cpe_services.customer.triple_cpe_site.triple_cpe_site_services.cpe_tertiary.eigrp.router_eigrp.redistribute.redistribute_on_eigrp.interface.interface.Interface.getInstance(),
            ...
            'cpedeployment:managed-cpe-services/customer/analytics': managed_cpe_services.customer.analytics.analytics.Analytics.getInstance(),
        }
    ...
    def unregister(self):
        ...
        for xpath in self.handler_map.keys():
            handler = self.handler_map[xpath]
            yang.unregisterServiceHandler(xpath, False)
