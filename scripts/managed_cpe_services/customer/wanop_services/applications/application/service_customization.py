...
class ServiceDataCustomization:
    ...
    def process_service_device_bindings(smodelctx, sdata, dev, **kwargs):
      ...
      if modify:
        ...
        cpedeployment.cpedeployment_grouping_lib.application_def_customization.grouping_create_application_def_application(smodelctx, sdata, dev, **kwargs)

        from servicemodel.device_abs_lib import device_wanop_applications
        if inputdict['application_name'] is not None:
          device_wanop_applications.wanop_applications.wanop_application().create(sdata, dev, fill_map_devices_device_wanop_applications_wanop_application(inputdict), addref=False)
    ...
    def process_service_update_data(smodelctx, sdata, **kwargs):
      ...
      if modify:
        ...
        if up_map_devices_device_wanop_applications_wanop_application[1] == 'key-delete-create' or up_map_devices_device_wanop_applications_wanop_application[1] == 'key-delete':
          device_wanop_applications.wanop_applications.wanop_application().delete(sdata, dev, pinputdict)
        if up_map_devices_device_wanop_applications_wanop_application[1] == 'key-delete-create' or up_map_devices_device_wanop_applications_wanop_application[1] == 'key-create':
          device_wanop_applications.wanop_applications.wanop_application().create(sdata, dev, up_map_devices_device_wanop_applications_wanop_application[0], addref=up_map_devices_device_wanop_applications_wanop_application)
        if up_map_devices_device_wanop_applications_wanop_application[1] == 'key-unchanged':
          device_wanop_applications.wanop_applications.wanop_application().update(sdata, dev, fill_map_devices_device_wanop_applications_wanop_application(inputdict))
        import cpedeployment.cpedeployment_grouping_lib.application_def_customization
        cpedeployment.cpedeployment_grouping_lib.application_def_customization.grouping_update_application_def_application(smodelctx, sdata, **kwargs)
    ...
    def process_service_delete_data(smodelctx, sdata, **kwargs):
      ...
      if modify:
        ...
        if dev is None or (isinstance(dev, list) and len(dev) == 0):
          return
        import cpedeployment.cpedeployment_grouping_lib.application_def_customization
        cpedeployment.cpedeployment_grouping_lib.application_def_customization.grouping_delete_application_def_application(smodelctx, sdata, **kwargs)
