...
class Type3Site(yang.AbstractYangServiceHandler):
    _instance = None
    ...
    def create(self, id, sdata):
        ...
        config = getCurrentObjectConfig(id, sdata, 'type3_site')
    ...
    def update(self, id, sdata):
        #Fetch Local Config Object
        config = getCurrentObjectConfig(id, sdata, 'type3_site')
        pconfig = getPreviousObjectConfig(id, sdata, 'type3_site')
        opaque_args = self.opaque_args
        ...
        pinputdict['dual_cpe_sites'] = pconfig.get_field_value('dual_cpe_sites')
        dev = []
    ...
    @staticmethod
    def getInstance():
        if(Type3Site._instance == None):
            Type3Site._instance = Type3Site()
        return Type3Site._instance
