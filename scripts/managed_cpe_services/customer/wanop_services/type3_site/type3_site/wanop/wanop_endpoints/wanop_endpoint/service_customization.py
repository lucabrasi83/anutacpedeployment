...
class ServiceDataCustomization:
    ...
    def process_service_device_bindings(smodelctx, sdata, dev, **kwargs):
      ...
      if modify:
        ...
        import cpedeployment.cpedeployment_grouping_lib.wanop_ic_local_props_type3_customization
        interface_ip,mask_length = cpedeployment.cpedeployment_grouping_lib.wanop_ic_local_props_type3_customization.grouping_create_wanop_ic_local_props_type3_wanop_endpoint(smodelctx, sdata, dev, **kwargs)
    ...
    def process_service_update_data(smodelctx, sdata, **kwargs):
      ...
      if modify:
        ...
        dev = kwargs['dev']
        import cpedeployment.cpedeployment_grouping_lib.wanop_ic_local_props_type3_customization
        cpedeployment.cpedeployment_grouping_lib.wanop_ic_local_props_type3_customization.grouping_update_wanop_ic_local_props_type3_wanop_endpoint(smodelctx, sdata, **kwargs)
    ...
    def process_service_delete_data(smodelctx, sdata, **kwargs):
      ...
      if modify:
        ...
        import cpedeployment.cpedeployment_grouping_lib.wanop_ic_local_props_type3_customization
        cpedeployment.cpedeployment_grouping_lib.wanop_ic_local_props_type3_customization.grouping_delete_wanop_ic_local_props_type3_wanop_endpoint(smodelctx, sdata, **kwargs)
