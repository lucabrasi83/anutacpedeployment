...
class UpdateDomainLabel(yang.AbstractYangServiceHandler):
    _instance = None
    ...
    def create(self, id, sdata):
        ...
        config = getCurrentObjectConfig(id, sdata, 'update_domain_label')
        ...
        inputdict['domain_label_name'] = config.get_field_value('domain_label_name')#leaf domain-label-name type False
        inputdict['domain'] = config.get_field_value('domain')#leaf domain type False
    ...
    def update(self, id, sdata):
        #Fetch Local Config Object
        config = getCurrentObjectConfig(id, sdata, 'update_domain_label')
        pconfig = getPreviousObjectConfig(id, sdata, 'update_domain_label')
        opaque_args = self.opaque_args
        ...
        pinputdict['domain_label_name'] = pconfig.get_field_value('domain_label_name')
        pinputdict['domain'] = pconfig.get_field_value('domain')
    ...
    @staticmethod
    def getInstance():
        if(UpdateDomainLabel._instance == None):
            UpdateDomainLabel._instance = UpdateDomainLabel()
        return UpdateDomainLabel._instance
