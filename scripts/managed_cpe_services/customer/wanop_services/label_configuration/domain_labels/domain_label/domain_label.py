...
class DomainLabel(yang.AbstractYangServiceHandler):
    _instance = None
    ...
    def create(self, id, sdata):
        ...
        config = getCurrentObjectConfig(id, sdata, 'domain_label')
    ...
    def update(self, id, sdata):
        #Fetch Local Config Object
        config = getCurrentObjectConfig(id, sdata, 'domain_label')
        pconfig = getPreviousObjectConfig(id, sdata, 'domain_label')
        opaque_args = self.opaque_args
    ...
    @staticmethod
    def getInstance():
        if(DomainLabel._instance == None):
            DomainLabel._instance = DomainLabel()
        return DomainLabel._instance
