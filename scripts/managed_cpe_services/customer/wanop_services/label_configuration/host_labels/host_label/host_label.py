...
class HostLabel(yang.AbstractYangServiceHandler):
    _instance = None
    ...
    def create(self, id, sdata):
        ...
        config = getCurrentObjectConfig(id, sdata, 'host_label')
    ...
    def update(self, id, sdata):
        #Fetch Local Config Object
        config = getCurrentObjectConfig(id, sdata, 'host_label')
        pconfig = getPreviousObjectConfig(id, sdata, 'host_label')
        opaque_args = self.opaque_args
    ...
    @staticmethod
    def getInstance():
        if(HostLabel._instance == None):
            HostLabel._instance = HostLabel()
        return HostLabel._instance
