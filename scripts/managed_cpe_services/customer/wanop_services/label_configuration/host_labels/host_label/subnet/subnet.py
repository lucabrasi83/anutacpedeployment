...
class Subnet(yang.AbstractYangServiceHandler):
    _instance = None
    ...
    def create(self, id, sdata):
        ...
        config = getCurrentObjectConfig(id, sdata, 'subnet')
        ...
        inputkeydict['managed_cpe_services_customer_wanop_services_label_configuration_host_labels_host_label_host_label_name'] = sdata.getRcPath().split('/')[-2].split('=')[1]
    ...
    def update(self, id, sdata):
        #Fetch Local Config Object
        config = getCurrentObjectConfig(id, sdata, 'subnet')
        pconfig = getPreviousObjectConfig(id, sdata, 'subnet')
        opaque_args = self.opaque_args
    ...
    @staticmethod
    def getInstance():
        if(Subnet._instance == None):
            Subnet._instance = Subnet()
        return Subnet._instance
