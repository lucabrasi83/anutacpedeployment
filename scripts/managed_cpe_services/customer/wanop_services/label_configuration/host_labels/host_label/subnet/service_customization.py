...
class ServiceDataCustomization:
    ...
    def process_service_device_bindings(smodelctx, sdata, dev, **kwargs):
      ...
      if modify:
        ...
        cpedeployment.cpedeployment_grouping_lib.label_configuration_def_customization.grouping_create_label_configuration_def_host_labels_host_label_subnet(smodelctx, sdata, dev, **kwargs)
        ...
        if inputdict['managed_cpe_services_customer_wanop_services_label_configuration_host_labels_host_label_host_label_name'] is not None:
          device_label_configuration.label_configuration.host_label.subnet().create(sdata, dev, inputdict['managed_cpe_services_customer_wanop_services_label_configuration_host_labels_host_label_host_label_name'], fill_map_devices_device_label_configuration_host_label_subnet(inputdict), addref=True)
    ...
    def process_service_update_data(smodelctx, sdata, **kwargs):
      ...
      if modify:
        ...
        if up_map_devices_device_label_configuration_host_label_subnet[1] == 'key-delete-create' or up_map_devices_device_label_configuration_host_label_subnet[1] == 'key-delete':
          device_label_configuration.label_configuration.host_label.subnet().delete(sdata, dev, inputdict['managed_cpe_services_customer_wanop_services_label_configuration_host_labels_host_label_host_label_name'], pinputdict)
        if up_map_devices_device_label_configuration_host_label_subnet[1] == 'key-delete-create' or up_map_devices_device_label_configuration_host_label_subnet[1] == 'key-create':
          device_label_configuration.label_configuration.host_label.subnet().create(sdata, dev, inputdict['managed_cpe_services_customer_wanop_services_label_configuration_host_labels_host_label_host_label_name'], up_map_devices_device_label_configuration_host_label_subnet[0], addref=up_map_devices_device_label_configuration_host_label_subnet)
        if up_map_devices_device_label_configuration_host_label_subnet[1] == 'key-unchanged':
          device_label_configuration.label_configuration.host_label.subnet().update(sdata, dev, inputdict['managed_cpe_services_customer_wanop_services_label_configuration_host_labels_host_label_host_label_name'], fill_map_devices_device_label_configuration_host_label_subnet(inputdict))
        import cpedeployment.cpedeployment_grouping_lib.label_configuration_def_customization
        cpedeployment.cpedeployment_grouping_lib.label_configuration_def_customization.grouping_update_label_configuration_def_host_labels_host_label_subnet(smodelctx, sdata, **kwargs)
    ...
    def process_service_delete_data(smodelctx, sdata, **kwargs):
      ...
      if modify:
        ...
        if dev is None or (isinstance(dev, list) and len(dev) == 0):
          return
        import cpedeployment.cpedeployment_grouping_lib.label_configuration_def_customization
        cpedeployment.cpedeployment_grouping_lib.label_configuration_def_customization.grouping_delete_label_configuration_def_host_labels_host_label_subnet(smodelctx, sdata, **kwargs)

def fill_map_devices_device_label_configuration_host_label_subnet(inputdict, delete=False):
