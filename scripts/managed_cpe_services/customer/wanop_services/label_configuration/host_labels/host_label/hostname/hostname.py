...
class Hostname(yang.AbstractYangServiceHandler):
    _instance = None
    ...
    def create(self, id, sdata):
        ...
        config = getCurrentObjectConfig(id, sdata, 'hostname')
    ...
    def update(self, id, sdata):
        #Fetch Local Config Object
        config = getCurrentObjectConfig(id, sdata, 'hostname')
        pconfig = getPreviousObjectConfig(id, sdata, 'hostname')
        opaque_args = self.opaque_args
    ...
    @staticmethod
    def getInstance():
        if(Hostname._instance == None):
            Hostname._instance = Hostname()
        return Hostname._instance
