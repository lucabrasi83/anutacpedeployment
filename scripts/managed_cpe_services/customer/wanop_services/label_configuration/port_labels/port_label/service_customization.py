...
class ServiceDataCustomization:
    ...
    def process_service_device_bindings(smodelctx, sdata, dev, **kwargs):
      ...
      if modify:
        ...
        cpedeployment.cpedeployment_grouping_lib.label_configuration_def_customization.grouping_create_label_configuration_def_port_labels_port_label(smodelctx, sdata, dev, **kwargs)
        ...
        if inputdict['port_label_name'] is not None and inputdict['port'] is not None:
          device_label_configuration.label_configuration.port_label().create(sdata, dev, fill_map_devices_device_label_configuration_port_label(inputdict), addref=True)
    ...
    def process_service_update_data(smodelctx, sdata, **kwargs):
      ...
      if modify:
        ...
        import cpedeployment.cpedeployment_grouping_lib.label_configuration_def_customization
        cpedeployment.cpedeployment_grouping_lib.label_configuration_def_customization.grouping_update_label_configuration_def_port_labels_port_label(smodelctx, sdata, **kwargs)
    ...
    def process_service_delete_data(smodelctx, sdata, **kwargs):
      ...
      if modify:
        ...
        if dev is None or (isinstance(dev, list) and len(dev) == 0):
          return
        import cpedeployment.cpedeployment_grouping_lib.label_configuration_def_customization
        cpedeployment.cpedeployment_grouping_lib.label_configuration_def_customization.grouping_delete_label_configuration_def_port_labels_port_label(smodelctx, sdata, **kwargs)
