...
class PortLabel(yang.AbstractYangServiceHandler):
    _instance = None
    ...
    def create(self, id, sdata):
        ...
        config = getCurrentObjectConfig(id, sdata, 'port_label')
    ...
    def update(self, id, sdata):
        #Fetch Local Config Object
        config = getCurrentObjectConfig(id, sdata, 'port_label')
        pconfig = getPreviousObjectConfig(id, sdata, 'port_label')
        opaque_args = self.opaque_args
    ...
    @staticmethod
    def getInstance():
        if(PortLabel._instance == None):
            PortLabel._instance = PortLabel()
        return PortLabel._instance
