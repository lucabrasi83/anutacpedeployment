...
/services/managed-cpe-services/customer/wanop-services/type2-site/type2-site/wanop-primary/inpath-rules/move-rule
"""
"""
    ...
    def process_service_update_data(smodelctx, sdata, **kwargs):
      ...
      if modify:
        ...
        if up_map_devices_device_inpath_rules_move_rule[1] == 'key-unchanged':
          device_inpath_rules.inpath_rules.move_rule().update(sdata, dev, fill_map_devices_device_inpath_rules_move_rule(inputdict))
        import cpedeployment.cpedeployment_grouping_lib.inpath_rules_def_customization
