...
/services/managed-cpe-services/customer/wanop-services/type2-site/type2-site/wanop-secondary/wanop-endpoints/wanop-endpoint
"""
"""
...
class ServiceDataCustomization:
    ...
    def process_service_device_bindings(smodelctx, sdata, dev, **kwargs):
      ...
      if modify:
        ...
        if dev is None or (isinstance(dev, list) and len(dev) == 0):
          return
        import cpedeployment.cpedeployment_grouping_lib.wanop_ic_local_props_type2_customization
        interface_ip,mask_length = cpedeployment.cpedeployment_grouping_lib.wanop_ic_local_props_type2_customization.grouping_create_wanop_ic_local_props_type2_wanop_endpoint(smodelctx, sdata, dev, **kwargs)
    ...
    def process_service_update_data(smodelctx, sdata, **kwargs):
      ...
      if modify:
        ...
        import cpedeployment.cpedeployment_grouping_lib.wanop_ic_local_props_type2_customization
        cpedeployment.cpedeployment_grouping_lib.wanop_ic_local_props_type2_customization.grouping_update_wanop_ic_local_props_type2_wanop_endpoint(smodelctx, sdata, **kwargs)
    ...
    def process_service_delete_data(smodelctx, sdata, **kwargs):
      ...
      if modify:
        ...
        if dev is None or (isinstance(dev, list) and len(dev) == 0):
          return
        import cpedeployment.cpedeployment_grouping_lib.wanop_ic_local_props_type2_customization
        cpedeployment.cpedeployment_grouping_lib.wanop_ic_local_props_type2_customization.grouping_delete_wanop_ic_local_props_type2_wanop_endpoint(smodelctx, sdata, **kwargs)
