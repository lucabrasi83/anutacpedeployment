...
/services/managed-cpe-services/customer/wanop-services/type2-site/type2-site/wanop-secondary/routes/route
"""
"""
    ...
    def process_service_update_data(smodelctx, sdata, **kwargs):
      ...
      if modify:
        ...
        if up_map_devices_device_routes_route[1] == 'key-unchanged':
          device_routes.routes.route().update(sdata, dev, fill_map_devices_device_routes_route(inputdict))
        import cpedeployment.cpedeployment_grouping_lib.routes_customization
...
def fill_map_devices_device_routes_route(inputdict, delete=False):
  mapping_dict_devices_device_routes_route = {}
  mapping_dict_devices_device_routes_route['dest_ip_address'] = inputdict['dest_ip_address']
  mapping_dict_devices_device_routes_route['dest_mask'] = inputdict['dest_mask']
