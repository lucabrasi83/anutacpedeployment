...
class Type2Site(yang.AbstractYangServiceHandler):
    _instance = None
    ...
    def create(self, id, sdata):
        ...
        config = getCurrentObjectConfig(id, sdata, 'type2_site')
        ...
        inputdict['dual_cpe_site_services'] = config.get_field_value('dual_cpe_site_services')#leaf dual-cpe-site-services type True
    ...
    def update(self, id, sdata):
        #Fetch Local Config Object
        config = getCurrentObjectConfig(id, sdata, 'type2_site')
        pconfig = getPreviousObjectConfig(id, sdata, 'type2_site')
        opaque_args = self.opaque_args
        ...
        pinputdict['dual_cpe_site_services'] = pconfig.get_field_value('dual_cpe_site_services')
        dev = []
    ...
    @staticmethod
    def getInstance():
        if(Type2Site._instance == None):
            Type2Site._instance = Type2Site()
        return Type2Site._instance
