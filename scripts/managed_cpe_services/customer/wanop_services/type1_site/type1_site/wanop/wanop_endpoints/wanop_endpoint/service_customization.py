...
/services/managed-cpe-services/customer/wanop-services/type1-site/type1-site/wanop/wanop-endpoints/wanop-endpoint
"""
"""
...
class ServiceDataCustomization:
    ...
    def process_service_device_bindings(smodelctx, sdata, dev, **kwargs):
      ...
      if modify:
        ...
        if dev is None or (isinstance(dev, list) and len(dev) == 0):
          return
        import cpedeployment.cpedeployment_grouping_lib.wanop_ic_local_props_type1_customization
        interface_ip,mask_length = cpedeployment.cpedeployment_grouping_lib.wanop_ic_local_props_type1_customization.grouping_create_wanop_ic_local_props_type1_wanop_endpoint(smodelctx, sdata, dev, **kwargs)
    ...
    def process_service_update_data(smodelctx, sdata, **kwargs):
      ...
      if modify:
        ...
        if up_map_devices_device_interfaces_interface[1] == 'key-delete-create' or up_map_devices_device_interfaces_interface[1] == 'key-delete':
          device_interfaces.interfaces.interface().delete(sdata, dev, pinputdict)
        ...
        if up_map_devices_device_interfaces_interface[1] == 'key-unchanged':
          device_interfaces.interfaces.interface().update(sdata, dev, fill_map_devices_device_interfaces_interface(inputdict))
        import cpedeployment.cpedeployment_grouping_lib.wanop_ic_local_props_type1_customization
        cpedeployment.cpedeployment_grouping_lib.wanop_ic_local_props_type1_customization.grouping_update_wanop_ic_local_props_type1_wanop_endpoint(smodelctx, sdata, **kwargs)
    ...
    def process_service_delete_data(smodelctx, sdata, **kwargs):
      ...
      if modify and kwargs is not None:
        for key, value in kwargs.items():
          log("Wanop-endpoint params generated by service:")
          log("%s == %s" %(key,value))
      ...
      if modify:
        ...
        import cpedeployment.cpedeployment_grouping_lib.wanop_ic_local_props_type1_customization
        cpedeployment.cpedeployment_grouping_lib.wanop_ic_local_props_type1_customization.grouping_delete_wanop_ic_local_props_type1_wanop_endpoint(smodelctx, sdata, **kwargs)

        if dev is None or (isinstance(dev, list) and len(dev) == 0):
          return
        from servicemodel.device_abs_lib import device_interfaces
        if inputdict['interface_name'] is not None:
          log("Clearing interface params generated by service:")
