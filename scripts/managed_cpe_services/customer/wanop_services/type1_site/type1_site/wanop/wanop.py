...
class Wanop(yang.AbstractYangServiceHandler):
    _instance = None
    ...
    def create(self, id, sdata):
        ...
        config = getCurrentObjectConfig(id, sdata, 'wanop')
        ...
        inputkeydict['managed_cpe_services_customer_wanop_services_type1_site_type1_site_site_name'] = sdata.getRcPath().split('/')[-2].split('=')[1]
    ...
    def update(self, id, sdata):
        #Fetch Local Config Object
        config = getCurrentObjectConfig(id, sdata, 'wanop')
        pconfig = getPreviousObjectConfig(id, sdata, 'wanop')
        opaque_args = self.opaque_args
    ...
    @staticmethod
    def getInstance():
        if(Wanop._instance == None):
            Wanop._instance = Wanop()
        return Wanop._instance
