...
class Route(yang.AbstractYangServiceHandler):
    _instance = None
    ...
    def create(self, id, sdata):
        ...
        config = getCurrentObjectConfig(id, sdata, 'route')
        ...
        inputdict['dest_ip_address'] = config.get_field_value('dest_ip_address')#leaf dest-ip-address type False
        inputdict['dest_mask'] = config.get_field_value('dest_mask')#leaf dest-mask type False
    ...
    def update(self, id, sdata):
        #Fetch Local Config Object
        config = getCurrentObjectConfig(id, sdata, 'route')
        pconfig = getPreviousObjectConfig(id, sdata, 'route')
        opaque_args = self.opaque_args
        ...
        pinputdict['dest_ip_address'] = pconfig.get_field_value('dest_ip_address')
        pinputdict['dest_mask'] = pconfig.get_field_value('dest_mask')
        _Gen_obj = getLocalObject(sdata, 'wanop')
        device_mgmt_ip_address = _Gen_obj.wanop.device_ip
    ...
    @staticmethod
    def getInstance():
        if(Route._instance == None):
            Route._instance = Route()
