...
class Type1Site(yang.AbstractYangServiceHandler):
    _instance = None
    ...
    def create(self, id, sdata):
        ...
        config = getCurrentObjectConfig(id, sdata, 'type1_site')
        ...
        inputdict['site_name'] = config.get_field_value('site_name')#leaf site-name type False
        inputdict['description'] = config.get_field_value('description')#leaf description type False
        inputdict['resource_pool'] = config.get_field_value('resource_pool')#leaf resource-pool type True
        inputdict['single_cpe_sites'] = config.get_field_value('single_cpe_sites')#leaf single-cpe-sites type True
    ...
    def update(self, id, sdata):
        #Fetch Local Config Object
        config = getCurrentObjectConfig(id, sdata, 'type1_site')
        pconfig = getPreviousObjectConfig(id, sdata, 'type1_site')
        opaque_args = self.opaque_args
        ...
        pinputdict['site_name'] = pconfig.get_field_value('site_name')
        pinputdict['description'] = pconfig.get_field_value('description')
        pinputdict['resource_pool'] = pconfig.get_field_value('resource_pool')
        pinputdict['single_cpe_sites'] = pconfig.get_field_value('single_cpe_sites')
        dev = []
    ...
    @staticmethod
    def getInstance():
        if(Type1Site._instance == None):
            Type1Site._instance = Type1Site()
        return Type1Site._instance
