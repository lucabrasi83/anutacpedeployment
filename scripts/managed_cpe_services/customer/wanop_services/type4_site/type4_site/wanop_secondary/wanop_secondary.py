...
class WanopSecondary(yang.AbstractYangServiceHandler):
    _instance = None
    ...
    def create(self, id, sdata):
        ...
        config = getCurrentObjectConfig(id, sdata, 'wanop_secondary')
    ...
    def update(self, id, sdata):
        #Fetch Local Config Object
        config = getCurrentObjectConfig(id, sdata, 'wanop_secondary')
        pconfig = getPreviousObjectConfig(id, sdata, 'wanop_secondary')
        opaque_args = self.opaque_args
    ...
    @staticmethod
    def getInstance():
        if(WanopSecondary._instance == None):
            WanopSecondary._instance = WanopSecondary()
        return WanopSecondary._instance
