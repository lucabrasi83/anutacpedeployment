...
/services/managed-cpe-services/customer/wanop-services/type4-site/type4-site/wanop-secondary/inpath-rules/inpath-rules
"""
"""
...
def fill_up_map_devices_device_inpath_rules_inpath_rules_def(inputdict, pinputdict):
  ...
  up_mapping_dict_devices_device_inpath_rules_inpath_rules_def['wan_vis_opt'] = inputdict['wan_vis_opt'] if not delete else ''
  ...
  if inputdict['srcport'] is None and inputdict['wan_visibility'] is None and inputdict['dst_host'] is None and inputdict['packet_mode_uni'] is None and inputdict['vlan'] is None and inputdict['dstaddr'] is None and inputdict['preoptimization'] is None and inputdict['latency_opt'] is None and inputdict['backup_addr'] is None and inputdict['target_port'] is None and inputdict['description'] is None and inputdict['backup_port'] is None and inputdict['rule_enable'] is None and inputdict['optimization'] is None and inputdict['rule_type'] is None and inputdict['dstport'] is None and inputdict['protocol'] is None and inputdict['web_proxy'] is None and inputdict['rulenum'] is None and inputdict['auto_kickoff'] is None and inputdict['neural_mode'] is None and inputdict['srcaddr'] is None and inputdict['dst_domain'] is None and inputdict['target_addr'] is None and inputdict['cloud_accel'] is None:
