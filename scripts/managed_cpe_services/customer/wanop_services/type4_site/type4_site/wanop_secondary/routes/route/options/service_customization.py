...
/services/managed-cpe-services/customer/wanop-services/type4-site/type4-site/wanop-secondary/routes/route/options
"""
"""
...
class ServiceDataCustomization:
    ...
    def process_service_device_bindings(smodelctx, sdata, dev, **kwargs):
      ...
      if modify:
        ...
        inputdict['managed_cpe_services_customer_wanop_services_type4_site_type4_site_wanop_secondary_routes_route_dest_ip_address'] = _route_obj.route.dest_ip_address
        inputdict['managed_cpe_services_customer_wanop_services_type4_site_type4_site_wanop_secondary_routes_route_dest_mask'] = _route_obj.route.dest_mask
        from servicemodel.device_abs_lib import device_routes
        if inputdict['managed_cpe_services_customer_wanop_services_type4_site_type4_site_wanop_secondary_routes_route_dest_ip_address'] is not None and inputdict['managed_cpe_services_customer_wanop_services_type4_site_type4_site_wanop_secondary_routes_route_dest_mask'] is not None and inputdict['id'] is not None:
          device_routes.routes.route.options().create(sdata, dev, inputdict['managed_cpe_services_customer_wanop_services_type4_site_type4_site_wanop_secondary_routes_route_dest_ip_address'], inputdict['managed_cpe_services_customer_wanop_services_type4_site_type4_site_wanop_secondary_routes_route_dest_mask'], fill_map_devices_device_routes_route_options(inputdict), addref=True)
    ...
    def process_service_update_data(smodelctx, sdata, **kwargs):
      ...
      if modify:
        ...
        if up_map_devices_device_routes_route_options[1] == 'key-delete-create' or up_map_devices_device_routes_route_options[1] == 'key-delete':
          device_routes.routes.route.options().delete(sdata, dev, inputdict['managed_cpe_services_customer_wanop_services_type4_site_type4_site_wanop_secondary_routes_route_dest_ip_address'], inputdict['managed_cpe_services_customer_wanop_services_type4_site_type4_site_wanop_secondary_routes_route_dest_mask'], pinputdict)
        ...
        if up_map_devices_device_routes_route_options[1] == 'key-unchanged':
          device_routes.routes.route.options().update(sdata, dev, inputdict['managed_cpe_services_customer_wanop_services_type4_site_type4_site_wanop_secondary_routes_route_dest_ip_address'], inputdict['managed_cpe_services_customer_wanop_services_type4_site_type4_site_wanop_secondary_routes_route_dest_mask'], fill_map_devices_device_routes_route_options(inputdict, pinputdict, update=True))
