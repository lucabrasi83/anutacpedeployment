...
class Type4Site(yang.AbstractYangServiceHandler):
    _instance = None
    ...
    def create(self, id, sdata):
        ...
        config = getCurrentObjectConfig(id, sdata, 'type4_site')
    ...
    def update(self, id, sdata):
        #Fetch Local Config Object
        config = getCurrentObjectConfig(id, sdata, 'type4_site')
        pconfig = getPreviousObjectConfig(id, sdata, 'type4_site')
        opaque_args = self.opaque_args
    ...
    @staticmethod
    def getInstance():
        if(Type4Site._instance == None):
            Type4Site._instance = Type4Site()
        return Type4Site._instance
