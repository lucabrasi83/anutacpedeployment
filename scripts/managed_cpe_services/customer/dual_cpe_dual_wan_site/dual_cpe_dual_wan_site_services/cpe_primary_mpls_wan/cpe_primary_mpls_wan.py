...
class CpePrimaryMplsWan(yang.AbstractYangServiceHandler):
    _instance = None
    ...
    def create(self, id, sdata):
        ...
        config = getCurrentObjectConfig(id, sdata, 'cpe_primary_mpls_wan')
        ...
        if inputdict.get('interconnect_name') is None:
          inputdict['interconnect_name'] = 'cpe-primary-mpls-wan'
    ...
    @staticmethod
    def getInstance():
        if(CpePrimaryMplsWan._instance == None):
            CpePrimaryMplsWan._instance = CpePrimaryMplsWan()
        return CpePrimaryMplsWan._instance

    #def rollbackCreate(self, id, sdata):
        #        log('rollback: id = %s, sdata = %s' % (id, sdata))
        #        self.delete(id,sdata)

if __name__ == 'cpe_primary_mpls_wan':
  from servicemodel.yang import YangServiceData
  sdata = YangServiceData()
  instance = CpePrimaryMplsWan().getInstance()
