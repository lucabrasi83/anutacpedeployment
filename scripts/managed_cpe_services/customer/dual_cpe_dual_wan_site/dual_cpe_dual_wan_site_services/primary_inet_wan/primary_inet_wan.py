...
class PrimaryInetWan(yang.AbstractYangServiceHandler):
    _instance = None
    ...
    def create(self, id, sdata):
        ...
        config = getCurrentObjectConfig(id, sdata, 'primary_inet_wan')
        ...
        if inputdict.get('name') is None:
          inputdict['name'] = 'primary-inet-wan'
        inputdict['primary_inet_wan_connectivity'] = config.get_field_value('primary_inet_wan_connectivity')
        if inputdict.get('primary_inet_wan_connectivity') is None:
          inputdict['primary_inet_wan_connectivity'] = 'INET'
    ...
    @staticmethod
    def getInstance():
        if(PrimaryInetWan._instance == None):
            PrimaryInetWan._instance = PrimaryInetWan()
        return PrimaryInetWan._instance

    #def rollbackCreate(self, id, sdata):
        #        log('rollback: id = %s, sdata = %s' % (id, sdata))
        #        self.delete(id,sdata)

if __name__ == 'primary_inet_wan':
  from servicemodel.yang import YangServiceData
  sdata = YangServiceData()
  instance = PrimaryInetWan().getInstance()
