...
/services/managed-cpe-services/customer/dual-cpe-dual-wan-site/dual-cpe-dual-wan-site-services
"""
"""
...
class ServiceDataCustomization:
    ...
    def process_service_update_data(smodelctx, sdata, **kwargs):
      ...
      #raise Exception('Update forbidden for node dual-cpe-dual-wan-site-services at path managed-cpe-services/customer/dual-cpe-dual-wan-site/dual-cpe-dual-wan-site-services')
      modify = True
      if modify and kwargs is not None:
        for key, value in kwargs.iteritems():
          log("%s == %s" %(key,value))
...
class DeletePreProcessor(yang.SessionPreProcessor):
    def processBeforeReserve(self, session):
        ...
        util.log_debug('pass12: operations: %s' % (operations))
        yang.moveOperations(operations, ['DeleteObjectGroup'], ['DeleteAclRule'], True)
