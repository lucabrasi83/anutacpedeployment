...
class SecondaryMplsWan(yang.AbstractYangServiceHandler):
    _instance = None
    ...
    def create(self, id, sdata):
        ...
        config = getCurrentObjectConfig(id, sdata, 'secondary_mpls_wan')
        ...
        if inputdict.get('name') is None:
          inputdict['name'] = 'secondary-mpls-wan'
        inputdict['secondary_mpls_wan_connectivity'] = config.get_field_value('secondary_mpls_wan_connectivity')
        if inputdict.get('secondary_mpls_wan_connectivity') is None:
          inputdict['secondary_mpls_wan_connectivity'] = 'MPLS'
    ...
    @staticmethod
    def getInstance():
        if(SecondaryMplsWan._instance == None):
            SecondaryMplsWan._instance = SecondaryMplsWan()
        return SecondaryMplsWan._instance

    #def rollbackCreate(self, id, sdata):
        #        log('rollback: id = %s, sdata = %s' % (id, sdata))
        #        self.delete(id,sdata)

if __name__ == 'secondary_mpls_wan':
  from servicemodel.yang import YangServiceData
  sdata = YangServiceData()
  instance = SecondaryMplsWan().getInstance()
