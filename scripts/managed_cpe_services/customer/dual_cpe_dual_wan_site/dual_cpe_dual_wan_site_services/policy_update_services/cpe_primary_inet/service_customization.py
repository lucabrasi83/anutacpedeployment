...
class ServiceDataCustomization:
    ...
    def process_service_update_data(smodelctx, sdata, **kwargs):
      ...
      if modify:
        ...
        primary_ic_uri = "%s/cpe-primary-inet-wan/end-points=%s/bgp-peers" % (parent_uri, inputdict['end_point'])
        ep_uri = "%s/cpe-primary-inet-wan/end-points=%s" % (parent_uri, inputdict['end_point'])
