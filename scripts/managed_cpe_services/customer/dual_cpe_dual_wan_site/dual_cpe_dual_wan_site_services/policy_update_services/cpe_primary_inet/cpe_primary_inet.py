...
class CpePrimaryInet(yang.AbstractYangServiceHandler):
    _instance = None
    ...
    def create(self, id, sdata):
        ...
        config = getCurrentObjectConfig(id, sdata, 'cpe_primary_inet')
    ...
    @staticmethod
    def getInstance():
        if(CpePrimaryInet._instance == None):
            CpePrimaryInet._instance = CpePrimaryInet()
        return CpePrimaryInet._instance

    #def rollbackCreate(self, id, sdata):
        #        log('rollback: id = %s, sdata = %s' % (id, sdata))
        #        self.delete(id,sdata)

if __name__ == 'cpe_primary_inet':
  from servicemodel.yang import YangServiceData
  sdata = YangServiceData()
  instance = CpePrimaryInet().getInstance()
