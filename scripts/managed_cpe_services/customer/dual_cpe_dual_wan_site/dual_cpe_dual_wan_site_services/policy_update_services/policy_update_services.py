...
class PolicyUpdateServices(yang.AbstractYangServiceHandler):
    _instance = None
    ...
    def create(self, id, sdata):
        ...
        config = getCurrentObjectConfig(id, sdata, 'policy_update_services')
        ...
        inputdict['rtt_trigger'] = config.get_field_value('rtt_trigger')
        if inputdict.get('rtt_trigger') is None:
          inputdict['rtt_trigger'] = 'false'
    ...
    @staticmethod
    def getInstance():
        if(PolicyUpdateServices._instance == None):
            PolicyUpdateServices._instance = PolicyUpdateServices()
        return PolicyUpdateServices._instance

    #def rollbackCreate(self, id, sdata):
        #        log('rollback: id = %s, sdata = %s' % (id, sdata))
        #        self.delete(id,sdata)

if __name__ == 'policy_update_services':
  from servicemodel.yang import YangServiceData
  sdata = YangServiceData()
  instance = PolicyUpdateServices().getInstance()
