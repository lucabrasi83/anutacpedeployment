...
class CpePrimaryInetWan(yang.AbstractYangServiceHandler):
    _instance = None
    ...
    def create(self, id, sdata):
        ...
        config = getCurrentObjectConfig(id, sdata, 'cpe_primary_inet_wan')
        ...
        if inputdict.get('interconnect_name') is None:
          inputdict['interconnect_name'] = 'cpe-primary-inet-wan'
    ...
    @staticmethod
    def getInstance():
        if(CpePrimaryInetWan._instance == None):
            CpePrimaryInetWan._instance = CpePrimaryInetWan()
        return CpePrimaryInetWan._instance

    #def rollbackCreate(self, id, sdata):
        #        log('rollback: id = %s, sdata = %s' % (id, sdata))
        #        self.delete(id,sdata)

if __name__ == 'cpe_primary_inet_wan':
  from servicemodel.yang import YangServiceData
  sdata = YangServiceData()
  instance = CpePrimaryInetWan().getInstance()
