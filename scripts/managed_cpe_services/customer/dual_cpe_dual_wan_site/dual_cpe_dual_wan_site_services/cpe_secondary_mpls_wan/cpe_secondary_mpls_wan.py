...
class CpeSecondaryMplsWan(yang.AbstractYangServiceHandler):
    _instance = None
    ...
    def create(self, id, sdata):
        ...
        config = getCurrentObjectConfig(id, sdata, 'cpe_secondary_mpls_wan')
        ...
        if inputdict.get('interconnect_name') is None:
          inputdict['interconnect_name'] = 'cpe-secondary-mpls-wan'
    ...
    @staticmethod
    def getInstance():
        if(CpeSecondaryMplsWan._instance == None):
            CpeSecondaryMplsWan._instance = CpeSecondaryMplsWan()
        return CpeSecondaryMplsWan._instance

    #def rollbackCreate(self, id, sdata):
        #        log('rollback: id = %s, sdata = %s' % (id, sdata))
        #        self.delete(id,sdata)

if __name__ == 'cpe_secondary_mpls_wan':
  from servicemodel.yang import YangServiceData
  sdata = YangServiceData()
  instance = CpeSecondaryMplsWan().getInstance()
