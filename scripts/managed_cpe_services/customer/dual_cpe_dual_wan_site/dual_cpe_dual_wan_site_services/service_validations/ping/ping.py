...
class Ping(yang.AbstractYangServiceHandler):
    _instance = None
    ...
    def create(self, id, sdata):
        ...
        config = getCurrentObjectConfig(id, sdata, 'ping')
        ...
        inputdict['destination_ip'] = config.get_field_value('destination_ip')
