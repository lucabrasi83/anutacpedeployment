...
class PrimaryMplsWan(yang.AbstractYangServiceHandler):
    _instance = None
    ...
    def create(self, id, sdata):
        ...
        config = getCurrentObjectConfig(id, sdata, 'primary_mpls_wan')
        ...
        if inputdict.get('name') is None:
          inputdict['name'] = 'primary-mpls-wan'
        inputdict['primary_mpls_wan_connectivity'] = config.get_field_value('primary_mpls_wan_connectivity')
        if inputdict.get('primary_mpls_wan_connectivity') is None:
          inputdict['primary_mpls_wan_connectivity'] = 'MPLS'
    ...
    @staticmethod
    def getInstance():
        if(PrimaryMplsWan._instance == None):
            PrimaryMplsWan._instance = PrimaryMplsWan()
        return PrimaryMplsWan._instance

    #def rollbackCreate(self, id, sdata):
        #        log('rollback: id = %s, sdata = %s' % (id, sdata))
        #        self.delete(id,sdata)

if __name__ == 'primary_mpls_wan':
  from servicemodel.yang import YangServiceData
  sdata = YangServiceData()
  instance = PrimaryMplsWan().getInstance()
