...
class DualCpeDualWanSiteServices(yang.AbstractYangServiceHandler):
    _instance = None
    ...
    @staticmethod
    def getInstance():
        if(DualCpeDualWanSiteServices._instance == None):
            DualCpeDualWanSiteServices._instance = DualCpeDualWanSiteServices()
        return DualCpeDualWanSiteServices._instance

    #def rollbackCreate(self, id, sdata):
        #        log('rollback: id = %s, sdata = %s' % (id, sdata))
        #        self.delete(id,sdata)

if __name__ == 'dual_cpe_dual_wan_site_services':
  from servicemodel.yang import YangServiceData
  sdata = YangServiceData()
  instance = DualCpeDualWanSiteServices().getInstance()
