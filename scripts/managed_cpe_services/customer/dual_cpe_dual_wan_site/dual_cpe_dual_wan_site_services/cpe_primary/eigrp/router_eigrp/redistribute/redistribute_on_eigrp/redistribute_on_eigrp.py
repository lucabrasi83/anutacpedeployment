...
class RedistributeOnEigrp(yang.AbstractYangServiceHandler):
    ...
    def create(self, id, sdata):
        ...
        inputkeydict['managed_cpe_services_customer_dual_cpe_dual_wan_site_dual_cpe_dual_wan_site_services_cpe_primary_eigrp_router_eigrp_process_id'] = sdata.getRcPath().split('/')[-3].split('=')[1]
