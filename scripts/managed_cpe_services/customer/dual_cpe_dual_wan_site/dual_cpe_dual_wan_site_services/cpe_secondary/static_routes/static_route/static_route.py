...
class StaticRoute(yang.AbstractYangServiceHandler):
    _instance = None
    ...
    def create(self, id, sdata):
        ...
        config = getCurrentObjectConfig(id, sdata, 'static_route')
    ...
    @staticmethod
    def getInstance():
        if(StaticRoute._instance == None):
            StaticRoute._instance = StaticRoute()
        return StaticRoute._instance

    #def rollbackCreate(self, id, sdata):
        #        log('rollback: id = %s, sdata = %s' % (id, sdata))
        #        self.delete(id,sdata)

if __name__ == 'static_route':
  from servicemodel.yang import YangServiceData
  sdata = YangServiceData()
  instance = StaticRoute().getInstance()
