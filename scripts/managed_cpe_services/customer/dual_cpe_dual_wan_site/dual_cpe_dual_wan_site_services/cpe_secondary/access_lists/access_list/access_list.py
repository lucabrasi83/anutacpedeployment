...
class AccessList(yang.AbstractYangServiceHandler):
    _instance = None
    ...
    def create(self, id, sdata):
        ...
        config = getCurrentObjectConfig(id, sdata, 'access_list')
        ...
        if inputdict.get('access_list_entry') is None:
    ...
    @staticmethod
    def getInstance():
        if(AccessList._instance == None):
            AccessList._instance = AccessList()
        return AccessList._instance

    #def rollbackCreate(self, id, sdata):
        #        log('rollback: id = %s, sdata = %s' % (id, sdata))
        #        self.delete(id,sdata)

if __name__ == 'access_list':
  from servicemodel.yang import YangServiceData
  sdata = YangServiceData()
  instance = AccessList().getInstance()
