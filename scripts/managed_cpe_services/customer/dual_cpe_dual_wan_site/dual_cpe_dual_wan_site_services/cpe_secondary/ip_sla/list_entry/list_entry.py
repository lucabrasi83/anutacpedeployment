...
/services/managed-cpe-services/customer/dual-cpe-dual-wan-site/dual-cpe-dual-wan-site-services/cpe-secondary/ip-sla/list-entry
"""
...
class ListEntry(yang.AbstractYangServiceHandler):
    _instance = None
    ...
    def create(self, id, sdata):
        ...
        config = getCurrentObjectConfig(id, sdata, 'list_entry')
        ...
        if inputdict.get('boolean_type') is None:
          inputdict['boolean_type'] = 'or'
    ...
    @staticmethod
    def getInstance():
        if(ListEntry._instance == None):
            ListEntry._instance = ListEntry()
        return ListEntry._instance
