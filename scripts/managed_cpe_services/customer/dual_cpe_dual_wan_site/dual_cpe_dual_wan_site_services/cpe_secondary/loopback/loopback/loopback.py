...
class Loopback(yang.AbstractYangServiceHandler):
    _instance = None
    ...
    def create(self, id, sdata):
        ...
        config = getCurrentObjectConfig(id, sdata, 'loopback')
    ...
    @staticmethod
    def getInstance():
        if(Loopback._instance == None):
            Loopback._instance = Loopback()
        return Loopback._instance

    #def rollbackCreate(self, id, sdata):
        #        log('rollback: id = %s, sdata = %s' % (id, sdata))
        #        self.delete(id,sdata)

if __name__ == 'loopback':
  from servicemodel.yang import YangServiceData
  sdata = YangServiceData()
  instance = Loopback().getInstance()
