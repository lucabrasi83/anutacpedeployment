...
class AddressTranslation(yang.AbstractYangServiceHandler):
    _instance = None
    ...
    def create(self, id, sdata):
        ...
        config = getCurrentObjectConfig(id, sdata, 'address_translation')
        ...
        inputdict['list'] = config.get_field_value('list')
    ...
    @staticmethod
    def getInstance():
        if(AddressTranslation._instance == None):
            AddressTranslation._instance = AddressTranslation()
        return AddressTranslation._instance

    #def rollbackCreate(self, id, sdata):
        #        log('rollback: id = %s, sdata = %s' % (id, sdata))
        #        self.delete(id,sdata)

if __name__ == 'address_translation':
  from servicemodel.yang import YangServiceData
  sdata = YangServiceData()
  instance = AddressTranslation().getInstance()
