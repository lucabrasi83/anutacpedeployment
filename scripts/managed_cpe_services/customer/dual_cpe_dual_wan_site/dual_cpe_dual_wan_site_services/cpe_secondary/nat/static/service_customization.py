...
/services/managed-cpe-services/customer/dual-cpe-dual-wan-site/dual-cpe-dual-wan-site-services/cpe-secondary/nat/static
"""
"""
...
from cpedeployment.cpedeployment_lib import log, natstatic
    ...
    def process_service_device_bindings(smodelctx, sdata, dev, **kwargs):
      ...
      if modify:
        ...
        for device in util.convert_to_list(dev):
            natstatic(smodelctx, sdata, device, **kwargs)
