...
class CommunityList(yang.AbstractYangServiceHandler):
    _instance = None
    ...
    @staticmethod
    def getInstance():
        if(CommunityList._instance == None):
            CommunityList._instance = CommunityList()
        return CommunityList._instance

    #def rollbackCreate(self, id, sdata):
        #        log('rollback: id = %s, sdata = %s' % (id, sdata))
        #        self.delete(id,sdata)

if __name__ == 'community_list':
  from servicemodel.yang import YangServiceData
  sdata = YangServiceData()
  instance = CommunityList().getInstance()
