...
/services/managed-cpe-services/customer/dual-cpe-dual-wan-site/dual-cpe-dual-wan-site-services/lan/switches/interface
"""
"""
...
from cpedeployment.switch_lib import interfacedef
from cpedeployment.switch_lib import delete_int
...
class ServiceDataCustomization:
    ...
    def process_service_device_bindings(smodelctx, sdata, dev, **kwargs):
      ...
      if modify:
        ...
        for device in util.convert_to_list(dev):
            interfacedef(smodelctx, sdata, device, **kwargs)
    ...
    def process_service_delete_data(smodelctx, sdata, **kwargs):
      ...
      if modify:
        ...
        opaque_args = kwargs['hopaque']
        for device in util.convert_to_list(dev):
            delete_int(smodelctx, sdata, device, **kwargs)
