...
class CpeLan(yang.AbstractYangServiceHandler):
    _instance = None
    ...
    def create(self, id, sdata):
        ...
        config = getCurrentObjectConfig(id, sdata, 'cpe_lan')
        ...
        if inputdict.get('interconnect_name') is None:
          inputdict['interconnect_name'] = 'cpe-lan'
    ...
    @staticmethod
    def getInstance():
        if(CpeLan._instance == None):
            CpeLan._instance = CpeLan()
        return CpeLan._instance
