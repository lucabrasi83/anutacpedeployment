...
class ServiceDataCustomization:
    ...
    def process_service_create_data(smodelctx, sdata, dev, **kwargs):
      ...
      if modify:
        ...
        for device in util.convert_to_list(dev):
            eigrpSummary('customer_lan_ic_dual', smodelctx, sdata, device, **kwargs)
    ...
    def process_service_update_data(smodelctx, sdata, **kwargs):
      ...
      raise Exception('Update forbidden for node summary-network at path managed-cpe-services/customer/dual-cpe-dual-wan-site/dual-cpe-dual-wan-site-services/cpe-lan/end-points/eigrp/summary-network')
      modify = True
      if modify and kwargs is not None:
        for key, value in kwargs.items():
          log("%s == %s" %(key,value))
