...
class DmvpnTunnelProfile(yang.AbstractYangServiceHandler):
    _instance = None
    ...
    def create(self, id, sdata):
        ...
        config = getCurrentObjectConfig(id, sdata, 'dmvpn_tunnel_profile')
        ...
        inputdict['tunnel_prefix'] = config.get_field_value('tunnel_prefix')
    ...
    @staticmethod
    def getInstance():
        if(DmvpnTunnelProfile._instance == None):
            DmvpnTunnelProfile._instance = DmvpnTunnelProfile()
        return DmvpnTunnelProfile._instance
