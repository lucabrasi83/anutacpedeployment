...
class RouteMapEntries(yang.AbstractYangServiceHandler):
    _instance = None
    ...
    def create(self, id, sdata):
        ...
        inputdict['continue1'] = config.get_field_value('continue')
        # END OF FETCHING THE LEAF PARAMETERS

        inputkeydict = {}
        # START OF FETCHING THE PARENT KEY LEAF PARAMETERS
        inputkeydict['managed_cpe_services_customer_route_maps_route_map_route_map_name'] = sdata.getRcPath().split('/')[-2].split('=')[1]
    ...
    @staticmethod
    def getInstance():
        if(RouteMapEntries._instance == None):
            RouteMapEntries._instance = RouteMapEntries()
        return RouteMapEntries._instance
