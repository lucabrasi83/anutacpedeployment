...
class UpdateRouteMaps(yang.AbstractYangServiceHandler):
    _instance = None
    ...
    @staticmethod
    def getInstance():
        if(UpdateRouteMaps._instance == None):
            UpdateRouteMaps._instance = UpdateRouteMaps()
        return UpdateRouteMaps._instance
