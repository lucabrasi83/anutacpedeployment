...
class DeleteObjectGroup(yang.AbstractYangServiceHandler):
    _instance = None
    ...
    def create(self, id, sdata):
        ...
        config = getCurrentObjectConfig(id, sdata, 'delete_object_group')
        ...
        inputdict['object_group_name'] = config.get_field_value('object_group_name')
    ...
    @staticmethod
    def getInstance():
        if(DeleteObjectGroup._instance == None):
            DeleteObjectGroup._instance = DeleteObjectGroup()
        return DeleteObjectGroup._instance

    #def rollbackCreate(self, id, sdata):
        #        log('rollback: id = %s, sdata = %s' % (id, sdata))
        #        self.delete(id,sdata)

if __name__ == 'delete_object_group':
  from servicemodel.yang import YangServiceData
  sdata = YangServiceData()
  instance = DeleteObjectGroup().getInstance()
