...
class Analytics(yang.AbstractYangServiceHandler):
    _instance = None
    ...
    def create(self, id, sdata):
        ...
        config = getCurrentObjectConfig(id, sdata, 'analytics', False)
        ...
        inputdict['update'] = config.get_field_value('update')
        # END OF FETCHING THE LEAF PARAMETERS

        # START OF FETCHING THE PARENT KEY LEAF PARAMETERS
        inputkeydict['managed_cpe_services_customer_name'] = sdata.getRcPath().split('/')[-2].split('=')[1]
    ...
    def update(self, id, sdata):
        #Fetch Local Config Object
        config = getCurrentObjectConfig(id, sdata, 'analytics', False)
        pconfig = getPreviousObjectConfig(id, sdata, 'analytics')
        opaque_args = self.opaque_args
        ...
        pinputdict['update'] = pconfig.get_field_value('update')
        dev = []
    ...
    @staticmethod
    def getInstance():
        if(Analytics._instance == None):
            Analytics._instance = Analytics()
