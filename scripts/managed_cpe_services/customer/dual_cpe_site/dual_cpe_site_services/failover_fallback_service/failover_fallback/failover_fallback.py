...
class FailoverFallback(yang.AbstractYangServiceHandler):
    ...
    def create(self, id, sdata):
        ...
        inputdict['failover_lan_and_b2b'] = config.get_field_value('failover_lan_and_b2b')
    ...
    def update(self, id, sdata):
        ...
        pinputdict['failover_lan_and_b2b'] = pconfig.get_field_value('failover_lan_and_b2b')
