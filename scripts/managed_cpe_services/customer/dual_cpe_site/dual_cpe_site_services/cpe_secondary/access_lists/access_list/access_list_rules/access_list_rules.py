...
class AccessListRules(yang.AbstractYangServiceHandler):
    ...
    def create(self, id, sdata):
        ...
        inputkeydict['managed_cpe_services_customer_dual_cpe_site_dual_cpe_site_services_cpe_secondary_access_lists_access_list_name'] = sdata.getRcPath().split('/')[-2].split('=')[1]
