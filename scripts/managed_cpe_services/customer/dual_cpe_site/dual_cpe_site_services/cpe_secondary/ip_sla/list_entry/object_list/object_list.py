...
/services/managed-cpe-services/customer/dual-cpe-site/dual-cpe-site-services/cpe-secondary/ip-sla/list-entry/object-list
"""
...
class ObjectList(yang.AbstractYangServiceHandler):
    ...
    def create(self, id, sdata):
        ...
        inputkeydict['managed_cpe_services_customer_dual_cpe_site_dual_cpe_site_services_cpe_secondary_ip_sla_list_entry_track_number'] = sdata.getRcPath().split('/')[-2].split('=')[1]
        ...
        inputdict['list_track_number'] = inputkeydict['managed_cpe_services_customer_dual_cpe_site_dual_cpe_site_services_cpe_secondary_ip_sla_list_entry_track_number']
