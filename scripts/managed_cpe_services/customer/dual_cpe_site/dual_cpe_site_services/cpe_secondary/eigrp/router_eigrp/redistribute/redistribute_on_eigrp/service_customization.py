...
/services/managed-cpe-services/customer/dual-cpe-site/dual-cpe-site-services/cpe-secondary/eigrp/router-eigrp/redistribute/redistribute-on-eigrp
"""
"""
    ...
    def process_service_create_data(smodelctx, sdata, dev, **kwargs):
      ...
      if modify:
        ...
        for device in util.convert_to_list(dev):
            eigrpRedis('cpe_secondary', smodelctx, sdata, device, **kwargs)
