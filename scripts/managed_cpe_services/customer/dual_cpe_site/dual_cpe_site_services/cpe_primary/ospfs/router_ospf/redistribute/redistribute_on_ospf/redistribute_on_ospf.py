...
class RedistributeOnOspf(yang.AbstractYangServiceHandler):
    ...
    def create(self, id, sdata):
        ...
        #inputkeydict['managed_cpe_services_customer_dual_cpe_site_dual_cpe_site_services_cpe_primary_ospfs_router_ospf_process_id'] = sdata.getRcPath().split('/')[-3].split('=')[1]
