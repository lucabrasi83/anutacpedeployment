...
class ServiceDataCustomization:
    ...
    def process_service_update_data(smodelctx, sdata, **kwargs):
      ...
      #raise Exception('Update forbidden for node sla at path managed-cpe-services/customer/dual-cpe-site/dual-cpe-site-services/cpe-primary/ip-sla/sla')
      modify = False
      if modify and kwargs is not None:
        for key, value in kwargs.iteritems():
          log("%s == %s" %(key,value))

      update_ip_sla(sdata, 'cpe_primary')
