...
/services/managed-cpe-services/customer/dual-cpe-site/dual-cpe-site-services/cpe-lan/end-points
"""
"""
...
class ServiceDataCustomization:
    ...
    def process_service_update_data(smodelctx, sdata, **kwargs):
      ...
      dev = kwargs['dev']
      #config_now = kwargs["config"]
      #prevconfig = util.parseXmlString(sdata.getPreviousPayload())
      #prevconfig_hsrp = prevconfig.end_points
      for device in util.convert_to_list(dev):
    ...
    def process_service_delete_data(smodelctx, sdata, **kwargs):
      ...
      for device in util.convert_to_list(dev):
          ...
          delete_physical_interface('customer_lan_ic', smodelctx, sdata, device, **kwargs)
