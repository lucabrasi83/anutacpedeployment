...
class ServiceDataCustomization:
    ...
    def process_service_update_data(smodelctx, sdata, **kwargs):
      ...
      if modify and kwargs is not None:
        ...
        inputdict = {}
        inputdict['end_point'] = prevconfig.cpe_secondary.get_field_value('end_point')
        ...
        secondary_ic_uri = "%s/cpe-secondary-wan/end-points=%s/bgp-peers" % (parent_uri, inputdict['end_point'])
        ep_uri = "%s/cpe-secondary-wan/end-points=%s" % (parent_uri, inputdict['end_point'])
