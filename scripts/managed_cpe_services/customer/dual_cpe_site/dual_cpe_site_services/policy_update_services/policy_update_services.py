...
class PolicyUpdateServices(yang.AbstractYangServiceHandler):
    ...
    def delete(self, id, sdata):
        ...
        dev = []
        #Use the custom method to process the data
        service_customization.ServiceDataCustomization.process_service_delete_data(smodelctx, sdata, dev=dev, parentobj=parentobj, config=config, inputdict=inputdict)
