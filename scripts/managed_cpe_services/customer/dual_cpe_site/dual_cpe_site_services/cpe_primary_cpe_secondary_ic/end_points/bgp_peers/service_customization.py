...
class ServiceDataCustomization:
    ...
    def process_service_device_bindings(smodelctx, sdata, dev, **kwargs):
      ...
      if modify:
        ...
        for device in util.convert_to_list(dev):
            bgp_peer('cpe_primary', 'cpe_primary_cpe_secondary_ic', smodelctx, sdata, device, **kwargs)
    ...
    def process_service_update_data(smodelctx, sdata, **kwargs):
      ...
      dev = kwargs['dev']
      for device in util.convert_to_list(dev):
          update_bgp_peer('cpe_primary', 'cpe_primary_cpe_secondary_ic', smodelctx, sdata, device, **kwargs)
