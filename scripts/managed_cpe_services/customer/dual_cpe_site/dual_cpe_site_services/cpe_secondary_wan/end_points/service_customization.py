...
/services/managed-cpe-services/customer/dual-cpe-site/dual-cpe-site-services/cpe-secondary-wan/end-points
"""
"""
...
class ServiceDataCustomization:
    ...
    def process_service_device_bindings(smodelctx, sdata, dev, **kwargs):
      ...
      if modify:
        ...
        for device in util.convert_to_list(dev):
            wan_endpoint('cpe_secondary', smodelctx, sdata, device, **kwargs)
    ...
    def process_service_delete_data(smodelctx, sdata, **kwargs):
      ...
      for device in util.convert_to_list(dev):
          ...
          delete_physical_interface('cpe_secondary', smodelctx, sdata, device, **kwargs)
          # config = kwargs['config']
          # if config.interface_type == 'Tunnel':
          #     delete_crypto('cpe_secondary', smodelctx, sdata, device, **kwargs)
