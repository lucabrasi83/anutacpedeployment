...
class SummaryNetwork(yang.AbstractYangServiceHandler):
    ...
    def create(self, id, sdata):
        ...
        inputkeydict['managed_cpe_services_customer_dual_cpe_site_dual_cpe_site_services_cpe_primary_wan_end_points_eigrp_name'] = sdata.getRcPath().split('/')[-2].split('=')[1]
        inputkeydict['managed_cpe_services_customer_dual_cpe_site_dual_cpe_site_services_cpe_primary_wan_end_points_endpoint_name'] = sdata.getRcPath().split('/')[-3].split('=')[1]
