...
class CpeName(yang.AbstractYangServiceHandler):
    ...
    def create(self, id, sdata):
        ...
        inputdict['lan_eigrp_redistribution'] = config.get_field_value('lan_eigrp_redistribution')
        inputdict['eigrp_route_map'] = config.get_field_value('eigrp_route_map')
        inputdict['eigrp_as'] = config.get_field_value('eigrp_as')
        inputdict['eigrp_metric'] = config.get_field_value('eigrp_metric')
        inputdict['eigrp_metric_type'] = config.get_field_value('eigrp_metric_type')
        inputdict['eigrp_tag'] = config.get_field_value('eigrp_tag')
