...
class OspfNetwork(yang.AbstractYangServiceHandler):
    _instance = None
    ...
    def create(self, id, sdata):
        ...
        inputdict['nssa'] = config.get_field_value('nssa')
    ...
    @staticmethod
    def getInstance():
        if(OspfNetwork._instance == None):
            OspfNetwork._instance = OspfNetwork()
        return OspfNetwork._instance
