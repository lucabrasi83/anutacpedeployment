...
class CpeTertiary(yang.AbstractYangServiceHandler):
    _instance = None
    ...
    def create(self, id, sdata):
        ...
        config = getCurrentObjectConfig(id, sdata, 'cpe_tertiary')
    ...
    @staticmethod
    def getInstance():
        if(CpeTertiary._instance == None):
            CpeTertiary._instance = CpeTertiary()
        return CpeTertiary._instance

    #def rollbackCreate(self, id, sdata):
        #        log('rollback: id = %s, sdata = %s' % (id, sdata))
        #        self.delete(id,sdata)

if __name__ == 'cpe_tertiary':
  from servicemodel.yang import YangServiceData
  sdata = YangServiceData()
  instance = CpeTertiary().getInstance()
