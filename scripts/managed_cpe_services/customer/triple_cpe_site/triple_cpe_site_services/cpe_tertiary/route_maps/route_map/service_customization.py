...
/services/managed-cpe-services/customer/triple-cpe-site/triple-cpe-site-services/cpe-tertiary/route-maps/route-map
"""
"""
...
class ServiceDataCustomization:
    ...
    def process_service_update_data(smodelctx, sdata, **kwargs):
      ...
      #raise Exception('Update forbidden for node route-map at path managed-cpe-services/customer/triple-cpe-site/triple-cpe-site-services/cpe-tertiary/route-maps/route-map')
      modify = True
      if modify and kwargs is not None:
        for key, value in kwargs.iteritems():
          log("%s == %s" %(key,value))
