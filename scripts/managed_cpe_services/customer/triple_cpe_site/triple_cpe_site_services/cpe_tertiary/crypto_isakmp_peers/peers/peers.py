...
class Peers(yang.AbstractYangServiceHandler):
    _instance = None
    ...
    def create(self, id, sdata):
        ...
        config = getCurrentObjectConfig(id, sdata, 'peers')
        ...
        inputdict['peer_address'] = config.get_field_value('peer_address')
    ...
    @staticmethod
    def getInstance():
        if(Peers._instance == None):
            Peers._instance = Peers()
        return Peers._instance
