...
class HsrpUpdateService(yang.AbstractYangServiceHandler):
    _instance = None
    ...
    def create(self, id, sdata):
        ...
        config = getCurrentObjectConfig(id, sdata, 'hsrp_update_service')
    ...
    @staticmethod
    def getInstance():
        if(HsrpUpdateService._instance == None):
            HsrpUpdateService._instance = HsrpUpdateService()
        return HsrpUpdateService._instance

    #def rollbackCreate(self, id, sdata):
        #        log('rollback: id = %s, sdata = %s' % (id, sdata))
        #        self.delete(id,sdata)

if __name__ == 'hsrp_update_service':
  from servicemodel.yang import YangServiceData
  sdata = YangServiceData()
  instance = HsrpUpdateService().getInstance()
