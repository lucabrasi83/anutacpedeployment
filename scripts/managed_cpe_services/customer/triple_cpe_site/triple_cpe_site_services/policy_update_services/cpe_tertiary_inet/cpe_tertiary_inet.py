...
class CpeTertiaryInet(yang.AbstractYangServiceHandler):
    _instance = None
    ...
    def create(self, id, sdata):
        ...
        config = getCurrentObjectConfig(id, sdata, 'cpe_tertiary_inet')
    ...
    @staticmethod
    def getInstance():
        if(CpeTertiaryInet._instance == None):
            CpeTertiaryInet._instance = CpeTertiaryInet()
        return CpeTertiaryInet._instance

    #def rollbackCreate(self, id, sdata):
        #        log('rollback: id = %s, sdata = %s' % (id, sdata))
        #        self.delete(id,sdata)

if __name__ == 'cpe_tertiary_inet':
  from servicemodel.yang import YangServiceData
  sdata = YangServiceData()
  instance = CpeTertiaryInet().getInstance()
