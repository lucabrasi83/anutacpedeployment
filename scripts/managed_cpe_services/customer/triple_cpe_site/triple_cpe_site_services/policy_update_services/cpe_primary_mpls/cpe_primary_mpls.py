...
class CpePrimaryMpls(yang.AbstractYangServiceHandler):
    _instance = None
    ...
    def create(self, id, sdata):
        ...
        config = getCurrentObjectConfig(id, sdata, 'cpe_primary_mpls')
    ...
    @staticmethod
    def getInstance():
        if(CpePrimaryMpls._instance == None):
            CpePrimaryMpls._instance = CpePrimaryMpls()
        return CpePrimaryMpls._instance

    #def rollbackCreate(self, id, sdata):
        #        log('rollback: id = %s, sdata = %s' % (id, sdata))
        #        self.delete(id,sdata)

if __name__ == 'cpe_primary_mpls':
  from servicemodel.yang import YangServiceData
  sdata = YangServiceData()
  instance = CpePrimaryMpls().getInstance()
