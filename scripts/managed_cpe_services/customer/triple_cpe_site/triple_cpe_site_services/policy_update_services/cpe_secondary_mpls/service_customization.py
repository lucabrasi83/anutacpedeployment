...
class ServiceDataCustomization:
    ...
    def process_service_update_data(smodelctx, sdata, **kwargs):
      ...
      if modify:
        ...
        inputdict = {}
        inputdict['end_point'] = prevconfig.cpe_primary.get_field_value('end_point')
        ...
        primary_ic_uri = "%s/cpe-secondary-mpls-wan/end-points=%s/bgp-peers" % (parent_uri, inputdict['end_point'])
        ep_uri = "%s/cpe-secondary-mpls-wan/end-points=%s" % (parent_uri, inputdict['end_point'])
        ...
        if not rc_path_list:
            ...
            if vrf is None:
                ...
                if hasattr(obj.triple_cpe_site_services.cpe_secondary, 'vrf_name'):
                    vrf = obj.triple_cpe_site_services.cpe_secondary.vrf_name
