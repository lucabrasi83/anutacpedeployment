...
class CpeSecondaryInet(yang.AbstractYangServiceHandler):
    _instance = None
    ...
    def create(self, id, sdata):
        ...
        config = getCurrentObjectConfig(id, sdata, 'cpe_secondary_inet')
    ...
    @staticmethod
    def getInstance():
        if(CpeSecondaryInet._instance == None):
            CpeSecondaryInet._instance = CpeSecondaryInet()
        return CpeSecondaryInet._instance

    #def rollbackCreate(self, id, sdata):
        #        log('rollback: id = %s, sdata = %s' % (id, sdata))
        #        self.delete(id,sdata)

if __name__ == 'cpe_secondary_inet':
  from servicemodel.yang import YangServiceData
  sdata = YangServiceData()
  instance = CpeSecondaryInet().getInstance()
