...
class ServiceDataCustomization:
    ...
    def process_service_update_data(smodelctx, sdata, **kwargs):
      ...
      if modify:
        ...
        primary_ic_uri = "%s/cpe-tertiary-mpls-wan/end-points=%s/bgp-peers" % (parent_uri, inputdict['end_point'])
        ep_uri = "%s/cpe-tertiary-mpls-wan/end-points=%s" % (parent_uri, inputdict['end_point'])
        ...
        if not rc_path_list:
            ...
            if vrf is None:
                ...
                if hasattr(obj.triple_cpe_site_services.cpe_tertiary, 'vrf_name'):
                    vrf = obj.triple_cpe_site_services.cpe_tertiary.vrf_name
