...
class CpeTertiaryMpls(yang.AbstractYangServiceHandler):
    _instance = None
    ...
    def create(self, id, sdata):
        ...
        config = getCurrentObjectConfig(id, sdata, 'cpe_tertiary_mpls')
    ...
    @staticmethod
    def getInstance():
        if(CpeTertiaryMpls._instance == None):
            CpeTertiaryMpls._instance = CpeTertiaryMpls()
        return CpeTertiaryMpls._instance

    #def rollbackCreate(self, id, sdata):
        #        log('rollback: id = %s, sdata = %s' % (id, sdata))
        #        self.delete(id,sdata)

if __name__ == 'cpe_tertiary_mpls':
  from servicemodel.yang import YangServiceData
  sdata = YangServiceData()
  instance = CpeTertiaryMpls().getInstance()
