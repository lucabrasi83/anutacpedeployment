...
class TripleCpeSiteServices(yang.AbstractYangServiceHandler):
    _instance = None
    ...
    def create(self, id, sdata):
        ...
        config = getCurrentObjectConfig(id, sdata, 'triple_cpe_site_services')
    ...
    @staticmethod
    def getInstance():
        if(TripleCpeSiteServices._instance == None):
            TripleCpeSiteServices._instance = TripleCpeSiteServices()
        return TripleCpeSiteServices._instance

    #def rollbackCreate(self, id, sdata):
        #        log('rollback: id = %s, sdata = %s' % (id, sdata))
        #        self.delete(id,sdata)

if __name__ == 'triple_cpe_site_services':
  from servicemodel.yang import YangServiceData
  sdata = YangServiceData()
  instance = TripleCpeSiteServices().getInstance()
