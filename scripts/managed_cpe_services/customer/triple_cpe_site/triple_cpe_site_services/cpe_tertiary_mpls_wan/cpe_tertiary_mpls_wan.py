...
class CpeTertiaryMplsWan(yang.AbstractYangServiceHandler):
    _instance = None
    ...
    def create(self, id, sdata):
        ...
        config = getCurrentObjectConfig(id, sdata, 'cpe_tertiary_mpls_wan')
        ...
        if inputdict.get('interconnect_name') is None:
          inputdict['interconnect_name'] = 'cpe-tertiary-mpls-wan'
    ...
    @staticmethod
    def getInstance():
        if(CpeTertiaryMplsWan._instance == None):
            CpeTertiaryMplsWan._instance = CpeTertiaryMplsWan()
        return CpeTertiaryMplsWan._instance

    #def rollbackCreate(self, id, sdata):
        #        log('rollback: id = %s, sdata = %s' % (id, sdata))
        #        self.delete(id,sdata)

if __name__ == 'cpe_tertiary_mpls_wan':
  from servicemodel.yang import YangServiceData
  sdata = YangServiceData()
  instance = CpeTertiaryMplsWan().getInstance()
