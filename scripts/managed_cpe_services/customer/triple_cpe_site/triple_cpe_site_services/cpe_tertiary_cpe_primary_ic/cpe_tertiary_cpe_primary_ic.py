...
class CpeTertiaryCpePrimaryIc(yang.AbstractYangServiceHandler):
    _instance = None
    ...
    def create(self, id, sdata):
        ...
        config = getCurrentObjectConfig(id, sdata, 'cpe_tertiary_cpe_primary_ic')
        ...
        if inputdict.get('interconnect_name') is None:
          inputdict['interconnect_name'] = 'cpe-tertiary-cpe-primary-ic'
    ...
    @staticmethod
    def getInstance():
        if(CpeTertiaryCpePrimaryIc._instance == None):
            CpeTertiaryCpePrimaryIc._instance = CpeTertiaryCpePrimaryIc()
        return CpeTertiaryCpePrimaryIc._instance

    #def rollbackCreate(self, id, sdata):
        #        log('rollback: id = %s, sdata = %s' % (id, sdata))
        #        self.delete(id,sdata)

if __name__ == 'cpe_tertiary_cpe_primary_ic':
  from servicemodel.yang import YangServiceData
  sdata = YangServiceData()
  instance = CpeTertiaryCpePrimaryIc().getInstance()
