...
class TertiaryInetWan(yang.AbstractYangServiceHandler):
    _instance = None
    ...
    def create(self, id, sdata):
        ...
        config = getCurrentObjectConfig(id, sdata, 'tertiary_inet_wan')
        ...
        if inputdict.get('name') is None:
          inputdict['name'] = 'tertiary-inet-wan'
        inputdict['tertiary_inet_wan_connectivity'] = config.get_field_value('tertiary_inet_wan_connectivity')
        if inputdict.get('tertiary_inet_wan_connectivity') is None:
          inputdict['tertiary_inet_wan_connectivity'] = 'INET'
    ...
    @staticmethod
    def getInstance():
        if(TertiaryInetWan._instance == None):
            TertiaryInetWan._instance = TertiaryInetWan()
        return TertiaryInetWan._instance

    #def rollbackCreate(self, id, sdata):
        #        log('rollback: id = %s, sdata = %s' % (id, sdata))
        #        self.delete(id,sdata)

if __name__ == 'tertiary_inet_wan':
  from servicemodel.yang import YangServiceData
  sdata = YangServiceData()
  instance = TertiaryInetWan().getInstance()
