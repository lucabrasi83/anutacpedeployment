...
/services/managed-cpe-services/customer/triple-cpe-site/triple-cpe-site-services/cpe-tertiary-inet-wan/end-points/eigrp
"""
"""
    ...
    def process_service_create_data(smodelctx, sdata, dev, **kwargs):
      ...
      if modify:
        ...
        for device in util.convert_to_list(dev):
            eigrpEnd('cpe_tertiary_inet_triple', smodelctx, sdata, device, **kwargs)
