...
class ServiceDataCustomization:
    ...
    def process_service_device_bindings(smodelctx, sdata, dev, **kwargs):
      ...
      if modify:
        ...
        for device in util.convert_to_list(dev):
            bgp_peer('cpe_tertiary_triple', 'cpe_tertiary_inet_triple', smodelctx, sdata, device, **kwargs)
    ...
    def process_service_update_data(smodelctx, sdata, **kwargs):
      ...
      if modify:
        ...
        dev = kwargs['dev']
        for device in util.convert_to_list(dev):
            update_bgp_peer('cpe_tertiary_triple', 'cpe_tertiary_inet_triple', smodelctx, sdata, device, **kwargs)
