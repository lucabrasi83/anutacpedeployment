...
class CpeTertiaryInetWan(yang.AbstractYangServiceHandler):
    _instance = None
    ...
    def create(self, id, sdata):
        ...
        config = getCurrentObjectConfig(id, sdata, 'cpe_tertiary_inet_wan')
        ...
        if inputdict.get('interconnect_name') is None:
          inputdict['interconnect_name'] = 'cpe-tertiary-inet-wan'
    ...
    @staticmethod
    def getInstance():
        if(CpeTertiaryInetWan._instance == None):
            CpeTertiaryInetWan._instance = CpeTertiaryInetWan()
        return CpeTertiaryInetWan._instance

    #def rollbackCreate(self, id, sdata):
        #        log('rollback: id = %s, sdata = %s' % (id, sdata))
        #        self.delete(id,sdata)

if __name__ == 'cpe_tertiary_inet_wan':
  from servicemodel.yang import YangServiceData
  sdata = YangServiceData()
  instance = CpeTertiaryInetWan().getInstance()
