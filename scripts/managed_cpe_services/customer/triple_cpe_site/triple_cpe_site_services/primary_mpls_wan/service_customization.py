...
class ServiceDataCustomization:
    ...
    def process_service_update_data(smodelctx, sdata, **kwargs):
      ...
      raise Exception('Update forbidden for node primary-mpls-wan at path managed-cpe-services/customer/triple-cpe-site/triple-cpe-site-services/primary-mpls-wan')
      modify = True
      if modify and kwargs is not None:
        for key, value in kwargs.iteritems():
          log("%s == %s" %(key,value))
