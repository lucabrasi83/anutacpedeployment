...
class TertiaryMplsWan(yang.AbstractYangServiceHandler):
    _instance = None
    ...
    def create(self, id, sdata):
        ...
        config = getCurrentObjectConfig(id, sdata, 'tertiary_mpls_wan')
        ...
        if inputdict.get('name') is None:
          inputdict['name'] = 'tertiary-mpls-wan'
        inputdict['tertiary_mpls_wan_connectivity'] = config.get_field_value('tertiary_mpls_wan_connectivity')
        if inputdict.get('tertiary_mpls_wan_connectivity') is None:
          inputdict['tertiary_mpls_wan_connectivity'] = 'MPLS'
    ...
    @staticmethod
    def getInstance():
        if(TertiaryMplsWan._instance == None):
            TertiaryMplsWan._instance = TertiaryMplsWan()
        return TertiaryMplsWan._instance

    #def rollbackCreate(self, id, sdata):
        #        log('rollback: id = %s, sdata = %s' % (id, sdata))
        #        self.delete(id,sdata)

if __name__ == 'tertiary_mpls_wan':
  from servicemodel.yang import YangServiceData
  sdata = YangServiceData()
  instance = TertiaryMplsWan().getInstance()
