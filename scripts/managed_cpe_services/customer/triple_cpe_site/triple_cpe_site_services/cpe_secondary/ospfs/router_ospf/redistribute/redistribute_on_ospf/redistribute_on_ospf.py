...
class RedistributeOnOspf(yang.AbstractYangServiceHandler):
    ...
    def create(self, id, sdata):
        ...
        inputkeydict['managed_cpe_services_customer_triple_cpe_site_triple_cpe_site_services_cpe_secondary_ospfs_router_ospf_process_id'] = sdata.getRcPath().split('/')[-3].split('=')[1]
