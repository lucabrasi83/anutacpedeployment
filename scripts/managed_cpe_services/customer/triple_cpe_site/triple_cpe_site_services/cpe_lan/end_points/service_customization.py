...
class ServiceDataCustomization:
    ...
    def process_service_device_bindings(smodelctx, sdata, dev, **kwargs):
      ...
      if modify:
        ...
        for device in util.convert_to_list(dev):
            new_back_endpoint('customer_lan_ic_triple', smodelctx, sdata, device, **kwargs)
    ...
    def process_service_update_data(smodelctx, sdata, **kwargs):
      ...
      if modify:
        ...
        dev = kwargs['dev']
        for device in util.convert_to_list(dev):
            update_hsrp_priority('customer_lan_ic_triple', smodelctx, sdata, device, **kwargs)
    ...
    def process_service_delete_data(smodelctx, sdata, **kwargs):
      ...
      if modify:
        ...
        dev = kwargs['dev']
        for device in util.convert_to_list(dev):
            delete_physical_interface('customer_lan_ic_triple', smodelctx, sdata, device, **kwargs)
