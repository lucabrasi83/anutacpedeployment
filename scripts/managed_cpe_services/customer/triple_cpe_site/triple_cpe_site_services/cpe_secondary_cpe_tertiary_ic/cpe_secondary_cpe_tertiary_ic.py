...
class CpeSecondaryCpeTertiaryIc(yang.AbstractYangServiceHandler):
    _instance = None
    ...
    def create(self, id, sdata):
        ...
        config = getCurrentObjectConfig(id, sdata, 'cpe_secondary_cpe_tertiary_ic')
        ...
        if inputdict.get('interconnect_name') is None:
          inputdict['interconnect_name'] = 'cpe-secondary-cpe-tertiary-ic'
    ...
    @staticmethod
    def getInstance():
        if(CpeSecondaryCpeTertiaryIc._instance == None):
            CpeSecondaryCpeTertiaryIc._instance = CpeSecondaryCpeTertiaryIc()
        return CpeSecondaryCpeTertiaryIc._instance

    #def rollbackCreate(self, id, sdata):
        #        log('rollback: id = %s, sdata = %s' % (id, sdata))
        #        self.delete(id,sdata)

if __name__ == 'cpe_secondary_cpe_tertiary_ic':
  from servicemodel.yang import YangServiceData
  sdata = YangServiceData()
  instance = CpeSecondaryCpeTertiaryIc().getInstance()
