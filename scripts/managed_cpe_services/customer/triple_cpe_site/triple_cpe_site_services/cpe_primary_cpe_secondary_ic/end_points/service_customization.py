...
/services/managed-cpe-services/customer/triple-cpe-site/triple-cpe-site-services/cpe-primary-cpe-secondary-ic/end-points
"""
"""
...
class ServiceDataCustomization:
    ...
    def process_service_device_bindings(smodelctx, sdata, dev, **kwargs):
      ...
      if modify:
        ...
        for device in util.convert_to_list(dev):
            new_back_endpoint('cpe_primary_cpe_secondary_ic_triple', smodelctx, sdata, device, **kwargs)
    ...
    def process_service_delete_data(smodelctx, sdata, **kwargs):
      ...
      if modify:
        ...
        dev = kwargs['dev']
        for device in util.convert_to_list(dev):
            delete_physical_interface('cpe_primary_cpe_secondary_ic_triple', smodelctx, sdata, device, **kwargs)
