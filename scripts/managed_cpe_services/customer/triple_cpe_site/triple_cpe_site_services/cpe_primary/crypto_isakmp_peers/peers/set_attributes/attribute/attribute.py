...
class Attribute(yang.AbstractYangServiceHandler):
    _instance = None
    ...
    def create(self, id, sdata):
        ...
        config = getCurrentObjectConfig(id, sdata, 'attribute')
        ...
        inputdict['attribute_type'] = config.get_field_value('attribute_type')
        inputdict['password'] = config.get_field_value('password')
        inputdict['endpoint_type'] = config.get_field_value('endpoint_type')
        inputdict['fqdn'] = config.get_field_value('fqdn')
        inputdict['ipv4_address'] = config.get_field_value('ipv4_address')
        ...
        #inputkeydict['managed_cpe_services_customer_single_cpe_site_single_cpe_site_services_cpe_eigrp_router_eigrp_process_id'] = sdata.getRcPath().split('/')[-3].split('=')[1]
        #inputkeydict['managed_cpe_services_customer_single_cpe_site_single_cpe_site_services_site_name'] = sdata.getRcPath().split('/')[-6].split('=')[1]
    ...
    def update(self, id, sdata):
        #Fetch Local Config Object
        config = getCurrentObjectConfig(id, sdata, 'attribute')
        pconfig = getPreviousObjectConfig(id, sdata, 'attribute')
        opaque_args = self.opaque_args
        ...
        pinputdict['attribute_type'] = pconfig.get_field_value('attribute_type')
        pinputdict['password'] = pconfig.get_field_value('password')
        pinputdict['endpoint_type'] = pconfig.get_field_value('endpoint_type')
        pinputdict['fqdn'] = pconfig.get_field_value('fqdn')
    ...
    @staticmethod
    def getInstance():
        if(Attribute._instance == None):
            Attribute._instance = Attribute()
        return Attribute._instance
