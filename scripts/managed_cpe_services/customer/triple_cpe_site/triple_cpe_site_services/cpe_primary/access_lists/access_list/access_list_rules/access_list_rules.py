...
class AccessListRules(yang.AbstractYangServiceHandler):
    ...
    def create(self, id, sdata):
        ...
        #inputkeydict['managed_cpe_services_customer_triple_cpe_site_triple_cpe_site_services_cpe_primary_access_lists_access_list_name'] = sdata.getRcPath().split('/')[-2].split('=')[1]
