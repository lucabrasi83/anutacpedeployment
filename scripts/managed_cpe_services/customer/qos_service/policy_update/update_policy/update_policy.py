...
class UpdatePolicy(yang.AbstractYangServiceHandler):
    _instance = None
    ...
    def create(self, id, sdata):
        ...
        config = getCurrentObjectConfig(id, sdata, 'update_policy')
    ...
    @staticmethod
    def getInstance():
        if(UpdatePolicy._instance == None):
            UpdatePolicy._instance = UpdatePolicy()
        return UpdatePolicy._instance

    #def rollbackCreate(self, id, sdata):
        #        log('rollback: id = %s, sdata = %s' % (id, sdata))
        #        self.delete(id,sdata)

if __name__ == 'update_policy':
  from servicemodel.yang import YangServiceData
  sdata = YangServiceData()
  instance = UpdatePolicy().getInstance()
