...
class CreateClassMap(yang.AbstractYangServiceHandler):
    _instance = None
    ...
    @staticmethod
    def getInstance():
        if(CreateClassMap._instance == None):
            CreateClassMap._instance = CreateClassMap()
        return CreateClassMap._instance
