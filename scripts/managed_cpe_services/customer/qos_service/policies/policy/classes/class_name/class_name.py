...
class ClassName(yang.AbstractYangServiceHandler):
    _instance = None
    ...
    def create(self, id, sdata):
        ...
        #inputkeydict['managed_cpe_services_customer_qos_service_policies_policy_name'] = sdata.getRcPath().split('/')[-3].split('=')[1]
