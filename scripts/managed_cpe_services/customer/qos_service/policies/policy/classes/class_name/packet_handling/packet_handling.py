...
class PacketHandling(yang.AbstractYangServiceHandler):
    _instance = None
    ...
    def create(self, id, sdata):
        ...
        config = getCurrentObjectConfig(id, sdata, 'packet_handling')
        ...
        inputdict['parent_class'] = config.get_field_value('parent_class')
        # END OF FETCHING THE LEAF PARAMETERS

        inputkeydict = {}
        # START OF FETCHING THE PARENT KEY LEAF PARAMETERS
        inputkeydict['managed_cpe_services_customer_qos_service_policies_policy_classes_class_name_name'] = sdata.getRcPath().split('/')[-2].split('=')[1]
        inputkeydict['managed_cpe_services_customer_qos_service_policies_policy_name'] = sdata.getRcPath().split('/')[-4].split('=')[1]
    ...
    @staticmethod
    def getInstance():
        if(PacketHandling._instance == None):
            PacketHandling._instance = PacketHandling()
        return PacketHandling._instance
