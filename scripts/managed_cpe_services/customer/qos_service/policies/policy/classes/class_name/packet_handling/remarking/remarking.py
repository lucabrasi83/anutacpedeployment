...
class Remarking(yang.AbstractYangServiceHandler):
    _instance = None
    ...
    def create(self, id, sdata):
        ...
        inputdict['dscp_tunnel'] = config.get_field_value('dscp_tunnel')
    ...
    @staticmethod
    def getInstance():
        if(Remarking._instance == None):
            Remarking._instance = Remarking()
        return Remarking._instance
