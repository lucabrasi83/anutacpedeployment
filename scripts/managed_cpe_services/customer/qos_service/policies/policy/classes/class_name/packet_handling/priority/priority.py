...
class Priority(yang.AbstractYangServiceHandler):
    _instance = None
    ...
    def create(self, id, sdata):
        ...
        inputdict['priority_level'] = config.get_field_value('priority_level')
    ...
    @staticmethod
    def getInstance():
        if(Priority._instance == None):
            Priority._instance = Priority()
        return Priority._instance
