...
class QueueLimit(yang.AbstractYangServiceHandler):
    _instance = None
    ...
    def create(self, id, sdata):
        ...
        config = getCurrentObjectConfig(id, sdata, 'queue_limit')
    ...
    @staticmethod
    def getInstance():
        if(QueueLimit._instance == None):
            QueueLimit._instance = QueueLimit()
        return QueueLimit._instance
