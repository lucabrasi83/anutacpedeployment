...
class RandomDetect(yang.AbstractYangServiceHandler):
    _instance = None
    ...
    def create(self, id, sdata):
        ...
        inputdict['random_detect'] = config.get_field_value('random_detect')
    ...
    @staticmethod
    def getInstance():
        if(RandomDetect._instance == None):
            RandomDetect._instance = RandomDetect()
        return RandomDetect._instance
