...
class ViolateHandling(yang.AbstractYangServiceHandler):
    _instance = None
    ...
    @staticmethod
    def getInstance():
        if(ViolateHandling._instance == None):
            ViolateHandling._instance = ViolateHandling()
        return ViolateHandling._instance
