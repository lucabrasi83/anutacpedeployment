...
class Policy(yang.AbstractYangServiceHandler):
    _instance = None
    ...
    def create(self, id, sdata):
        ...
        config = getCurrentObjectConfig(id, sdata, 'policy')
    ...
    @staticmethod
    def getInstance():
        if(Policy._instance == None):
            Policy._instance = Policy()
        return Policy._instance
