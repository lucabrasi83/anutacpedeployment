...
/services/managed-cpe-services/customer/access-lists/delete-access-list
"""
...
class DeleteAccessList(yang.AbstractYangServiceHandler):
    _instance = None
    ...
    def create(self, id, sdata):
        ...
        config = getCurrentObjectConfig(id, sdata, 'delete_access_list')
    ...
    @staticmethod
    def getInstance():
        if(DeleteAccessList._instance == None):
            DeleteAccessList._instance = DeleteAccessList()
        return DeleteAccessList._instance

    #def rollbackCreate(self, id, sdata):
        #        log('rollback: id = %s, sdata = %s' % (id, sdata))
        #        self.delete(id,sdata)

if __name__ == 'delete_access_list':
  from servicemodel.yang import YangServiceData
  sdata = YangServiceData()
  instance = DeleteAccessList().getInstance()
