...
class SingleCpeDualWanSiteServices(yang.AbstractYangServiceHandler):
    _instance = None
    ...
    def create(self, id, sdata):
        ...
        config = getCurrentObjectConfig(id, sdata, 'single_cpe_dual_wan_site_services')
    ...
    @staticmethod
    def getInstance():
        if(SingleCpeDualWanSiteServices._instance == None):
            SingleCpeDualWanSiteServices._instance = SingleCpeDualWanSiteServices()
        return SingleCpeDualWanSiteServices._instance
