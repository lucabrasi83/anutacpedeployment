...
class Eigrp(yang.AbstractYangServiceHandler):
    ...
    def create(self, id, sdata):
        ...
        inputkeydict['managed_cpe_services_customer_single_cpe_dual_wan_site_single_cpe_dual_wan_site_services_cpe_primary_wan_end_points_endpoint_name'] = sdata.getRcPath().split('/')[-2].split('=')[1]
