...
class SecondaryWan(yang.AbstractYangServiceHandler):
    _instance = None
    ...
    def create(self, id, sdata):
        ...
        config = getCurrentObjectConfig(id, sdata, 'secondary_wan')
        ...
        if inputdict['name'] is None:
          inputdict['name'] = 'secondary-wan'
        # inputdict['secondary_wan_connectivity'] = config.get_field_value('secondary_wan_connectivity')
        # if inputdict['secondary_wan_connectivity'] is None:
        #   inputdict['secondary_wan_connectivity'] = 'MPLS'
    ...
    @staticmethod
    def getInstance():
        if(SecondaryWan._instance == None):
            SecondaryWan._instance = SecondaryWan()
        return SecondaryWan._instance
