...
def fail_fall(smodelctx, sdata, **kwargs):
    ...
    failover_state = obj_prim.single_cpe_dual_wan_site_services.failover_state
            ...
            for endpoint in endpoints:
                ...
                if hasattr(endpoint, 'bgp_peers'):
                    ...
                    for peer in bgp_peers:
                            ...
                            bgp_peer_url = dev.url + '/l3features:vrfs/vrf=%s/router-bgp/neighbor=%s' % (vrf, peer.peer_ip)
                            ...
                            if yang.Sdk.dataExists(bgp_peer_url):
                                ...
                                raise Exception("eBGP Peer " + str(peer.peer_ip) + " not found on device. Cannot proceed with failover.")
                    ...
                    if hasattr(endpoint, 'bgp_peers'):
                        ...
                        for peer in bgp_peers:
                                ...
                                if yang.Sdk.dataExists(bgp_peer_url):
                                    ...
                                    raise Exception("eBGP Peer " + str(peer.peer_ip) + " not found on device. Cannot proceed with fallback.")
