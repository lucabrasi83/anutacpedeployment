...
/services/managed-cpe-services/customer/single-cpe-dual-wan-site/single-cpe-dual-wan-site-services/lan/switches/spanning-tree
"""
"""
...
from cpedeployment.switch_lib import spanningtree
    ...
    def process_service_device_bindings(smodelctx, sdata, dev, **kwargs):
      ...
      if modify:
        ...
        for device in util.convert_to_list(dev):
            spanningtree(smodelctx, sdata, device, **kwargs)
