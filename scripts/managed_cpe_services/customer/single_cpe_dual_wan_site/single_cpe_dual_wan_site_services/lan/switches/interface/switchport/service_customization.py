...
/services/managed-cpe-services/customer/single-cpe-dual-wan-site/single-cpe-dual-wan-site-services/lan/switches/interface/switchport
"""
"""
...
from cpedeployment.switch_lib import switchport
    ...
    def process_service_device_bindings(smodelctx, sdata, dev, **kwargs):
      ...
      if modify:
        ...
        for device in util.convert_to_list(dev):
            switchport(smodelctx, sdata, device, **kwargs)
