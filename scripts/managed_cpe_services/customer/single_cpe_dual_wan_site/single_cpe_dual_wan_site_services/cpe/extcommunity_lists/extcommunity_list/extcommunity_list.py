...
class ExtcommunityList(yang.AbstractYangServiceHandler):
    _instance = None
    ...
    def create(self, id, sdata):
        ...
        config = getCurrentObjectConfig(id, sdata, 'extcommunity_list')
        ...
        inputdict['extcommunity_list_name'] = config.get_field_value('extcommunity_list_name')
    ...
    @staticmethod
    def getInstance():
        if(ExtcommunityList._instance == None):
            ExtcommunityList._instance = ExtcommunityList()
        return ExtcommunityList._instance

    #def rollbackCreate(self, id, sdata):
        #        log('rollback: id = %s, sdata = %s' % (id, sdata))
        #        self.delete(id,sdata)

if __name__ == 'extcommunity_list':
  from servicemodel.yang import YangServiceData
  sdata = YangServiceData()
  instance = ExtcommunityList().getInstance()
