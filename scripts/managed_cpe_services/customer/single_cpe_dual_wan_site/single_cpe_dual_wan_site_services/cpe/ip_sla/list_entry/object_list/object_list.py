...
/services/managed-cpe-services/customer/single-cpe-dual-wan-site/single-cpe-dual-wan-site-services/cpe/ip-sla/list-entry/object-list
"""
...
class ObjectList(yang.AbstractYangServiceHandler):
    _instance = None
    ...
    def create(self, id, sdata):
        ...
        inputkeydict['managed_cpe_services_customer_single_cpe_dual_wan_site_single_cpe_dual_wan_site_services_cpe_ip_sla_list_entry_track_number'] = sdata.getRcPath().split('/')[-2].split('=')[1]
        ...
        inputdict['list_track_number'] = inputkeydict['managed_cpe_services_customer_single_cpe_dual_wan_site_single_cpe_dual_wan_site_services_cpe_ip_sla_list_entry_track_number']
    ...
    def update(self, id, sdata):
        #Fetch Local Config Object
        config = getCurrentObjectConfig(id, sdata, 'object_list')
        #pconfig = getPreviousObjectConfig(id, sdata, 'object_list')
        opaque_args = self.opaque_args
    ...
    @staticmethod
    def getInstance():
        if(ObjectList._instance == None):
            ObjectList._instance = ObjectList()
        return ObjectList._instance
