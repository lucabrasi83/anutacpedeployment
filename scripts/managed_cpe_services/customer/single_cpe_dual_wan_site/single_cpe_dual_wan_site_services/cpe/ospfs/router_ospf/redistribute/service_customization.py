...
/services/managed-cpe-services/customer/single-cpe-dual-wan-site/single-cpe-dual-wan-site-services/cpe/ospfs/router-ospf/redistribute
"""
"""
    ...
    def process_service_create_data(smodelctx, sdata, dev, **kwargs):
        ...
        if modify:
            ...
            for device in util.convert_to_list(dev):
                ospf_on_bgp('cpe_dual', smodelctx, sdata, device, **kwargs)
