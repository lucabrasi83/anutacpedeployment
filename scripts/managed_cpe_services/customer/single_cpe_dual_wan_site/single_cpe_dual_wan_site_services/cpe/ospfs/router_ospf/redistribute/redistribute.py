...
class Redistribute(yang.AbstractYangServiceHandler):
    ...
    def create(self, id, sdata):
        ...
        inputdict['redistribute_ospf_on_bgp'] = config.get_field_value('redistribute_ospf_on_bgp')
        inputdict['ospf_internal'] = config.get_field_value('ospf_internal')
        inputdict['ospf_external1'] = config.get_field_value('ospf_external1')
        inputdict['ospf_external2'] = config.get_field_value('ospf_external2')
        ...
        inputkeydict['managed_cpe_services_customer_single_cpe_dual_wan_site_single_cpe_dual_wan_site_services_cpe_ospfs_router_ospf_process_id'] = sdata.getRcPath().split('/')[-2].split('=')[1]
