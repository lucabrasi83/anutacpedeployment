...
class RedistributeOnOspf(yang.AbstractYangServiceHandler):
    ...
    def create(self, id, sdata):
        ...
        inputdict['key1'] = config.get_field_value('key1')
        inputdict['key2'] = config.get_field_value('key2')
        ...
        inputkeydict['managed_cpe_services_customer_single_cpe_dual_wan_site_single_cpe_dual_wan_site_services_cpe_ospfs_router_ospf_process_id'] = sdata.getRcPath().split('/')[-3].split('=')[1]
