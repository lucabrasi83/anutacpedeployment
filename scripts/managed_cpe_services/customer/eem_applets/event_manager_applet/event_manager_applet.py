...
class EventManagerApplet(yang.AbstractYangServiceHandler):
    _instance = None
    ...
    def create(self, id, sdata):
        ...
        config = getCurrentObjectConfig(id, sdata, 'event_manager_applet')
    ...
    def update(self, id, sdata):
        #Fetch Local Config Object
        config = getCurrentObjectConfig(id, sdata, 'event_manager_applet')
        pconfig = getPreviousObjectConfig(id, sdata, 'event_manager_applet')
        opaque_args = self.opaque_args
    ...
    @staticmethod
    def getInstance():
        if(EventManagerApplet._instance == None):
            EventManagerApplet._instance = EventManagerApplet()
        return EventManagerApplet._instance
