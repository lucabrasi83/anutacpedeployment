...
class DeleteIpsecProfile(yang.AbstractYangServiceHandler):
    _instance = None
    ...
    def create(self, id, sdata):
        ...
        config = getCurrentObjectConfig(id, sdata, 'delete_ipsec_profile')
    ...
    @staticmethod
    def getInstance():
        if(DeleteIpsecProfile._instance == None):
            DeleteIpsecProfile._instance = DeleteIpsecProfile()
        return DeleteIpsecProfile._instance

    #def rollbackCreate(self, id, sdata):
        #        log('rollback: id = %s, sdata = %s' % (id, sdata))
        #        self.delete(id,sdata)

if __name__ == 'delete_ipsec_profile':
  from servicemodel.yang import YangServiceData
  sdata = YangServiceData()
  instance = DeleteIpsecProfile().getInstance()
