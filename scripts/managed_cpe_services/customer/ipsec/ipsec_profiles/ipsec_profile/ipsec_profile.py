...
class IpsecProfile(yang.AbstractYangServiceHandler):
    _instance = None
    ...
    def create(self, id, sdata):
        ...
        inputdict['ipsec_profile_name'] = config.get_field_value('ipsec_profile_name')
        inputdict['sa_lifetime'] = config.get_field_value('sa_lifetime')
        inputdict['transform_set'] = config.get_field_value('transform_set')
        inputdict['crypto_profile'] = config.get_field_value('crypto_profile')
        inputdict['shared'] = config.get_field_value('shared')
    ...
    @staticmethod
    def getInstance():
        if(IpsecProfile._instance == None):
            IpsecProfile._instance = IpsecProfile()
        return IpsecProfile._instance
