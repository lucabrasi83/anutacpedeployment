...
class TransformSet(yang.AbstractYangServiceHandler):
    _instance = None
    ...
    def create(self, id, sdata):
        ...
        inputdict['transform_set_name'] = config.get_field_value('transform_set_name')
        inputdict['mode'] = config.get_field_value('mode')
        if inputdict['mode'] is None:
          inputdict['mode'] = 'transport'
    ...
    @staticmethod
    def getInstance():
        if(TransformSet._instance == None):
            TransformSet._instance = TransformSet()
        return TransformSet._instance
