...
class ServiceDataCustomization:
    ...
    def process_service_create_data(smodelctx, sdata, dev, **kwargs):
      ...
      if modify:
        ...
        for device in util.convert_to_list(dev):
            eigrpPassive('cpe', smodelctx, sdata, device, **kwargs)
    ...
    def process_service_update_data(smodelctx, sdata, **kwargs):
      ...
      #raise Exception('Update forbidden for node passive-interface at path managed-cpe-services/customer/single-cpe-site/single-cpe-site-services/cpe/eigrp/router-eigrp/passive-interface')
      modify = True
      if modify and kwargs is not None:
        for key, value in kwargs.items():
          log("%s == %s" %(key,value))
