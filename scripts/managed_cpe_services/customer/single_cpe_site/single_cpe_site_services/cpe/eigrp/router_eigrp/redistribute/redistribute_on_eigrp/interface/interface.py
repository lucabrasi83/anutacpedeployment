...
class Interface(yang.AbstractYangServiceHandler):
    ...
    def create(self, id, sdata):
        ...
        inputkeydict['managed_cpe_services_customer_single_cpe_site_single_cpe_site_services_cpe_eigrp_router_eigrp_redistribute_redistribute_on_eigrp_protocol'] = sdata.getRcPath().split('/')[-4].split('=')[1]
        inputkeydict['managed_cpe_services_customer_single_cpe_site_single_cpe_site_services_site_name'] = sdata.getRcPath().split('/')[-7].split('=')[1]
    ...
    def update(self, id, sdata):
        ...
        # START OF FETCHING THE LEAF PARAMETERS
        inputdict['route_map_connected_sequence_number'] = pconfig.get_field_value('route_map_connected_sequence_number')
        inputdict['interface_name'] = config.get_field_value('interface_name')
        # END OF FETCHING THE LEAF PARAMETERS
