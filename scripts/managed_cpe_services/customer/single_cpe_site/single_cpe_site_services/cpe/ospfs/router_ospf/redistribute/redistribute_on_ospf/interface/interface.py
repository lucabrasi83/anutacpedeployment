...
class Interface(yang.AbstractYangServiceHandler):
    ...
    def create(self, id, sdata):
        ...
        inputkeydict['managed_cpe_services_customer_single_cpe_site_single_cpe_site_services_cpe_ospfs_router_ospf_redistribute_redistribute_on_ospf_protocol'] = sdata.getRcPath().split('/')[-4].split('=')[1]
