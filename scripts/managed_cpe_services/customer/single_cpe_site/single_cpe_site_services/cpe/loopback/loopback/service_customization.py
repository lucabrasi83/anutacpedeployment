...
/services/managed-cpe-services/customer/single-cpe-site/single-cpe-site-services/cpe/loopback/loopback
"""
"""
...
class ServiceDataCustomization:
    ...
    def process_service_update_data(smodelctx, sdata, **kwargs):
      ...
      #raise Exception('Update forbidden for node loopback at path managed-cpe-services/customer/single-cpe-site/single-cpe-site-services/cpe/loopback/loopback')
      modify = True
      if modify and kwargs is not None:
        for key, value in kwargs.iteritems():
          log("%s == %s" %(key,value))
