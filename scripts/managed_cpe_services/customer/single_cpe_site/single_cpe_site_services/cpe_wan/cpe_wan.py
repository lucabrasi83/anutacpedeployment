...
class CpeWan(yang.AbstractYangServiceHandler):
    _instance = None
    ...
    def create(self, id, sdata):
        ...
        config = getCurrentObjectConfig(id, sdata, 'cpe_wan')
        ...
        if inputdict['interconnect_name'] is None:
          inputdict['interconnect_name'] = 'cpe-wan'
        ...
        inputkeydict['managed_cpe_services_customer_single_cpe_site_single_cpe_site_services_site_name'] = sdata.getRcPath().split('/')[-2].split('=')[1]
    ...
    @staticmethod
    def getInstance():
        if(CpeWan._instance == None):
            CpeWan._instance = CpeWan()
        return CpeWan._instance
