...
class SingleCpeSiteServices(yang.AbstractYangServiceHandler):
    _instance = None
    ...
    def create(self, id, sdata):
        ...
        config = getCurrentObjectConfig(id, sdata, 'single_cpe_site_services')
    ...
    @staticmethod
    def getInstance():
        if(SingleCpeSiteServices._instance == None):
            SingleCpeSiteServices._instance = SingleCpeSiteServices()
        return SingleCpeSiteServices._instance
