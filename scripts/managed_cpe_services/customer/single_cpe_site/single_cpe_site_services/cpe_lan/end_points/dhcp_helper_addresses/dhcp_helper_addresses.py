...
class DhcpHelperAddresses(yang.AbstractYangServiceHandler):
    _instance = None
    ...
    def create(self, id, sdata):
        ...
        config = getCurrentObjectConfig(id, sdata, 'dhcp_helper_addresses')
        ...
        inputdict['helper_address'] = config.get_field_value('helper_address')
        ...
        inputkeydict['managed_cpe_services_customer_single_cpe_site_single_cpe_site_services_cpe_lan_end_points_endpoint_name'] = sdata.getRcPath().split('/')[-2].split('=')[1]
    ...
    @staticmethod
    def getInstance():
        if(DhcpHelperAddresses._instance == None):
            DhcpHelperAddresses._instance = DhcpHelperAddresses()
        return DhcpHelperAddresses._instance
